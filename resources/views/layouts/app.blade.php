...
<body class="h-full font-sans antialiased bg-white text-slate-900">
            ...
            'PAGES' => [
                [
                    ...
                    'links' => [
                        ...
                        [
                            'label' => 'Our Locations',
                            'href' => route('pages.our-locations'),
                            'icon' =>
            ...
            'CONTACT' => [
                [
                    ...
                    'links' => [
                        ...
                        [
                            'label' => 'Hotline: +880 9666-777100',
                            'href' => 'tel:+8809666777100',
                            'icon' =>
                                '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 stroke-2 shrink-0 text-brand-blue"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>',
                        ],
                        [
                        ...
                        @if ($item['hasMega'])
                            <div class="border-b border-slate-100 pb-2">
                                <div class="flex items-center justify-between">
                                    ...
                                    @endif
                                    <button type="button"
                                        class="mobile-mega-toggle flex-1 flex items-center justify-end self-stretch pl-2 p-2.5 rounded-lg hover:bg-slate-50 transition-colors"
    ...
    <footer class="relative bg-brand-dark-bg text-white font-sans antialiased pb-20 lg:pb-0">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-10 py-10 lg:py-4">
            ...
            <div class="lg:hidden space-y-10 mb-3">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="https://www.linkedin.com/company/bctbd/" target="_blank" rel="noopener noreferrer"
                ...
                {{-- Contact Info --}}
                <div class="space-y-6">
                    <h3 class="text-lg font-bold mb-4 pb-2 border-b border-white/20">Contact</h3>
            ...
            {{-- Desktop Layout (lg+) --}}
            <div class="hidden lg:grid grid-cols-6 gap-8 mb-4">
                {{-- Column 1: Logo & About --}}
                ...
                {{-- Column 3: Contact --}}
                <div class="reveal col-span-3" data-variant="fade-left" data-delay="200">
