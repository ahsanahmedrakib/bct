...
@section('content')
        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">In today's
                    digital-first world, cybersecurity is no longer optional — it's a necessity. Microsoft 365 stands out as
                    a comprehensive suite designed to not only enhance productivity but also provide top-tier cybersecurity
                    features.</p>
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="Microsoft 365 Cyber Security" loading="lazy" class="rounded-lg"
    ...
    <section class="py-24 bg-white" id="overview">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal reveal-fade-up space-y-6">
                ...
                <p class="text-slate-600 leading-relaxed text-justify">Microsoft 365 is a powerful suite of productivity
                ...
                <p class="text-slate-600 leading-relaxed text-justify">Cybersecurity in Microsoft 365 is essential to
    ...
    <section class="py-24 bg-slate-50" id="security-areas">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Microsoft 365 provides comprehensive protection
    ...
    <section class="py-24 bg-white" id="features">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Essential cybersecurity features of Microsoft 365
    ...
    <section class="py-16 bg-slate-50" id="help">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="reveal reveal-fade-up bg-linear-to-br from-blue-600 to-blue-800 rounded-2xl p-8 lg:p-12 text-white">
