...
@section('content')
        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">In today's
                    digital-first world, cybersecurity is no longer optional — it's a necessity. Businesses of all sizes
                    face
                    increasingly sophisticated threats, making robust security solutions critical for safeguarding sensitive
                    data. Microsoft 365 stands out as a comprehensive suite designed to not only enhance productivity but
                    also
    ...
    <section class="py-16 lg:py-24 bg-white" id="overview">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-6 leading-tight">Why Microsoft 365 Cyber
                    Security Matters</h2>
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Microsoft 365 is a powerful suite of
                    productivity
                ...
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Cybersecurity in Microsoft 365 is
                    essential to
                ...
                <p class="text-slate-500 text-sm leading-relaxed mb-8 text-justify">Microsoft 365 security solutions help
                    businesses
                    strengthen their cyber posture, meet compliance requirements, and operate securely in today's
                    cloud-first world.</p>
                ...
                @foreach ($areas as $area)
                    <div
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            <div
                                class="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-blue-600 shrink-0">
    ...
    <section class="py-16 lg:py-24 bg-white" id="advanced">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 reveal reveal-fade-up">
                ...
                <p class="text-slate-600 text-center max-w-2xl mx-auto">Advanced cybersecurity features in Microsoft 365
                    are designed to
                    deliver enterprise-grade protection for identities, data, devices, and applications in a modern cloud
                    environment</p>
            </div>
            <div class="grid md:grid-cols-2 gap-8">
                <div
                    class="reveal reveal-fade-up bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all relative h-full flex flex-col">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <span class="text-blue-500 font-bold text-sm tracking-wide mb-3 block">Enterprise-Grade
                        Protection</span>
                    <h3 class="text-xl font-bold text-slate-800 mb-4">Advanced Threat Protection</h3>
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">These capabilities go beyond
                        baseline security, helping
                        organisations proactively defend against advanced cyber threats, targeted attacks, and data
                        breaches.</p>
                    <div class="space-y-4 mt-auto">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-sm text-justify">Enable organisations to enforce security
                                    rules based on user roles, device compliance, location, and risk level, significantly
                                    reducing the impact of compromised credentials.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-sm text-justify">ATP helps identify and respond to zero-day
                                    attacks and sophisticated threats with real-time threat intelligence.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Combined with centralised audit
                        logging, continuous
                        monitoring, and security reporting, these advanced Microsoft 365 cybersecurity features provide
                    ...
                    <div class="space-y-4 mt-auto">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-sm text-justify">Protect admin accounts using role-based
                                    access controls and enhanced monitoring to prevent unauthorised access.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-sm text-justify">Continuous monitoring and security reporting
                                    provide strong visibility and control across all endpoints.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">The password policy in Microsoft
                        365, managed through Azure Active Directory (Azure AD), enforces strong security measures to protect
                        user accounts.</p>
                    <div class="space-y-3 mb-8">
                        <div class="flex items-start gap-3">
                            ...
                            <span class="text-slate-600 text-sm">Supports password complexity requirements including
                                length, special characters, and expiration periods</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-600 text-sm">Self-service password reset (SSPR) allows users to
                                securely reset passwords without IT intervention</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-600 text-sm">Azure AD Password Protection prevents weak or commonly
                                used passwords using global banned password lists</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-600 text-sm">Multi-Factor Authentication (MFA) and Conditional Access
                                Policies for added security</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-600 text-sm">Aligns with ACSC Essential 8, ensuring compliance and
                                protection against password-related attacks</span>
                        </div>
                    </div>
                    <a href="#data-protection"
                        class="text-blue-600 font-medium flex items-center hover:text-blue-800">Data Protection
                        <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Microsoft 365 data protection is
                        built on enterprise-grade security designed to safeguard business information across emails, files,
                        devices, and cloud applications.</p>
                    <div class="space-y-3 mb-8">
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-600 text-sm">Microsoft Purview protects sensitive data with encryption,
                                Data Loss Prevention (DLP), and compliance controls</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-600 text-sm">Azure Active Directory (Entra ID) secures identity
                                management with Multi-Factor Authentication (MFA)</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-600 text-sm">Microsoft Sentinel provides Security Information and Event
                                Management (SIEM) for real-time threat detection</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-600 text-sm">Aligns with frameworks like ACSC Essential 8, ensuring
                                secure and compliant cloud operations</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-600 text-sm">Supports compliance with ISO 27001, SOC 2, and HIPAA
                                requirements</span>
                        </div>
                    </div>
                    <a href="#essential-eight"
                        class="text-blue-600 font-medium flex items-center hover:text-blue-800">Essential Eight
                        <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
    ...
    <section class="py-16 lg:py-24 bg-slate-50" id="essential-eight">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 reveal reveal-fade-up">
                ...
                <p class="text-slate-600 text-center max-w-2xl mx-auto mb-6">The ACSC Essential Eight, developed by the
                    Bangladeshi Cyber Security Centre, is a proven framework designed to help organisations protect against
                    cyber attacks, ransomware, and data breaches.</p>
                <p class="text-slate-600 text-center max-w-2xl mx-auto">It focuses on practical, high-impact controls that
                    significantly reduce cybersecurity risk when implemented correctly. Microsoft 365 security features
                    align with these controls to help businesses achieve compliance.</p>
            </div>
    ...
    <section class="py-16 lg:py-24 bg-white" id="help">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            <div
                class="reveal reveal-fade-up relative w-full rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100">
            ...
            <div
                ...
                <p class="text-blue-100 text-sm leading-relaxed mb-6 text-justify">At BCT, we help
                ...
                <p class="text-blue-100 text-sm mb-6">Whether you need a Microsoft Defender health check or a
                    comprehensive Microsoft 365 security review, we're here to help strengthen your organisation's security
                    posture.</p>
                <a href="/contact"
                ...
                @php
                    $usefulLinks = [
                        [
                            ...
                            'href' =>
                                'https://www.microsoft.com/en-us/security/business/endpoint-security/microsoft-defender-for-business',
                        ],
                        [
            ...
            <div class="space-y-4">
                @php
                    $faqs = [
                        ...
                        [
                            'question' => 'How can BCT help with Microsoft 365 security?',
                            'answer' =>
