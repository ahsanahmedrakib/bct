...
@section('content')
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Ensuring identity
                    security has become paramount in the evolving work landscape, particularly with the flexibility of
                    remote app access. Establishing secure access to your network and applications starts with Azure Active
                    Directory.</p>
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="Microsoft Entra ID" loading="lazy" class="rounded-lg w-full max-w-md lg:max-w-lg"
                    src="/images/cloud/microsoft-solutions/entra-id/entra-id.png" />
            </div>
        </div>
    ...
    <section class="py-16 lg:py-24 bg-white" id="overview">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-6 leading-tight">Identity & Access Management
                </h2>
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Ensuring identity security has become
                    paramount in the evolving work landscape, particularly with the flexibility of remote app access.
                    Establishing secure access to your network and applications starts with Azure Active Directory.</p>
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Azure Active Directory (Azure AD) serves
                    as the bedrock of your cloud identity and serves as the security boundary for all Microsoft online
                    services, including Microsoft 365. As an enterprise identity solution, Azure AD offers single sign-on,
                    multi-factor authentication, and conditional access features to safeguard your users against 99.9% of
                    cyber threats.</p>
                <p class="text-slate-500 text-sm leading-relaxed mb-8 text-justify">Microsoft Entra ID provides a
                    comprehensive identity and access management solution that helps you manage user identities, control
                    access to resources, and protect against security threats across your entire organisation.</p>
                ...
                @php
                    $features = [
                        [
                            ...
                            'desc' =>
                                'Connect your workforce to all your apps, from any location, using any device. Simplify access to your apps from anywhere.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Help safeguard access to data and apps and keep it simple for users. Add an extra layer of security to the login process.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Apply the right access controls to keep your organisation more secure. Enforce policies based on user, location, device, and risk.',
                            'icon' =>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-start">
                <div>
                    <h2 class="text-3xl font-bold text-blue-900 mb-4">Protect your business with a universal identity
                        platform</h2>
                    <p class="text-slate-600 text-sm leading-relaxed mb-8 text-justify">The Azure Active Directory (Azure
                        AD) enterprise identity service provides single sign-on and multi-factor authentication to help
                        protect your users from 99.9 percent of cybersecurity attacks.</p>
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-slate-700 text-sm">Single sign-on simplifies access to your apps from
                                anywhere</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="text-blue-600 shrink-0 mt-0.5 w-5 h-5" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span class="text-slate-700 text-sm">Conditional Access and multi-factor authentication help
                                protect and govern access</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="text-blue-600 shrink-0 mt-0.5 w-5 h-5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-700 text-sm">A single identity platform lets you engage with internal
                                and external users more securely</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="text-blue-600 shrink-0 mt-0.5 w-5 h-5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="text-slate-700 text-sm">Developer tools make it easy to integrate identity into
                                your apps and services</span>
                        </li>
                    </ul>
                </div>
                <div
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Azure AD is the bedrock of your
                        cloud identity and serves as the security boundary for all Microsoft online services, including
                        Microsoft 365. It provides single sign-on, multi-factor authentication, and conditional access
                        features to safeguard your users.</p>
                    @php
                        $azureFeatures = [
                            [
                                'title' => 'Single sign-on simplifies access to your apps from anywhere',
                                'desc' =>
                                    'Users only need one set of credentials to access all their applications, whether they\'re in the office or working remotely.',
                            ],
                            [
                                'title' =>
                                    'Conditional Access and multi-factor authentication help protect and govern access',
                                'desc' =>
                                    'Enforce security policies based on user identity, location, device compliance, and risk level to ensure the right people have the right access.',
                            ],
                            [
                                'title' =>
                                    'A single identity platform lets you engage with internal and external users more securely',
                                'desc' =>
                                    'Manage identities for employees, customers, and partners from a unified platform, extending your security boundary beyond organisational walls.',
                            ],
                            [
                                'title' =>
                                    'Developer tools make it easy to integrate identity into your apps and services',
                                'desc' =>
                                    'Accelerate adoption of your applications by supporting single sign-on and user provisioning with built-in developer tools and APIs.',
                            ],
                        ];
                    @endphp
                    <div class="space-y-4">
    ...
    <section class="py-16 lg:py-24 bg-white" id="details">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
            @php
                $featureSections = [
                    [
                    ...
                    [
                        ...
                        'links' => [
                            [
                                ...
                                'href' =>
                                    'https://azure.microsoft.com/en-us/services/active-directory/customer-partner-identity/',
                            ],
                        ],
                    ],
                    [
            ...
            @foreach ($featureSections as $index => $section)
                <div class="reveal reveal-fade-up grid lg:grid-cols-2 gap-12 items-center">
                    <div class="flex justify-center {{ $index % 2 !== 0 ? 'lg:order-2 order-1' : '' }}">
                        <img src="{{ $section['image'] }}" alt="{{ $section['title'] }}" class="object-cover"
                            loading="lazy" />
                    </div>
                    <div
                        class="bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all relative h-full {{ $index % 2 !== 0 ? 'lg:order-1 order-2' : '' }}">
                        <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                        <h3 class="text-2xl font-bold text-slate-900 mb-4">{{ $section['title'] }}</h3>
                        <p class="text-slate-600 text-sm leading-relaxed mb-6 text-justify">{{ $section['description'] }}
                        </p>
                        <div class="space-y-3">
                            @foreach ($section['links'] as $link)
                                <a href="{{ $link['href'] }}" target="_blank"
                                    class="text-blue-600 font-semibold text-sm hover:underline block">{{ $link['label'] }}
                                    &rarr;</a>
                            @endforeach
                        </div>
                    </div>
                ...
                @php
                    $benefits = [
                        [
                            ...
                            'desc' =>
                                'Azure AD serves as the bedrock of your cloud identity, providing a single platform to manage identities for employees, customers, and partners across your entire organisation.',
                        ],
                        [
                            'title' => '99.9% Threat Protection',
                            'desc' =>
                                'Enterprise-grade single sign-on, multi-factor authentication, and conditional access features safeguard your users against 99.9% of cybersecurity attacks.',
                        ],
                        [
                            'title' => 'Seamless Remote Access',
                            'desc' =>
                                'Whether people are on-site or remote, Entra ID gives them seamless access to all their apps so they can stay productive from anywhere, on any device.',
                        ],
                        [
                            'title' => '2,800+ SaaS Integrations',
                            'desc' =>
                                'Azure AD supports more than 2,800 pre-integrated SaaS applications, making it easy to connect your workforce to all the tools they need.',
                        ],
                        [
                            'title' => 'Granular Access Control',
                            'desc' =>
                                'Conditional Access policies let you apply the right access controls based on user identity, location, device compliance, and risk level.',
                        ],
                        [
                            'title' => 'Developer-Friendly Integration',
                            'desc' =>
                                'Built-in developer tools make it easy to integrate identity into your apps and services, supporting SSO and automated user provisioning.',
                        ],
                    ];
                @endphp
    ...
    <section class="py-16 lg:py-24 bg-white" id="faq">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-356 mx-auto space-y-4">
                @php
                    $faqs = [
                        [
                        ...
                        [
                            'question' => 'Can I use Entra ID for external users like customers and partners?',
                            'answer' =>
