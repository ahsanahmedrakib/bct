...
@section('content')
        ...
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div
                ...
                <a href="#plans" class="text-blue-600 font-medium flex items-center hover:text-blue-800">
                    View Plans <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-center gap-3">
                                <svg class="w-5 h-5 shrink-0 text-slate-600" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="reveal reveal-fade-up relative h-full">
                    <div
                        ...
                        <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                        <span
                            class="absolute -top-3 left-1/2 -translate-x-1/2 bg-blue-400 text-white text-xs font-bold px-4 py-1 rounded-full">Most
                            Popular</span>
        ...
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Store files safely in the cloud and access them
                        instantly
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Chat, call, video meet, and collaborate with your team
                        in
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Microsoft 365 Cloud includes Word, Excel, PowerPoint,
                        and
    ...
    <section class="py-16 lg:py-24 bg-white" id="collaboration">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div
                class="reveal reveal-fade-up bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all relative h-full order-2 lg:order-1">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="flex items-center gap-2 text-sm text-slate-700">
                        <svg class="w-4 h-4 shrink-0 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <div class="reveal reveal-fade-up flex justify-center order-1 lg:order-2">
                <img src="/images/cloud/microsoft-solutions/micrsoft-365/collaboration.png"
                    alt="Microsoft 365 Collaboration" class="object-cover" loading="lazy" />
            </div>
        </div>
    </section>
    ...
    <section class="py-16 lg:py-24 bg-slate-50" id="sharepoint">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div
                class="reveal reveal-fade-up bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all relative h-full order-1 lg:order-2">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
        ...
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div
                ...
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Copilot can draft documents, rewrite
                    ...
                    Teams, it captures meeting summaries, action items, and key discussion points, helping teams stay
                    aligned
                    and productive.</p>
                <div class="grid grid-cols-2 gap-3">
                    <div class="flex items-center gap-2 text-sm text-slate-700">
    ...
    <section class="py-16 lg:py-24 bg-slate-900 text-white" id="security">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div
                    class="reveal reveal-fade-up flex items-start gap-4 bg-slate-800/80 border border-slate-700/60 hover:border-blue-500/50 rounded-xl p-5 transition-all">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-300 leading-relaxed text-justify">Control who can access what, when,
                            and
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-300 leading-relaxed text-justify">Ensure only trusted and secure
                            devices
                ...
                <div
                    ...
                    <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white shrink-0">
                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.568 8.268M5.742 6.364A7.465 7.465 0 004.5 10.5a48.667 48.667 0 00-1.418 8.773 7.46 7.46 0 01-1.19-3.467zM12.75 10.5a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm.75 3.75a.75.75 0 100-1.5.75.75 0 000 1.5zm-.75-6a.75.75 0 10-1.5 0 .75.75 0 001.5 0z" />
                        </svg>
                    </div>
                    <div>
            ...
            <div class="reveal reveal-fade-up mt-12 bg-slate-800/60 border border-slate-700/60 rounded-2xl p-8">
                ...
                <p class="text-slate-300 text-sm leading-relaxed text-justify mb-4">Microsoft 365 data protection is built
                    on
                ...
                <p class="text-slate-300 text-sm leading-relaxed text-justify">Sensitive information is secured through
                    Data
            ...
            <div class="space-y-4">
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <button onclick="this.parentElement.classList.toggle('open')"
                        ...
                        <svg class="w-5 h-5 text-blue-600 shrink-0 transition-transform duration-300 faq-icon"
                    ...
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-300">
                        <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">Microsoft 365 is a cloud-based
                            productivity and collaboration platform that includes Microsoft Word, Excel, PowerPoint,
                            Outlook,
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <button onclick="this.parentElement.classList.toggle('open')"
                        class="w-full flex justify-between items-center px-6 py-5 text-left">
                        <span class="font-medium text-slate-900 pr-4">What is included in Microsoft 365 for
                            business?</span>
                        <svg class="w-5 h-5 text-blue-600 shrink-0 transition-transform duration-300 faq-icon"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-300">
                        <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">Yes. Microsoft 365 includes
                            multi-factor
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-300">
                        <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">Absolutely. Microsoft 365 is designed
                            for
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <button onclick="this.parentElement.classList.toggle('open')"
                        class="w-full flex justify-between items-center px-6 py-5 text-left">
                        <span class="font-medium text-slate-900 pr-4">What is the difference between Business Basic,
                            Standard, and Premium?</span>
                        <svg class="w-5 h-5 text-blue-600 shrink-0 transition-transform duration-300 faq-icon"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                    ...
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-300">
                        <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">Business Basic includes web apps and
                            email, Business Standard adds desktop Office apps, and Business Premium includes advanced
                            security
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-300">
                        <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">Microsoft provides data retention, but
                            many
