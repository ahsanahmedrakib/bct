    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="Microsoft 365 Modern Workplace" loading="lazy" class="rounded-lg"
    ...
    <section class="py-24 bg-white" id="overview">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal reveal-fade-up space-y-6">
                ...
                <p class="text-slate-600 leading-relaxed text-justify">Microsoft 365 Modern Workplace is a cloud-first
                ...
                <p class="text-slate-600 leading-relaxed text-justify">The modern workplace enables employees to work from
                ...
                <p class="text-slate-600 leading-relaxed text-justify">Security and management are core components of the
    ...
    <section class="py-24 bg-slate-50" id="core-apps">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Microsoft 365 includes the essential tools
    ...
    <section class="py-24 bg-white" id="benefits">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">By combining productivity, flexibility, cyber
    ...
    <section class="py-16 bg-slate-50" id="help">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="reveal reveal-fade-up bg-linear-to-br from-blue-600 to-blue-800 rounded-2xl p-8 lg:p-12 text-white">
                ...
                <p class="text-blue-100 text-sm leading-relaxed mb-8 max-w-3xl text-justify">Total Solutions IT helps
