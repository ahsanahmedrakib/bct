    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">If you are considering
                    migrating to the
                    cloud, let BCT guide you on your journey. Our team of accredited specialists have the
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 md:w-3/4 w-full">
                    <a href="#benefits"
                        class="group flex cursor-pointer items-center justify-between px-6 py-4 text-white text-sm font-semibold rounded-xl shadow-md transition-all bg-navy hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg">BENEFITS
                    ...
                    <a href="#services"
                        class="group flex cursor-pointer items-center justify-between px-6 py-4 text-white text-sm font-semibold rounded-xl shadow-md transition-all bg-navy hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg">SERVICES
                        <svg class="w-4 h-4 text-sky-300 transition-transform group-hover:translate-x-1"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m9 18 6-6-6-6" />
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="Cloud Services" loading="lazy" class="rounded-lg w-full" src="/images/cloud/hero.png" />
            </div>
        </div>
                ...
                @php
                    $benefits = [
                        [
                            'title' => 'Scalability',
                            'desc' =>
                                'Scale infrastructure up or down easily based on point in time needs. Whether it\'s increasing storage capacity, computing power, or network bandwidth, the cloud provides flexibility to meet fluctuating demands without the need for significant upfront investments.',
                        ],
                        [
                            'title' => 'Accessibility',
                            'desc' =>
                                'The cloud enables employees to access data, applications, and resources - anytime, from anywhere. This fosters remote work, collaboration across distributed teams, and increases productivity by eliminating geographical constraints.',
                        ],
                        [
                            'title' => 'Enhanced security',
                            'desc' =>
                                'Cloud provides advanced security protocols, encryption techniques, and monitoring systems to ensure data privacy and protection against unauthorised access.',
                        ],
                        [
                            'title' => 'Cost efficiencies',
                            'desc' =>
                                'Rather than investing in expensive hardware and software upfront, organisations can pay for cloud resources on a subscription or consumption basis – eliminating the need for maintaining and upgrading expensive infrastructure.',
                        ],
                        [
                            'title' => 'Business continuity',
                            'desc' =>
                                'By leveraging the cloud, enterprises can implement effective disaster recovery plans, ensuring that critical data and applications are protected and can be quickly restored in the event of an outage or other unforeseen circumstance.',
                        ],
                        [
                            'title' => 'Rapid deployment',
                            'desc' =>
                                'Quickly deploy applications and services, reducing time-to-market for new products or features. Ready-to-use infrastructure and development tools, allows developers to focus on coding rather than setting up and configuring hardware and software.',
                        ],
                        [
                            'title' => 'Innovation and agility',
                            'desc' =>
                                'Experiment and innovate at a faster pace with cutting-edge technologies, such as artificial intelligence, machine learning, and big data analytics.',
                        ],
                    ];
                @endphp
                ...
                @php
                    $services = [
                        [
                            ...
                            'desc' => 'BCT will help you get the most out of your Microsoft 365 service.',
                        ],
                        [
                            'title' => 'Windows 365',
