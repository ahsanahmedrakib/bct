...
@section('content')
    ...
    <section class="py-24 bg-white" id="overview">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div
                class="reveal reveal-fade-up bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 transition-all relative h-full">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <span class="text-blue-500 font-bold text-sm tracking-wide mb-3 block">Endpoint Security for SMBs</span>
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-6 leading-tight">What is Microsoft Defender for
                    Business?</h2>
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">
                    Microsoft Defender for Business is an endpoint security solution based on Microsoft Defender for
                    Endpoint. It is designed for small and medium-sized businesses up to 300 users, offering protection from
                    ransomware, malware, phishing, and other threats on devices.
                </p>
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">
                    It also offers performance monitoring and privacy controls to ensure safe browsing and system health.
                    Regular updates and seamless integration with Windows make Microsoft Defender a convenient choice for
                    maintaining security without additional software. Its integration with Microsoft 365 provides enhanced
                    security features for enterprise environments, making it a versatile solution for both personal and
                    professional use.
                </p>
                <p class="text-slate-500 text-sm leading-relaxed mb-8 text-justify">
                    Defender for Business is available as a standalone subscription or as part of Microsoft 365 Business
                    Premium. It supports Windows, macOS, iOS, and Android devices, providing enterprise-grade security
                    across your entire device estate from a single, simplified management console.
                </p>
    ...
    <section class="py-24 bg-white" id="what-is">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div
                class="reveal reveal-fade-up bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 transition-all relative h-full order-2 lg:order-1">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <h2 class="text-3xl text-center font-bold text-blue-900 mb-6">What is Microsoft Defender for Business, and
                    could it suit your Business?</h2>
                <div class="space-y-6">
                    <p class="text-slate-600 text-sm leading-relaxed text-justify">
                        Small and Medium Enterprises (SMEs) form the backbone of the Bangladeshi economy and play a crucial
                        role in the supply chain. However, in today's digital era, this significance also brings challenges.
                        SMEs are increasingly targeted by malicious actors due to a fiercely competitive market and limited
                        budgets for security measures, unlike larger corporations.
                    </p>
                    <p class="text-slate-600 text-sm leading-relaxed text-justify">
                        Over recent years, SMEs have embraced cloud technology for their operations, which has enhanced
                        flexibility and mobility, positively impacting our daily lives. Yet, this shift has altered the risk
                        landscape, emphasizing the importance of Endpoints and the necessity for a Zero Trust Architecture.
                        The traditional notion of 'trust, but verify' is outdated, especially in light of current global
                        events.
                    </p>
                    <p class="text-slate-600 text-sm leading-relaxed text-justify">
                        As Endpoints gain prominence and attackers become more sophisticated, conventional Endpoint
                        protection methods like antivirus software fall short. SMEs often struggle to afford
                        Enterprise-grade features such as Endpoint Detection and Response (EDR) and Threat and Vulnerability
                        Management. However, the introduction of Microsoft Defender for Business aims to address this issue,
                        offering SMEs a more accessible solution.
                    </p>
                </div>
            </div>
    ...
    <section class="py-24 bg-slate-50" id="features">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                <h2 class="text-3xl md:text-4xl font-bold text-blue-900">Key Features of Microsoft Defender for Business
                </h2>
                <p class="mt-4 text-slate-600 max-w-2xl mx-auto">Comprehensive endpoint security with AI-powered threat
                    protection</p>
            </div>
            @php
                $keyFeatures = [
                    [
                        ...
                        'desc' =>
                            'Advanced antivirus and anti-malware protection using cloud-powered intelligence, machine learning, and behavioral heuristics to detect and block new and emerging threats in real time.',
                        'icon' =>
                    ...
                    [
                        ...
                        'desc' =>
                            'AI-powered EDR continuously monitors endpoint activities and generates alerts for suspicious behavior, enabling you to detect, investigate, and respond to advanced threats.',
                        'icon' =>
                    ...
                    [
                        ...
                        'desc' =>
                            'Automated investigation and remediation capabilities automatically resolve most cyberthreats with minimal IT effort, reducing response time from hours to minutes.',
                        'icon' =>
                    ...
                    [
                        ...
                        'desc' =>
                            'Discover, prioritize, and remediate software vulnerabilities and misconfigurations that pose the most urgent and highest risk to your business.',
                        'icon' =>
                    ...
                    [
                        ...
                        'desc' =>
                            'Block malicious macros, scripts, USB exploits, and other risky actions with built-in attack surface reduction rules that minimize vulnerabilities in devices and applications.',
                        'icon' =>
                            '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285zM12 15.75h.007v.008H12v-.008z" />',
                    ],
                    [
                        'title' => 'Ransomware Protection',
                        'desc' =>
                            'Built-in ransomware mitigation with controlled folder access, behavior monitoring, and automatic attack disruption to stop ransomware before it encrypts your data.',
                        'icon' =>
                    ...
                    [
                        ...
                        'desc' =>
                            'Protect Windows, macOS, iOS, and Android devices from a single management console, ensuring consistent security across your entire device estate.',
                        'icon' =>
                    ...
                    [
                        ...
                        'desc' =>
                            'Server security available as an add-on, providing simplified onboarding and management with security policies activated out of the box to quickly secure servers.',
                        'icon' =>
                    ...
                    [
                        ...
                        'desc' =>
                            'Receive monthly security summary reports to track your protection status, including threats blocked, device health, and pending vulnerabilities.',
                        'icon' =>
    ...
    <section class="py-24 bg-white" id="capabilities">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-slate-600 max-w-2xl mx-auto">Enterprise-grade protection designed for small and
            ...
            @php
                $capabilities = [
                    ...
                    [
                        'title' => 'Threat & Vulnerability Management',
                        'desc' =>
                            'Proactively discover, prioritize, and remediate vulnerabilities and misconfigurations early. Get a clear view of your cyberattack surface with actionable security recommendations to strengthen your defenses.',
                    ],
                    [
                        'title' => 'Attack Surface Reduction',
                        'desc' =>
                            'Minimize vulnerabilities with built-in capabilities including ransomware mitigation, application control, web protection, network protection, network firewall, and attack surface reduction rules.',
                    ],
                    [
                        'title' => 'Centralized Management',
                        'desc' =>
                            'Single dashboard in Microsoft 365 Defender to monitor, act, and report across all your endpoints. Wizard-based onboarding and simplified management experience for IT administrators.',
                    ],
                ];
            @endphp
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <section class="py-24 bg-slate-50" id="nist">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-slate-600 max-w-2xl mx-auto">Defender for Business encompasses functionality across all
                    five key functions outlined in the NIST Cyber Security Framework</p>
            </div>
            @php
                $nistFramework = [
                    [
                        'title' => 'Identify',
                        'desc' =>
                            'Threat & Vulnerability Management provides asset visibility, intelligent assessments, and built-in remediation tools for various platforms, including Windows, macOS, Linux, Android, iOS, and network devices. It prioritizes vulnerabilities on critical assets and offers security recommendations for risk mitigation.',
                        'icon' =>
                    ...
                    [
                        'title' => 'Detect',
                        'desc' =>
                            'Endpoint Detection & Response (EDR) offers advanced attack detection capabilities in near real-time. Security analysts can efficiently prioritize alerts, gain visibility into breach scopes, and take response actions to mitigate threats.',
                        'icon' =>
                            '<path stroke-linecap="round" stroke-linejoin="round" d="M12 18a6 6 0 100-12 6 6 0 000 12z" /><path stroke-linecap="round" stroke-linejoin="round" d="M12 14a2 2 0 100-4 2 2 0 000 4z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12a8.25 8.25 0 0116.5 0" />',
                    ],
                    [
                        'title' => 'Respond',
                        'desc' =>
                            'Auto Investigation & Remediation (AIR) utilizes various inspection algorithms and processes akin to those used by security analysts. AIR examines alerts and promptly takes action to resolve breaches, thereby reducing response times and minimizing damage.',
                        'icon' =>
                    ...
                    [
                        'title' => 'Recover',
                        'desc' =>
                            'Defender for Business supports recovery through automated remediation capabilities that restore affected systems and files. The solution helps organizations quickly return to a secure state after a security incident.',
                        'icon' =>
    ...
    <section class="py-24 bg-white" id="included">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-slate-600">Defender for Business is a collection of capabilities bundled into a single
                    Managed Security Services offering</p>
            </div>
            @php
                $includedFeatures = [
                    ...
                    [
                        'feature' => 'Cross platform support for Windows, MacOS, iOS, and Android clients',
                        'included' => true,
                    ],
                    ['feature' => 'Windows server and Linux server', 'included' => 'Add-on'],
                    ['feature' => 'Partner APIs', 'included' => true],
                    [
                        'feature' => 'Microsoft 365 Lighthouse for viewing security incidents across customers',
                        'included' => true,
                    ],
            ...
            @endphp
            <div
                class="reveal reveal-fade-up bg-white border-2 border-blue-100 rounded-xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                <div class="grid grid-cols-2 gap-px bg-blue-100">
                    <div class="bg-brand-blue text-white font-bold text-sm px-6 py-3">Feature</div>
                    <div class="bg-brand-blue text-white font-bold text-sm px-6 py-3 text-center">Defender for Business
                    </div>
                </div>
    ...
    <section class="py-24 bg-slate-50" id="comparison">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @endphp
            <div
                class="reveal reveal-fade-up bg-white border-2 border-blue-100 rounded-xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-x-auto">
                        ...
                        @foreach ($featureTable as $row)
                            <tr class="{{ $loop->even ? 'bg-blue-50/50' : 'bg-white' }}">
                                ...
                                <td class="px-4 py-3 text-center">
                                    @if ($row['db'] === true)
                                        <svg class="w-5 h-5 text-green-500 mx-auto" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M4.5 12.75l6 6 9-13.5" />
                                        </svg>
                                    @elseif ($row['db'] === false)
                                        <svg class="w-5 h-5 text-red-400 mx-auto" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <section class="py-24 bg-slate-50" id="benefits">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                <h2 class="text-3xl md:text-4xl font-bold text-blue-900">Benefits of Using Microsoft Defender for Business
                </h2>
                <p class="mt-4 text-slate-600 max-w-2xl mx-auto">Why businesses choose Defender for enterprise-grade
                    endpoint security</p>
            </div>
            @php
                $benefits = [
                    [
                        ...
                        'desc' =>
                            'Access the same powerful endpoint security capabilities used by Fortune 500 companies, optimized and priced for small and medium-sized businesses with up to 300 employees.',
                    ],
                    [
                        'title' => 'Cost-Effective Protection',
                        'desc' =>
                            'At just $3.00 per user/month, Defender for Business provides comprehensive device security including next-gen antivirus, EDR, vulnerability management, and automated remediation.',
                    ],
                    [
                        'title' => 'Reduced IT Overhead',
                        'desc' =>
                            'Automated investigation and remediation capabilities resolve most threats automatically, reducing the burden on IT staff and eliminating the need for a dedicated security operations center.',
                    ],
                    [
                        'title' => 'Proactive Threat Prevention',
                        'desc' =>
                            'Move beyond reactive antivirus to proactive threat hunting with vulnerability management, attack surface reduction rules, and behavioral analysis that catches threats before they execute.',
                    ],
                    [
                        'title' => 'Unified Security Console',
                        'desc' =>
                            'Manage all endpoint security from a single, simplified dashboard in Microsoft 365 Defender, providing complete visibility across Windows, macOS, iOS, and Android devices.',
                    ],
                    [
                        'title' => 'Seamless Microsoft 365 Integration',
                        'desc' =>
                            'Integrates with Microsoft Intune for device compliance, Conditional Access policies, and the wider Microsoft 365 security ecosystem for comprehensive protection.',
                    ],
                ];
            @endphp
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <section class="py-24 bg-white" id="limitations">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-slate-600">While Defender for Business offers robust endpoint protection, certain
                    advanced capabilities available in Defender for Endpoint P2 may not be included</p>
            </div>
            @php
                $limitations = [
            ...
            @endphp
            <div
                class="reveal reveal-fade-up bg-white border-2 border-blue-100 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                <ul class="space-y-3">
                    @foreach ($limitations as $limitation)
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-red-400 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                            </svg>
