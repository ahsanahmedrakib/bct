...
@section('content')
        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Microsoft
                    <span class="text-brand-blue block mt-2"> Intune</span>
                </h1>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div
                class="reveal reveal-fade-up bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 relative h-full">
                ...
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Microsoft Intune is a cloud-based
                    endpoint
                    management solution that helps organisations manage and secure devices, apps, and data across their
                    entire
                    fleet — whether corporate-owned or personal. As part of the Microsoft Endpoint Manager suite, Intune
                    provides
                    a unified platform for device configuration, application deployment, compliance enforcement, and
                    security
                    management.</p>
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Intune enables IT teams to manage
                    Windows,
                    macOS, iOS, Android, and Linux devices from a single console. It supports both Mobile Device Management
                    (MDM)
                    and Mobile Application Management (MAM), giving organisations flexibility in how they control corporate
                    data on
                ...
                <p class="text-slate-500 text-sm leading-relaxed mb-8 text-justify">With features like Windows Autopilot for
                    zero-touch deployment, Endpoint Analytics for performance insights, and integration with Microsoft
                    Defender for
                    threat detection, Intune provides comprehensive endpoint management that scales with your organisation's
                    needs.</p>
                <a href="#key-features" class="text-blue-600 font-medium flex items-center hover:text-blue-800">Key Features
    ...
    <section class="py-24 bg-white" id="key-features">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-slate-600 max-w-2xl mx-auto">Everything you need for comprehensive endpoint management
                    and
                    device security</p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Deploy configuration profiles and compliance policies
                        across
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Push, update, and manage applications across your fleet
                        with
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Zero-touch Windows device deployment that configures
                        devices
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Monitor device performance, startup times, and user
                        experience
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Create and deploy device configuration profiles
                                to
                                enforce settings across Windows, macOS, iOS, and Android devices — including Wi-Fi, VPN,
                                email,
                                and security settings.</p>
                        </div>
                        <div>
                            <h4 class="text-sm font-bold text-slate-900 mb-1">Compliance Policies</h4>
                            <p class="text-sm text-slate-600 text-justify">Define compliance rules (e.g., minimum OS
                                version,
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Use the Settings Catalog to access a
                                comprehensive
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Deploy Windows devices directly to end users
                                without
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Users sign in with their corporate credentials
                                and
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">For kiosk or shared device scenarios, Autopilot
                                can
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Monitor device boot times, logon performance,
                                and
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Track and benchmark startup performance across
                                your
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Create and deploy scripts that automatically
                                detect
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Ensure all devices meet your organisation's
                                security
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Integrate with Microsoft Defender for Endpoint
                                to
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Enforce access controls based on device
                                compliance,
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Enroll corporate-owned and BYOD devices to gain
                                full
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Remotely remove only corporate data from a
                                device
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Organise devices into categories based on
                                department,
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Seamlessly integrate with Azure Active Directory
                                for
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Enforce MFA requirements for device enrollment
                                and
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Manage devices outside the corporate network
                                without
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Use Intune alongside Configuration Manager
                                (SCCM) to
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Gain visibility into your entire device fleet
                                with
                                detailed hardware and software inventory reports.</p>
                        </div>
                        <div>
                            <h4 class="text-sm font-bold text-slate-900 mb-1">Audit Logs</h4>
                            <p class="text-sm text-slate-600 text-justify">Track all administrative actions and changes
                                made in
                                Intune for compliance auditing and troubleshooting.</p>
                        </div>
                        <div>
                            <h4 class="text-sm font-bold text-slate-900 mb-1">Diagnostic Reports</h4>
                            <p class="text-sm text-slate-600 text-justify">Generate diagnostic reports for individual
                                devices to
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Control the deployment of Windows updates across
                                your
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600 text-justify">Manage Windows feature update adoption with
                                phased
        ...
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 relative rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm mb-4">Technical documentation for Microsoft Intune — including
                        deployment
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 relative rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm mb-4">Understand how Windows Autopilot simplifies device deployment
                        with
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 relative rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm mb-4">Compare Microsoft Intune plans and pricing — find the right
                        option
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-slate-600 max-w-2xl mx-auto">Why organisations choose Intune for endpoint management
                </p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Manage Windows, macOS, iOS, Android, and Linux devices
                        from
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Automated compliance checks and conditional access
                        policies
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Cloud-based management eliminates the need for
                        on-premises
            ...
            <div class="space-y-4">
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">Microsoft Intune is a cloud-based endpoint
                            management
                            solution that helps organisations manage and secure devices, apps, and data across their entire
                            fleet.
                            It provides Mobile Device Management (MDM) and Mobile Application Management (MAM) capabilities
                            from
                            a single console.</p>
                    </div>
                </div>
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">Intune supports management of Windows, macOS,
                            iOS,
                            Android, and Linux devices. It provides platform-specific features while maintaining a
                            consistent
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">Windows Autopilot is a collection of technologies
                            used
                            to set up and pre-configure new devices, getting them ready for productive use. It enables
                            zero-touch
                            deployment where devices automatically configure themselves when first powered on, without IT
                            needing
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">Intune supports BYOD through Mobile Application
                            Management (MAM), which protects corporate data within apps on personal devices without
                            requiring full
                            device enrollment. Users maintain privacy over their personal data while corporate information
                            remains
                            protected.</p>
                    </div>
                </div>
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <button
                        onclick="this.nextElementSibling.classList.toggle('hidden'); this.querySelector('svg').classList.toggle('rotate-180')"
                        class="w-full flex justify-between items-center px-6 py-5 text-left">
                        <span class="font-medium text-slate-900 pr-4">Can Intune work alongside Configuration
                            Manager?</span>
                        <svg class="w-5 h-5 text-blue-600 shrink-0 transition-transform duration-300"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">Yes. Intune supports co-management with
                            Configuration
                            Manager (SCCM), allowing organisations to gradually shift management workloads to the cloud
                            while
