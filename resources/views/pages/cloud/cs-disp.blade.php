...
@section('content')
        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">The Defence Industry
                    ...
                    with Defence. This page explains DISP membership, security domains, and obligations.</p>
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="Defence Industry Security Program" loading="lazy" class="rounded-lg"
    ...
    <section class="py-24 bg-white" id="overview">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal reveal-fade-up space-y-6">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-slate-900">What is the Defence Industry Security Program
                    (DISP)?</h2>
                <p class="text-slate-600 leading-relaxed text-justify">The Defence Industry Security Program (DISP) is the
                ...
                <p class="text-slate-600 leading-relaxed text-justify">Organisations that want to work with the Bangladeshi
                    Defence Force or the broader Department of Defence supply chain need to understand the security
                    standards expected of them. In most cases, the key framework is the Defence Industry Security Program
                    (DISP).</p>
                <p class="text-slate-600 leading-relaxed text-justify">For businesses seeking Defence work, DISP membership
                    is often mandatory. It demonstrates that your organisation has the appropriate controls, processes, and
                    compliance measures in place. Achieving DISP strengthens your organisation's credibility, resilience,
                    and eligibility for Defence contracts.</p>
    ...
    <section class="py-24 bg-slate-50" id="domains">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">DISP is built around four key security areas that
                ...
                @php
                    $domains = [
                        [
                            ...
                            'desc' =>
                                'Policies, risk management, and security oversight. The ongoing security governance obligations for DISP membership also include regular reporting documents.',
                        ...
                        [
                            ...
                            'desc' =>
                                'Protection of facilities, assets, and equipment. DISP membership requirements for physical security will depend on the level of security classification required.',
                            'image' => '/images/cloud/cyber-security/disp/section-3.jpg',
                        ],
                        [
                            'title' => 'ICT & Cyber Security',
                            'desc' =>
                                'Securing systems, networks, and data. To meet the ICT and cyber security DISP membership requirements, an entity will need to demonstrate how they meet or exceed the E8 Mitigation Strategies at ML 2.',
    ...
    <section class="py-24 bg-white" id="essential-eight">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div class="reveal reveal-fade-up space-y-6">
                ...
                <p class="text-slate-600 leading-relaxed text-justify">The ASD Essential Eight is the core cyber security
                    standard used within the Defence Industry Security Program (DISP) and is widely recognised as
                    Australia's baseline for protecting business systems.</p>
                <p class="text-slate-600 leading-relaxed text-justify">To meet DISP requirements, organisations are
                    typically required to achieve Essential Eight Maturity Level 2 (ML2), a key benchmark in modern
                    cybersecurity frameworks. This level ensures that security controls are fully implemented, consistently
                    applied, and actively managed across all systems.</p>
                <p class="text-slate-600 leading-relaxed text-justify">Reaching Essential Eight ML2 is not a 'set and
    ...
    <section class="py-24 bg-slate-50" id="requirements">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                <h2 class="text-3xl md:text-4xl font-bold text-blue-900">Ongoing Cyber Security & Assurance Requirements
                </h2>
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Unlike one-time implementations, DISP requires
                    continuous validation, reporting, and improvement of cybersecurity controls.</p>
            </div>
    ...
    <section class="py-24 bg-white" id="prepare">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Achieving alignment with the Essential Eight
                    Maturity Level 2 (ML2) requires organisations to assess their current environment, identify gaps, and
                    implement practical security improvements.</p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @php
                    $steps = [
    ...
    <section class="py-16 bg-slate-50" id="help">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
                ...
                <p class="text-blue-100 text-sm leading-relaxed mb-8 max-w-3xl text-justify">At Total Solutions IT, we help
                    ...
                    strategy, tools, and expertise, your organisation can strengthen its security posture.</p>
