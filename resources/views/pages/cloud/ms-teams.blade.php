        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Microsoft Teams is a
                    leading communication and collaboration platform that integrates effortlessly with Microsoft 365.
                    Serving
                    as a central hub for teamwork, it allows users to chat, hold video meetings, share files, and
                    collaborate
    ...
    <section class="py-16 lg:py-24 bg-white" id="overview">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div class="flex justify-center">
                <img src="/images/cloud/microsoft-solutions/teams/section.png" alt="Microsoft Teams" class="object-cover"
                    loading="lazy" />
            </div>
            <div
                ...
                @php
                    $keyFeatures = [
                        [
                            ...
                            'desc' =>
                                'Persistent, threaded conversations with rich formatting, @mentions, and file sharing within channels and direct messages.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'HD video conferencing, meeting scheduling with Outlook integration, and automatic meeting recordings saved to OneDrive.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Real-time screen sharing and digital whiteboard for collaborative brainstorming during meetings.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'SharePoint-integrated file storage with real-time co-authoring on Word, Excel, and PowerPoint documents.',
                            'icon' =>
                        ...
                        [
                            'title' => 'Teams Calling',
                            'desc' =>
                                'VoIP and PSTN calling with call transfer, forwarding, and voicemail for comprehensive business communications.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'End-to-end encryption, Data Loss Prevention (DLP), and compliance recording for secure communications.',
                            'icon' =>
    ...
    <section class="py-16 lg:py-24 bg-slate-50" id="all-features">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 reveal reveal-fade-up">
                ...
                <p class="text-slate-600 text-center mb-12">Comprehensive collaboration capabilities across Microsoft Teams
                </p>
            </div>
            @php
                $features = [
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Teams allows for continuous, threaded conversations within channels and direct messages, making it easy to keep track of discussions over time.',
                            ],
                            [
                                'title' => 'Rich Text Formatting',
                                'desc' =>
                                    'Users can format messages with bold, italics, bullet points, and more, making it easier to communicate clearly.',
                            ],
                            [
                                'title' => '@Mentions',
                                'desc' =>
                                    'You can tag individuals or entire teams to draw their attention to specific messages or updates.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Teams supports HD video conferencing, allowing users to conduct virtual meetings with clear video and audio.',
                            ],
                            [
                                'title' => 'Meeting Scheduling',
                                'desc' =>
                                    'Integrated with Outlook, users can schedule meetings directly within Teams or Outlook, ensuring that all participants receive calendar invites.',
                            ],
                            [
                                'title' => 'Meeting Recordings',
                                'desc' =>
                                    'Teams allows users to record meetings, which can then be automatically saved to OneDrive or SharePoint for later reference.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'During meetings, participants can share their screens to collaborate on documents, presentations, or applications in real time.',
                            ],
                            [
                                'title' => 'Whiteboard',
                                'desc' =>
                                    'Teams includes a digital whiteboard feature, allowing participants to brainstorm and visualise ideas together during meetings.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Files shared in Teams channels are stored in SharePoint, making them easily accessible and securely stored.',
                            ],
                            [
                                'title' => 'Real-Time Co-Authoring',
                                'desc' =>
                                    'Users can collaborate on documents (Word, Excel, PowerPoint) directly within Teams, with changes being synchronised in real-time.',
                            ],
                            [
                                'title' => 'File Tabs',
                                'desc' =>
                                    'Each channel can have dedicated file tabs for easy access to important documents and resources.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Users can create teams for different projects, departments, or groups, and organise conversations into channels based on topics or workstreams.',
                            ],
                            [
                                'title' => 'Private Channels',
                                'desc' =>
                                    'Teams supports the creation of private channels, which are only accessible to selected members within a team, for more confidential discussions.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                'title' => 'App Store',
                                'desc' =>
                                    'Teams integrates with a wide range of third-party apps and services, such as Trello, Asana, GitHub, and more, allowing users to extend the platform\'s functionality.',
                            ],
                            [
                                'title' => 'Custom Bots',
                                'desc' =>
                                    'Organisations can create custom bots that interact with users, provide information, or automate tasks directly within Teams.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Teams supports voice over IP (VoIP) calls and can integrate with the public switched telephone network (PSTN) for traditional phone services, allowing users to make and receive calls from anywhere.',
                            ],
                            [
                                'title' => 'Call Transfer and Voicemail',
                                'desc' =>
                                    'Teams includes features like call transfer, call forwarding, and voicemail, making it a comprehensive solution for business communications.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Teams integrates with Microsoft Planner, allowing users to create, assign, and track tasks within the platform.',
                            ],
                            [
                                'title' => 'To-Do Lists',
                                'desc' =>
                                    'Users can manage personal tasks and to-do lists directly within Teams, helping them stay organised and on track.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                'title' => 'Teams Rooms',
                                'desc' =>
                                    'Microsoft Teams supports specialised hardware for meeting rooms, such as cameras, microphones, and screens, optimising the meeting experience in physical spaces.',
                            ],
                            [
                                'title' => 'Device Integration',
                                'desc' =>
                                    'Teams works seamlessly across various devices, including desktop computers, smartphones, and tablets, ensuring accessibility and consistency.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Teams offers end-to-end encryption for meetings and chats, ensuring that communications are secure.',
                            ],
                            [
                                'title' => 'Data Loss Prevention (DLP)',
                                'desc' =>
                                    'Integrated with Microsoft 365\'s DLP policies, Teams helps prevent sensitive information from being shared inappropriately within chats or files.',
                            ],
                            [
                                'title' => 'Compliance Recording',
                                'desc' =>
                                    'Teams supports compliance recording, ensuring that all communications are logged and stored in accordance with legal and regulatory requirements.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Teams allows organisations to host live events and webinars for up to 10,000 participants (or more with advanced licensing), making it a powerful tool for large-scale presentations and public events.',
                            ],
                            [
                                'title' => 'Interactive Features',
                                'desc' =>
                                    'Webinars in Teams can include Q&A, polls, and attendee engagement tools, enhancing the experience for both presenters and participants.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Breakout rooms allow meeting organisers to split participants into smaller groups for focused discussions, which can then rejoin the main meeting.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Users can customise their notification settings to stay informed about important updates without being overwhelmed by alerts.',
                            ],
                            [
                                'title' => 'Priority Notifications',
                                'desc' =>
                                    'Teams offers the ability to mark messages as urgent, ensuring that recipients are notified repeatedly until they respond.',
                            ],
                        ],
                    ],
                    [
                        ...
                        'items' => [
                            [
                                ...
                                'desc' =>
                                    'Teams provides insights into collaboration patterns, meeting effectiveness, and user activity, helping organisations optimise their communication strategies.',
                            ],
                        ],
                    ],
                ];
    ...
    <section class="py-16 lg:py-24 bg-slate-50" id="benefits">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 reveal reveal-fade-up">
                ...
                <p class="text-slate-600 text-center max-w-2xl mx-auto">Why organisations choose Teams for communication
                    and
                    collaboration</p>
            </div>
            @php
                $benefits = [
                    [
                        ...
                        'desc' =>
                            'Teams provides a single hub for chat, video meetings, file sharing, and project collaboration — eliminating the need for multiple disjointed tools.',
                    ],
                    [
                        'title' => 'Seamless Microsoft 365 Integration',
                        'desc' =>
                            'Deep integration with Word, Excel, PowerPoint, Outlook, SharePoint, and OneDrive ensures a connected and streamlined workflow.',
                    ],
                    [
                        'title' => 'Support for Remote & Hybrid Work',
                        'desc' =>
                            'Enable your team to collaborate from anywhere with secure chat, video conferencing, and file access across all devices.',
                    ],
                    [
                        'title' => 'Customisable Channels & Teams',
                        'desc' =>
                            'Organise discussions by project, department, or topic with public and private channels, keeping conversations focused and manageable.',
                    ],
                    [
                        'title' => 'Enterprise-Grade Security',
                        'desc' =>
                            'End-to-end encryption, DLP policies, compliance recording, and advanced admin controls protect your organisation\'s communications.',
                    ],
                    [
                        'title' => 'Extensible with Apps & Bots',
                        'desc' =>
                            'Integrate third-party apps like Trello, Asana, and GitHub, or create custom bots to automate tasks and extend functionality.',
                    ],
                ];
            @endphp
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
