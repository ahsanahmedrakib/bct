...
@section('content')
        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Backup & Recovery
                    <br />
                    <span class="text-blue-600 block mt-2">Business Continuity</span>
                </h1>
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Backup and Data
                    ...
                    restore information and minimise downtime if something goes wrong.</p>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 md:w-3/4 w-full">
                    ...
                    <a href="#solutions"
                        class="group flex cursor-pointer items-center justify-between px-6 py-4 text-white text-sm font-semibold rounded-xl shadow-md transition-all bg-navy hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg">SOLUTIONS
                        <svg class="w-4 h-4 text-sky-300 transition-transform group-hover:translate-x-1"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m9 18 6-6-6-6" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal reveal-fade-up">
                <div
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-6 leading-tight">What is Backup and
                        Recovery?</h2>
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Backup and Data Recovery are
                        critical components of a
                        modern business continuity and cybersecurity strategy. They ensure that important files, systems,
                        and
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">By maintaining secure backup copies
                        of business data,
                        organisations can minimise downtime and quickly recover from unexpected disruptions. Modern backup
                        solutions often combine local backups, cloud storage, and offsite replication to provide multiple
                        layers
                        of protection.</p>
                    <p class="text-slate-500 text-sm leading-relaxed mb-8 text-justify">Automated backup systems regularly
                        capture and store data
                        so that recovery can occur quickly when needed. This ensures that important data stored on servers,
                        computers, and cloud services can be recovered quickly, helping organisations maintain operations
                        and
                        protect valuable business information.</p>
                    <a href="#solutions" class="text-blue-600 font-medium flex items-center hover:text-blue-800">Our
                        Solutions
                ...
                @php
                    $solutions = [
                        ...
                        [
                            'title' => 'Datto Backup',
                            'desc' =>
                                'Datto Backup is a comprehensive data protection solution designed primarily for managed service providers (MSPs) and small to medium-sized businesses (SMBs). It offers a range of features that provide robust backup, disaster recovery, and business continuity services.',
                            'features' => [
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div class="reveal reveal-fade-up">
                <div
                    class="bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 transition-all relative h-full">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <span class="text-blue-500 font-bold text-sm tracking-wide mb-3 block">StorageCraft
                        ShadowProtect</span>
                    <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-6 leading-tight">Full System Backup</h2>
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">StorageCraft ShadowProtect captures
                        full, differential and incremental backups of your entire system, including the entire operating
                        system, applications, configuration settings, and files.</p>
                    <div class="space-y-3 mb-8">
                        <div class="flex items-start gap-3">
                            ...
                            <span class="text-slate-600 text-sm">Full System Backup: Complete image of your entire
                                system</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span class="text-slate-600 text-sm">Differential Backups: Changes since the last full
                                backup</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span class="text-slate-600 text-sm">Incremental Backups: Changes since the last backup of any
                                type</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span class="text-slate-600 text-sm">Hardware Independent Restore (HIR): Recover entire system
                                state to different hardware</span>
                        </div>
                    </div>
                    <p class="text-slate-500 text-sm leading-relaxed text-justify">Hardware Independent Restore (HIR):
                        Recover an entire system state to a different hardware architecture or virtual machine. This means
                        that if a server's hardware irretrievably fails, we can deploy a state backup of the server to
                        another machine and recover your business processes in hours.</p>
                </div>
            </div>
            <div class="flex justify-center">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal reveal-fade-up">
                <div
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">MozyPro is our preferred
                        cloud-based backup solution for your business. Available for both desktops and servers, it ensures
                        peace of mind that your data is stored and archived in the cloud, ready for when you need it
                        restored.</p>
                    <div class="space-y-3 mb-8">
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <span class="text-slate-600 text-sm">Can be deployed with Windows Server Backup or
                                ShadowProtect</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-4 h-4 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span class="text-slate-600 text-sm">Essential for business-critical data that cannot be
                                lost</span>
                        </div>
                    </div>
                    <p class="text-slate-500 text-sm leading-relaxed text-justify">We often deploy Mozy in conjunction with
                        Windows Server Backup or ShadowProtect to supplement the backups with a file history and archive
                        that is stored in the cloud. Essential for business-critical data that absolutely cannot be lost.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div
                        ...
                        <div class="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-blue-600 mb-4">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor">{!! $type['icon'] !!}</svg>
                        </div>
    ...
    <section class="py-16 lg:py-24 bg-white" id="help">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative w-full rounded-2xl overflow-hidden order-1 lg:order-2">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div
                    ...
                    <p class="text-slate-600 text-sm mb-4">Enterprise-grade cloud backup and disaster recovery solutions
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm mb-4">Cloud-first data protection service designed for managed service
                        providers and IT teams.</p>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm mb-4">Comprehensive data protection and business continuity solutions
                        for SMBs and MSPs.</p>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm mb-4">System-level backup and recovery solution with
                        hardware-independent restore capabilities.</p>
    ...
    <section class="py-16 lg:py-24 bg-white" id="faq">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                <div class="border-2 border-blue-100 rounded-xl overflow-hidden relative faq-item">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <button onclick="toggleFaq(this)"
                        class="w-full flex justify-between items-center px-6 py-5 text-left">
                        <span class="font-medium text-slate-900 pr-4">What is the difference between backup and disaster
                            recovery?</span>
                    ...
                    <div class="faq-answer grid transition-all duration-300 grid-rows-[0fr]">
                        <div class="overflow-hidden">
                            <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">Backup refers to creating copies of
                                your data to be restored later, while disaster recovery is a broader strategy that includes
                                the processes and tools to recover entire systems and operations after a major incident.
                                Backup is one component of a complete disaster recovery plan.</p>
                        </div>
                    </div>
                </div>
                <div class="border-2 border-blue-100 rounded-xl overflow-hidden relative faq-item">
                    ...
                    <div class="faq-answer grid transition-all duration-300 grid-rows-[0fr]">
                        <div class="overflow-hidden">
                            <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">The frequency of backups depends on
                                how critical your data is and how much data loss your business can tolerate. For most
                                businesses, daily backups are essential, with more frequent backups for critical systems. We
                                can help determine the optimal backup schedule for your specific needs.</p>
                        </div>
                    </div>
                </div>
                <div class="border-2 border-blue-100 rounded-xl overflow-hidden relative faq-item">
                    ...
                    <div class="faq-answer grid transition-all duration-300 grid-rows-[0fr]">
                        <div class="overflow-hidden">
                            <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">All business-critical data should
                                be backed up, including databases, email systems, documents, configurations, and application
                                data. We recommend a comprehensive approach that covers all systems essential to your
                ...
                <div class="border-2 border-blue-100 rounded-xl overflow-hidden relative faq-item">
                    ...
                    <div class="faq-answer grid transition-all duration-300 grid-rows-[0fr]">
                        <div class="overflow-hidden">
                            <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">Recovery time depends on the amount
                                of data, the type of backup solution, and your recovery objectives. Local backups can often
                                be restored quickly, while cloud recoveries depend on internet speeds. We design solutions
                                with your specific recovery time objectives in mind.</p>
                        </div>
                    </div>
                </div>
                <div class="border-2 border-blue-100 rounded-xl overflow-hidden relative faq-item">
                    ...
                    <div class="faq-answer grid transition-all duration-300 grid-rows-[0fr]">
                        <div class="overflow-hidden">
                            <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">Yes, reputable cloud backup
                                providers use enterprise-grade encryption both in transit and at rest. Your data is stored
                                in secure data centres with multiple layers of physical and digital security. We only
                                recommend cloud backup solutions that meet strict security standards.</p>
                        </div>
                    </div>
                </div>
                <div class="border-2 border-blue-100 rounded-xl overflow-hidden relative faq-item">
                    ...
                    <div class="faq-answer grid transition-all duration-300 grid-rows-[0fr]">
                        <div class="overflow-hidden">
                            <p class="px-6 pb-5 text-sm text-slate-600 leading-relaxed">This is why we recommend offsite or
                                cloud backup as part of your strategy. If local backups are lost due to fire, theft, or
                                hardware failure, your data remains protected in the cloud or at an offsite location,
                                ensuring you can still recover your business-critical information.</p>
                        </div>
                    </div>
                </div>
            </div>
