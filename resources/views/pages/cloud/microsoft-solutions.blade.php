...
@section('description', 'Maximize your productivity with our comprehensive Microsoft 365 and Azure cloud solutions. As
    certified Microsoft partners, we deliver tailored enterprise solutions.')
                ...
                @php
                    $solutions = [
                        [
                            ...
                            'desc' =>
                                'Complete productivity suite with Word, Excel, Teams, and cloud storage for seamless collaboration.',
                        ...
                        [
                            ...
                            'desc' =>
                                'Stream your personalised Windows experience to any device with a secure cloud-based PC.',
                        ...
                        [
                            ...
                            'desc' =>
                                'Scalable cloud computing services for building, deploying, and managing applications globally.',
                            'route' => 'ms-azure',
                        ],
                        [
                            ...
                            'desc' =>
                                'Chat, video meetings, file sharing, and app integrations all in one unified platform.',
                            'route' => 'ms-teams',
                        ],
                        [
                            ...
                            'desc' =>
                                'Advanced threat protection for endpoints, email, and cloud applications with real-time monitoring.',
                            'route' => 'ms-defender',
                        ],
                        [
                            ...
                            'desc' =>
                                'Enterprise-class email and calendar with 50GB mailbox, anti-spam protection, and mobile access.',
                        ...
                        [
                            ...
                            'desc' =>
                                '1TB of cloud storage per user with file sharing, sync across devices, and version history.',
                            'route' => 'ms-onedrive',
                        ],
                        [
                            'title' => 'SharePoint',
                            ...
                            'desc' =>
                                'Team sites, document management, workflows, and intranet portals for seamless collaboration.',
                            'route' => 'ms-sharepoint',
                        ],
                        [
                            ...
                            'desc' =>
                                'AI-powered assistant that helps you write, analyze data, create presentations, and automate tasks.',
                            'route' => 'ms-copilot',
                        ],
                        [
                            ...
                            'desc' =>
                                'Cloud-based endpoint management for mobile devices, laptops, and desktops across your organization.',
                            'route' => 'ms-intune',
                        ],
                        [
                            ...
                            'desc' =>
                                'Identity and access management with single sign-on, MFA, and conditional access policies.',
                            'route' => 'ms-entra-id',
                        ],
                        [
                            ...
                            'desc' =>
                                'Identity-driven access policies that enforce zero trust security for your organization.',
                    ...
                    <a href="{{ route($solution['route']) }}"
                        ...
                        <div class="relative h-48 w-full overflow-hidden bg-slate-50 flex items-center justify-center p-6">
                            <img src="{{ $solution['img'] }}" alt="{{ $solution['title'] }}"
                                class="object-contain max-h-full transition-transform duration-700 group-hover:scale-105"
                                loading="lazy" />
                        </div>
                        <div class="p-6">
