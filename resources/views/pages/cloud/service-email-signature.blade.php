...
@section('content')
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Centrally manage
    ...
    <section id="overview" class="py-16 lg:py-24 bg-white">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div
                class="border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all relative reveal reveal-fade-up">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <span class="text-blue-500 font-bold text-sm tracking-wide mb-3 block">Email Signature Management</span>
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-6 leading-tight">What is CodeTwo Email
                    Signatures 365?</h2>
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">CodeTwo Email Signatures 365 helps
                    businesses centrally manage
                ...
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">With cloud-based management, flexible
                    signature rules, and
                    support for Entra ID attributes, CodeTwo makes signature management easier, more scalable, and more
                    professional.</p>
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">CodeTwo Email Signatures 365 is a
                    powerful cloud-based email
                ...
                <p class="text-slate-500 text-sm leading-relaxed mb-8 text-justify">This solution works across Outlook,
                    webmail and mobile
                ...
                <a href="#features" class="text-blue-600 font-medium flex items-center hover:text-blue-800">Key
                    Features <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                ...
                @php
                    $features = [
                        [
                            ...
                            'desc' =>
                                'Control signatures for the whole organisation from a single web-based portal. Administrators can update signatures for the entire organisation instantly without needing to configure each user\'s Outlook settings.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Ensure consistent company branding across every email sent by employees. Maintain a uniform signature regardless of the device being used.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Signatures automatically include user details pulled from Microsoft Entra ID such as names, job titles, departments and contact information.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Add marketing banners and promotional messaging in signatures to support campaigns and announcements.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Supports Windows, Mac, Outlook on the web, iOS, Android and other email apps, depending on the mode used.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Centrally manage out-of-office messages and branded auto replies across the organisation.',
                            'icon' =>
                ...
                @php
                    $scenarios = [
                        [
                            ...
                            'desc' =>
                                'Maintain consistent branding across all emails with standardised signatures for the entire organisation.',
                            'icon' =>
                                '<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75" />',
                        ],
                        [
                            ...
                            'desc' =>
                                'Use promotional banners and announcements in email signatures to support marketing campaigns.',
                            'icon' =>
                                '<path stroke-linecap="round" stroke-linejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 01-1.44-4.282m3.102.069a18.03 18.03 0 01-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 018.835 2.535M10.34 6.66a23.847 23.847 0 008.835-2.535m0 0A23.74 23.74 0 0018.795 3m.38 1.125a23.91 23.91 0 011.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 001.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 010 3.46" />',
                        ],
                        [
                            ...
                            'desc' =>
                                'Manage signatures, disclaimers and updates from a single platform, reducing administrative burden.',
                            'icon' =>
                                '<path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" />',
                        ],
                        [
                            'title' => 'Automatic User Details',
                            'desc' =>
                                'Populate signatures automatically from Microsoft Entra ID attributes like names, job titles and departments.',
                            'icon' =>
                                '<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />',
                        ],
                        [
                            ...
                            'desc' =>
                                'Ensure signatures appear correctly regardless of the device used - desktop, web or mobile.',
                            'icon' =>
                                '<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />',
                        ],
                        [
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-blue-600">
                                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    stroke="currentColor">{!! $scenario['icon'] !!}</svg>
                            </div>
                ...
                @php
                    $modes = [
                        [
                            ...
                            'desc' =>
                                'In this mode, a signature is added after an email is sent and does not require the installation of the CodeTwo Signatures add-in. Signatures are added to emails sent from any device or mail application.',
                        ],
                        [
                            'title' => 'Client-Side (Outlook)',
                            'desc' =>
                                'A signature is added as you type an email. This mode requires installation of the CodeTwo Signatures add-in to add signatures directly to Outlook and Outlook Web App.',
                        ],
                        [
                            'title' => 'Combo Mode',
                            'desc' =>
                                'This mode provides the best of both types of processing (client-side and server-side). It requires you to set up Office 365 connectors and the CodeTwo Signatures add-in.',
                        ],
                    ];
                @endphp
                @foreach ($modes as $index => $mode)
                    <div
                        ...
                        <div class="p-6 flex flex-col grow">
                            <div class="flex items-center gap-3 mb-3">
                                <div
                                    class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white shrink-0">
                ...
                @php
                    $benefits = [
                        [
                            ...
                            'desc' =>
                                'It is cloud-based, so there is no infrastructure to deploy or maintain on-premises. The deployment process is fully automated and based on wizards.',
                            'icon' =>
                        ...
                        [
                            'title' => 'Centralised Management',
                            'desc' =>
                                'It centralises the management of email signatures and disclaimer additions to Microsoft 365 organisations - one person can manage all signatures.',
                            'icon' =>
                                '<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75" />',
                        ],
                        [
                            ...
                            'desc' =>
                                'It is easy to configure and provision. Just authorise with your Microsoft 365 global admin credentials and you\'ll be ready to create your first email signature.',
                            'icon' =>
                                '<path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" />',
                        ],
                        [
                            ...
                            'desc' =>
                                'CodeTwo signatures are not device-specific and work on Windows, Mac, mobile devices, and tablets.',
                            'icon' =>
                                '<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />',
                        ],
                        [
                            ...
                            'desc' =>
                                'It provides a flexible email signature editor with web-based HTML templates, signature rule automation, and predefined signature layouts.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'High level of security and compliance with ISO/IEC 27001 and ISO/IEC 27018 certifications. It is the only vendor with a modern signature add-in for Outlook and Outlook Web App.',
                            'icon' =>
    ...
    <section id="help" class="py-16 lg:py-24 bg-white">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            <div
                class="relative w-full rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 reveal reveal-fade-up">
            ...
            <div
                class="bg-linear-to-br from-blue-600 to-blue-800 rounded-2xl p-8 lg:p-10 text-white reveal reveal-fade-up">
                <h2 class="text-2xl lg:text-3xl font-bold mb-6">Need Help with Email Signature Management?</h2>
                <p class="text-blue-100 text-sm leading-relaxed mb-6 text-justify">BCT provides comprehensive CodeTwo Email
                ...
                <p class="text-blue-100 text-sm mb-6">Whether you need a complete signature solution or want to improve
                    your existing email signatures, we can help you achieve consistent, professional branding across all
                ...
                @php
                    $usefulLinks = [
                        ...
                        [
                            ...
                            'href' =>
                                'https://www.codetwo.com/userguide/email-signatures-for-office-365/first-steps.htm',
                        ],
                        [
                ...
                @php
                    $faqs = [
                        ...
                        [
                            ...
                            'answer' =>
                                'Bismillah Computer & Technology provides comprehensive CodeTwo Email Signatures 365 services including deployment, configuration, template design, rule setup, and ongoing support to ensure your organisation maintains professional and consistent email signatures.',
                        ],
                    ];
                @endphp
                @foreach ($faqs as $faq)
