    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="Conditional Access" loading="lazy" class="rounded-lg w-full max-w-md lg:max-w-lg"
    ...
    <section class="py-16 lg:py-24 bg-white" id="overview">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div
                ...
                <span class="text-blue-500 font-bold text-sm tracking-wide mb-3 block">Microsoft 365 Conditional
                    Access</span>
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-6 leading-tight">What is Conditional Access?
                </h2>
                ...
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">By applying Conditional Access policies,
                    organisations can enforce multi-factor authentication (MFA), block access from untrusted locations,
                    restrict
                    access to compliant devices, and tailor access requirements to different user roles. This helps protect
                    against unauthorised access, reduces the risk of data breaches, and ensures that only the right users
                    have
        ...
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Control access based on user identity, group membership,
                        and
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Block or allow access based on IP addresses and
                        geographic
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Require devices to be Intune-compliant or Hybrid Azure
                        AD
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Apply policies to specific cloud apps — control access
                        to
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Control which applications users can connect from —
                        allow
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Block sign-ins if Azure detects unusual behaviour — such
                        as
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Control persistent browser sessions and sign-in
                        frequency —
        ...
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-start">
                <div class="reveal reveal-fade-up">
                    ...
                    <ul class="space-y-3 mb-6">
                        <li class="flex items-start gap-3">
                            <svg class="text-amber-500 shrink-0 mt-0.5 w-4.5 h-4.5" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-slate-700 text-sm">Office 365 can be accessed from any device — not just
                                corporate owned devices, any device (Personal Windows/Mac laptop, tablet, phone, any device
                                with
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-slate-700 text-sm">Emails can be cached offline and copied elsewhere on a
                                home
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed mb-4">Microsoft introduced Conditional Access to
                        resolve
                        this problem. Conditional Access allows administrators to control what Office 365 apps users can
                        gain
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">What users do you want to control — Users can be
                        included/excluded from the policy if required. You will always get the person who is too important
                        for
                        this policy and wants to access everything from their personal iPad. It also allows you to test
                        policies
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">What apps do you want to control? Conditional Access
                        does
    ...
    <section class="py-16 lg:py-24 bg-slate-50" id="grant-controls">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 reveal reveal-fade-up">
                ...
                <p class="text-slate-600 text-center max-w-2xl mx-auto">Based on the conditions above, access can be
                    allowed
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Device must be Intune compliant — the device must match
                        the
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Devices must be Hybrid Azure AD joined — Mobile Devices
                        Azure AD registered and domain joined machines are set to automatically register in their Azure AD.
                    </p>
                </div>
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Access is only granted if a connection attempt was made
                        by an
        ...
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                    ...
                    <div class="hidden px-6 pb-5">
                        ...
                        <ol class="space-y-2">
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">1.</span><span
                                    ...
                                    privileges.</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">2.</span><span
                                    class="text-sm text-slate-600">Navigate to Protection: In the left-hand menu, click on
                                    "Protection".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">3.</span><span
                                    class="text-sm text-slate-600">Conditional Access: Under the protection menu, select
                                    "Conditional Access".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">4.</span><span
                                    class="text-sm text-slate-600">New Policy: Select "New Policy from Template".</span>
                            </li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">5.</span><span
                                    class="text-sm text-slate-600">Secure Foundation: Select "Secure Foundation" from the
                                    top
                                    menu.</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">6.</span><span
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">7.</span><span
                                    class="text-sm text-slate-600">Adjust Policy state and save: Set policy name as per
                                    your
                                    requirements (e.g. "CA01 – Require multifactor Authentication for all users"). Set
                                    policy
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        ...
                        <ol class="space-y-2">
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">4.</span><span
                                    class="text-sm text-slate-600">Named Locations: Once in the conditional access main
                                    menu,
                                    select "Named Locations".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">5.</span><span
                                    class="text-sm text-slate-600">Navigate to Countries location: In the top menu, click
                                    on
                                    "Countries location".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">6.</span><span
                                    class="text-sm text-slate-600">Country Selection: Enter the name "Approved Countries".
                                    In
                            ...
                            <li class="flex items-start gap-3"><span
                                    ...
                                    "create".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">8.</span><span
                                    class="text-sm text-slate-600">Create policy: Select "New Policy" from the top
                                    menu.</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">9.</span><span
                                    class="text-sm text-slate-600">Name Policy: Set name of policy (e.g. "CA02 – Block
                                    Access
                                    from Other Countries").</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">10.</span><span
                                    class="text-sm text-slate-600">Users to affect: In the "Users" menu, set the include
                                    sub
                                    menu to "all users".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">11.</span><span
                                    class="text-sm text-slate-600">Exclude admin account: To ensure you are never locked
                                    out of
                                    your Microsoft 365 tenant, select the sub menu "exclude" then select your administrator
                                    account.</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">12.</span><span
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">13.</span><span
                                    ...
                                    Done.</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">14.</span><span
                                    class="text-sm text-slate-600">Block Access: Select "Grant" menu item. Select "block
                                    access".
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed mb-4">Ensure users are only able to access the
                            Microsoft 365 system from specific device types, and block access from un-approved device types.
                        </p>
                        <p class="text-sm font-semibold text-slate-900 mb-3">Steps:</p>
                        <ol class="space-y-2">
                            <li class="flex items-start gap-3"><span
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">4.</span><span
                                    class="text-sm text-slate-600">Select "Users" Menu and then select "All users".</span>
                            </li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">5.</span><span
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">6.</span><span
                                    class="text-sm text-slate-600">Select "Conditions" and then "Device Platforms".</span>
                            </li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">7.</span><span
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">9.</span><span
                                    class="text-sm text-slate-600">Select "Grant" from left hand menu and then set to
                                    "Block
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        ...
                        <ol class="space-y-2">
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">7.</span><span
                                    class="text-sm text-slate-600">Set configure to "yes" and then tick "Browser", then
                                    select
                                    "done".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">8.</span><span
                                    class="text-sm text-slate-600">Select "Session" from right hand side menu, then tick
                                    "Persistent Browser Session". Then set the drop down menu to "Never Persistent".</span>
                            </li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">9.</span><span
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        ...
                        <ol class="space-y-2">
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">2.</span><span
                                    class="text-sm text-slate-600">Name the policy "CA05 – Require App Protection
                                    Policy".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">3.</span><span
                                    class="text-sm text-slate-600">Select "users" from right hand menu and then select "all
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">4.</span><span
                                    class="text-sm text-slate-600">Select "Target Resources" then click "Select
                                    Apps".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">5.</span><span
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">7.</span><span
                                    class="text-sm text-slate-600">Select "Conditions" from right hand side menu, then
                                    select
                                    "Device Platform". Then set the right hand side menu configure option to "yes".</span>
                            </li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">8.</span><span
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">10.</span><span
                                    class="text-sm text-slate-600">Set Configure on right hand side menu to "yes", then
                                    click
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed mb-4">Block older protocols from being able to
                            access
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed mb-4">Enforce multi-factor authentication when
                            users
                        ...
                        <ol class="space-y-2">
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">2.</span><span
                                    class="text-sm text-slate-600">Name the policy "CA07 – Require MFA to Join to
                                    Entra".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">3.</span><span
                                    class="text-sm text-slate-600">Select "users" from right hand menu and then select "all
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">5.</span><span
                                    class="text-sm text-slate-600">Select "Grant" from the left hand menu, then select
                                    "grant
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed mb-4">Block access to the Microsoft 365 system
                            from
                        ...
                        <ol class="space-y-2">
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">2.</span><span
                                    class="text-sm text-slate-600">Name the policy "CA08 – Block Personal Devices".</span>
                            </li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">3.</span><span
                                    class="text-sm text-slate-600">Select "users" from right hand menu and then select "all
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">4.</span><span
                                    class="text-sm text-slate-600">Select the "Exclude" menu, select "users and groups",
                                    enter
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">6.</span><span
                                    class="text-sm text-slate-600">Select "Conditions" menu, then select "device
                                    platforms".
                                    Select "Yes" under the configure option on the right hand side. Then tick "Windows" and
                                    "macOS". Select "done".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">7.</span><span
                                    class="text-sm text-slate-600">Select "Client apps", set configure to "yes", tick
                                    "browser",
                                    "mobile apps and desktop clients", "exchange Active Sync clients" and "other
                                    clients".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">8.</span><span
                                    class="text-sm text-slate-600">Select "Filter for devices". Set to "yes" under
                                    configure. Set
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">9.</span><span
                                    class="text-sm text-slate-600">Select "Grant", select "Block Access" on right hand
                                    side. Click
                                    "select".</span></li>
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">10.</span><span
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">11.</span><span
                                    class="text-sm text-slate-600">Review and enable once settings are confirmed.</span>
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed mb-4">Restrict access so that users can only
                            connect to
                        ...
                        <ol class="space-y-2">
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">4.</span><span
                                    class="text-sm text-slate-600">Give the policy a meaningful name, such as "Restrict
                                    Access
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">6.</span><span
                                    class="text-sm text-slate-600">Under Assignments, select Cloud apps or actions. Choose
                                    all
                            ...
                            <li class="flex items-start gap-3"><span
                                    class="text-blue-600 font-bold text-sm shrink-0 mt-0.5">9.</span><span
                                    class="text-sm text-slate-600">Under Access controls, click Grant. Select Grant access,
                                    and
    ...
    <section class="py-16 lg:py-24 bg-slate-50" id="gotchas">
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8 reveal reveal-fade-up">
                ...
                <p class="text-slate-600 text-center">As with most Microsoft solutions, Conditional Access is not without
                    its
                    flaws.</p>
            </div>
            <div class="space-y-4">
                <div
                    class="reveal reveal-fade-up border-2 border-amber-200 hover:border-amber-300 relative rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all">
                    ...
                    <p class="text-slate-600 text-sm text-justify">Not all client apps support Conditional Access — the
                        Client
                        App needs to support Modern Authentication. e.g. Outlook 2016 or Outlook 2013 (with a reg key
                        change).
                ...
                <div class="reveal reveal-fade-up border-2 border-amber-200 hover:border-amber-300 relative rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Upgrade to Outlook 2016 if your business is still using
                        this. Any 3rd party apps (e.g. Outlook Plugins) that don't support above Outlook 2010, put pressure
                        on
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Conditional Access ensures that only verified users and
                        compliant devices can access corporate resources, significantly reducing the risk of data breaches.
                    </p>
                </div>
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    style="animation-delay: 0.1s">
                    ...
                    <p class="text-slate-600 text-sm text-justify">Require additional verification beyond just a username
                        and
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Restrict Office 365 access to specific geographic
                        locations
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Ensure only Intune-compliant and company-owned devices
                        can
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Apply security policies to specific apps rather than all
                        of
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all"
                    ...
                    <p class="text-slate-600 text-sm text-justify">Implement a comprehensive Zero Trust approach by
                        combining
        ...
        <div class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative">
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">Conditional Access is a security feature in
                            Microsoft
                            Entra ID that controls access to resources based on specific conditions such as user identity,
                            location, device compliance, and risk level. It allows organisations to enforce policies like
                            MFA,
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">Yes. Conditional Access requires an Azure AD
                            Premium
                            license (P1 or P2), which is also included in the Enterprise Mobility and Security Suite (EMS)
                            or
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <button
                        onclick="this.nextElementSibling.classList.toggle('hidden'); this.querySelector('svg').classList.toggle('rotate-180')"
                        class="w-full flex justify-between items-center px-6 py-5 text-left">
                        <span class="font-medium text-slate-900 pr-4">Can I exclude specific users from a Conditional
                            Access
                            policy?</span>
                        <svg class="w-5 h-5 text-blue-600 shrink-0 transition-transform duration-300"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">Yes. Each policy allows you to include or exclude
                            specific users or groups. It's recommended to always exclude your admin account from block
                            policies
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">If a user doesn't meet the conditions defined in
                            the
                            policy, access will be blocked. The user will see an error message indicating they don't meet
                            the
                ...
                <div class="reveal reveal-fade-up border-2 border-blue-100 rounded-xl overflow-hidden relative"
                    ...
                    <div class="hidden px-6 pb-5">
                        <p class="text-sm text-slate-600 leading-relaxed">Yes. You can set a policy to "Report-only" mode,
                            which
                            allows you to see the impact of the policy without actually enforcing it. This helps you test
                            and
