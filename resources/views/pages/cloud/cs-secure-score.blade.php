    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Microsoft <span
                        class="text-brand-blue">Secure Score</span> Security Posture</h1>
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Microsoft Secure Score
                    ...
                    security controls, and continuously improve their Microsoft 365 security posture.</p>
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="#how-it-works"
                        ...
                        IT WORKS</a>
                    <a href="#improve"
                        class="inline-flex items-center gap-2 bg-white text-brand-blue border-2 border-brand-blue font-semibold px-6 py-3 rounded-xl hover:bg-blue-50 transition-colors text-sm">IMPROVE
                        YOUR SCORE</a>
                </div>
            </div>
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="Microsoft Secure Score" loading="lazy" class="rounded-lg"
    ...
    <section class="py-24 bg-white" id="overview">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal reveal-fade-up space-y-6">
                ...
                <p class="text-slate-600 leading-relaxed text-justify">Microsoft Secure Score is a built-in security
                    ...
                    Microsoft 365 environment is protected against common security threats.</p>
                <p class="text-slate-600 leading-relaxed text-justify">The score is calculated based on the security
    ...
    <section class="py-24 bg-slate-50" id="why-matters">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Microsoft Secure Score is more than just a number —
    ...
    <section class="py-24 bg-white" id="categories">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Secure Score is divided into four main categories
    ...
    <section class="py-24 bg-slate-50" id="improve">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Microsoft provides specific recommendations to
                ...
                @php
                    $improvements = [
                        [
                            ...
                            'desc' =>
                                'The single most impactful control in any M365 tenant. Password compromise does not lead to account takeover when MFA is required.',
                        ],
                        [
                            'title' => 'Disable legacy authentication protocols',
                            'desc' =>
                                'Disable legacy authentication protocols (e.g., POP, IMAP, SMTP basic auth). Legacy protocols do not support MFA and represent a significant attack vector.',
                        ],
                        [
                            'title' => 'Apply Intune compliance policies',
                            'desc' =>
                                'Apply Intune compliance policies for device health and encryption. Ensure only trusted and compliant devices can access company systems.',
                        ],
                        [
                            'title' => 'Use Microsoft Defender for Office 365',
                            'desc' =>
                                'Use Microsoft Defender for Office 365 to protect against phishing and malware. Deploy Safe Links and Safe Attachments for real-time content scanning.',
                        ],
                        [
                            'title' => 'Deploy Sensitivity Labels',
                            'desc' =>
                                'Deploy Sensitivity Labels to classify and protect data across Microsoft 365. Ensure only authorised users access sensitive content.',
                        ],
                        [
                            'title' => 'Implement Conditional Access',
                            'desc' =>
                                'Implement Conditional Access to enforce secure access rules. Define policies that evaluate user identity, device compliance, location, and risk level.',
                        ],
                        [
                            'title' => 'Audit privileged roles',
                            'desc' =>
                                'Audit privileged roles and restrict global admin usage. Enforce least-privilege access with Role-Based Access Control (RBAC).',
                        ],
                        [
                            'title' => 'Enable Safe Links and Safe Attachments',
                            'desc' =>
                                'Enable Safe Links and Safe Attachments for real-time content scanning. Protect against phishing attempts, malware, and ransomware attacks.',
                        ],
                    ];
                @endphp
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
                ...
                <p class="text-blue-100 text-sm leading-relaxed mb-8 max-w-3xl text-justify">Microsoft Secure Score is a
                    ...
                    visibility, direction, and measurable goals in a format that's easy to understand. Partnering with a
                    skilled Microsoft 365 Security partner can help you achieve the best combination between a secure IT
                    environment and a great user experience.</p>
