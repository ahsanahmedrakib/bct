    ...
    <section class="py-16 lg:py-24 bg-white" id="overview">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div class="flex justify-center">
                <img src="/images/cloud/microsoft-solutions/azure/section.png" alt="Microsoft Azure" class="object-cover"
                    loading="lazy" />
            </div>
            <div
                ...
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Microsoft Azure is an ever-expanding set
                    ...
                    manage, and deploy applications on a massive, global network using your favorite tools and frameworks.
                </p>
                <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Find answers to the business challenges
                    ...
                    and running quickly with a scalable, cost-effective solution that works with your existing investments.
                </p>
                <p class="text-slate-500 text-sm leading-relaxed mb-8 text-justify">BCT is a long-standing
                ...
                @php
                    $keyFeatures = [
                        [
                            ...
                            'desc' =>
                                'Access virtual machines, containers, and serverless computing resources on-demand — scale up or down based on your needs.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                "Deploy applications across Microsoft's global network of datacentres for low latency and high availability worldwide.",
                            'icon' =>
                        ...
                        [
                            'title' => 'Pay-As-You-Go',
                            'desc' =>
                                'Only pay for the resources you actually use with flexible pricing models — no large upfront capital expenditure required.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Built-in security features including encryption, identity management, and compliance certifications to protect your data.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Extend your on-premises infrastructure to the cloud with hybrid solutions that give you the best of both worlds.',
                            'icon' =>
                        ...
                        [
                            ...
                            'desc' =>
                                'Fully managed database services including SQL Database, Cosmos DB, and MySQL — with built-in intelligence and automation.',
                            'icon' =>
                ...
                <div class="reveal reveal-fade-up">
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-slate-700 text-sm">You need to be able to upgrade the hardware on your server
                                instantly.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="text-blue-600 shrink-0 mt-0.5 w-5 h-5" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-slate-700 text-sm">You only want to pay for the bandwidth and hardware that
                                you use.</span>
                        </li>
                    </ul>
                </div>
                <div
                    class="reveal reveal-fade-up border-2 border-blue-100 hover:border-blue-300 rounded-xl p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all relative h-full">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">A Virtual Private Cloud on
                        Microsoft
                        Azure provides a secure, isolated environment for your infrastructure. You get the flexibility of
                        cloud
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-slate-600">You need to be able to upgrade the hardware on your server
                                instantly.</span>
                        </div>
                        <div class="flex items-start gap-3">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-slate-600">You only want to pay for the bandwidth and hardware that
                                you use.</span>
                        </div>
                    </div>
                </div>
            ...
            @php
                $benefits = [
                    [
                        ...
                        'desc' =>
                            'With a cloud server, you pay a fixed rate monthly for the services you use. No surprises, no hidden fees — just transparent, predictable costs.',
                    ],
                    [
                        'title' => 'Mobility',
                        'desc' =>
                            "You can access your cloud server from anywhere with an internet connection. Your team stays productive whether they're in the office, at home, or on the road.",
                    ],
                    [
                        'title' => 'Scalability',
                        'desc' =>
                            'As your business grows, so can your hardware — without downtime or physical work. Scale resources up or down instantly to match demand.',
                    ],
                    [
                        'title' => 'No Upfront Hardware Costs',
                        'desc' =>
                            'There is no infrastructure put in place on your site — it is all stored in another datacentre. Eliminate capital expenditure on physical servers.',
                    ],
                    [
                        'title' => "Bangladesh's Best Datacentres",
                        'desc' =>
                            'BCT uses the Telstra cloud server datacentre — the most stable and available service in the country. Your infrastructure is hosted in world-class facilities.',
                    ],
                    [
                        'title' => 'Data Availability',
                        'desc' =>
                            'Telstra cloud servers are maintained at the physical level by Telstra technicians — as part of your monthly fixed cost. You can ensure that your system will always be available.',
                    ],
                ];
            @endphp
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
