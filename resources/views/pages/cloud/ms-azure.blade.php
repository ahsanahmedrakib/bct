...
<section class="relative bg-gradient-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
  <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
    <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
      <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Microsoft Azure</h1>
      <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Enterprise cloud computing platform for building, deploying, and managing applications through Microsoft's global network of data centres.</p>
    </div>
    <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
      <img alt="Microsoft Azure" loading="lazy" class="rounded-lg" src="/images/cloud/microsoft-solutions/azure/azure.png"/>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid lg:grid-cols-2 gap-16 items-center">
      <div class="reveal reveal-fade-up space-y-6">
        ...
        <p class="text-slate-600 leading-relaxed">Microsoft Azure is a comprehensive cloud computing platform with over 200 services for building, deploying, and managing applications. It provides IaaS, PaaS, and SaaS capabilities for organisations of all sizes.</p>
        <p class="text-slate-600 leading-relaxed">Azure enables you to host websites, run virtual machines, store data, build AI solutions, and connect on-premises environments with the cloud. It integrates seamlessly with Microsoft 365 and other Microsoft services.</p>
        <p class="text-slate-600 leading-relaxed">With global data centres across 60+ regions, Azure provides the reliability, scalability, and compliance certifications needed for enterprise workloads.</p>
      </div>
      <div class="reveal reveal-fade-up">
        <img src="/images/cloud/microsoft-solutions/azure/section.png" alt="Microsoft Azure Cloud" class="rounded-2xl shadow-lg w-full" loading="lazy"/>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed">Deploy Windows and Linux VMs with configurable compute, memory, and storage options.</p>
      </div>
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Build and deploy web apps, APIs, and mobile backends with managed PaaS infrastructure.</p>
      </div>
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed">Fully managed relational database with built-in intelligence, security, and scalability.</p>
      </div>
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        <div class="w-14 h-14 bg-brand-blue/10 rounded-xl flex items-center justify-center mb-6">
        ...
        <p class="text-slate-600 leading-relaxed">Isolated virtual networks with subnets, NSGs, and VPN gateway for hybrid connectivity.</p>
      </div>
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        <div class="w-14 h-14 bg-brand-blue/10 rounded-xl flex items-center justify-center mb-6">
        ...
        <p class="text-slate-600 leading-relaxed">Build intelligent apps with cognitive services, ML Studio, and OpenAI integration.</p>
      </div>
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        <div class="w-14 h-14 bg-brand-blue/10 rounded-xl flex items-center justify-center mb-6">
          <svg class="w-7 h-7 text-brand-blue" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" /></svg>
        ...
        <p class="text-slate-600 leading-relaxed">Massively scalable object storage for unstructured data, backups, and data lakes.</p>
      </div>
    </div>
  </div>
</section>
