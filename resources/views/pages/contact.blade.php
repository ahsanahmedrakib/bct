...
@section('content')
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        ...
        <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
            <svg class="relative block w-full h-15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120"
                preserveAspectRatio="none">
                <path
                    d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.8C59.71,118.11,130.92,141.14,211.39,130.78,258.73,125.75,305.56,107.89,321.39,56.44Z"
                    fill="#ffffff"></path>
            </svg>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div class="bg-white p-10 rounded-xl border-2 border-blue-100 relative">
                        ...
                        <div class="space-y-6 mb-10">
                            <div class="flex items-start gap-4">
                                <div
                                    class="w-12 h-12 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center shrink-0">
                        ...
                        <div class="border-t border-gray-100 pt-8">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="https://wa.me/8801972721388" target="_blank"
                                    class="bg-brand-green text-white rounded-xl shadow-md px-6 py-3 flex items-center gap-2 hover:opacity-90 transition-opacity">
                                    <i class="fab fa-whatsapp text-lg"></i>
                                    <span class="font-medium">WhatsApp</span>
                                </a>
                                <a href="https://m.me/bct" target="_blank"
                                    class="bg-messenger text-white rounded-xl shadow-md px-6 py-3 flex items-center gap-2 hover:opacity-90 transition-opacity">
                ...
                <div>
                    <div class="rounded-2xl overflow-hidden shadow border-2 border-blue-100 h-full min-h-125">
                        <iframe
                            ...
                            title="Our Location in Dhaka"></iframe>
                    </div>
                </div>
            </div>
        </div>
