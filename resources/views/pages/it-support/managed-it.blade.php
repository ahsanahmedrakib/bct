...
@section('description',
    'Proactive managed IT services including monitoring, maintenance, helpdesk, and strategic IT
...
@section('content')
    <main class="flex min-h-screen flex-col font-sans text-slate-800 bg-slate-50">
        ...
        <section class="py-20 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto" id="why-choose-us">
        ...
        <section class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8" id="services">
            <div class="reveal reveal-fade-up grid lg:grid-cols-2 gap-12 items-center my-12">
                <div class="order-2 lg:order-1">
                    <div
                        ...
                        <p class="text-slate-600 mb-6 leading-relaxed">With over 20 years of experience providing managed
                            IT
                            services
