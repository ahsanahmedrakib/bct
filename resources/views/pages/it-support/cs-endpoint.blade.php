...
@section('content')
    <main class="flex min-h-screen flex-col font-sans text-slate-800 bg-slate-50">
        ...
        <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
            <div
                ...
                <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                    ...
                    <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Endpoint security
                        protects devices like computers, smartphones, and servers from cyber threats. It includes antivirus,
                        anti-malware, firewalls, and real-time threat detection to prevent unauthorized access, malware, and
                        data breaches. This protection is vital for securing individual devices and the broader network they
                        connect to.</p>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 md:w-3/4 w-full">
                        <a href="#why-need"
                            class="group flex items-center justify-between px-6 py-4 bg-navy hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg text-white text-sm font-semibold rounded-xl shadow-md transition-all">
                            WHY IS IT NEEDED
                ...
                <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                    <img src="/images/it-support/cyber-security/cloud-and-network/hero.png" alt="EndPoint Security Hero"
            ...
            <div class="reveal reveal-fade-up grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                ...
                <div class="order-1 lg:order-2 flex justify-center items-center">
                    <div class="relative w-full overflow-hidden">
                        <img src="/images/it-support/cyber-security/endpoint-security/section-1.webp"
                            alt="Endpoint Protection Dashboard on Computer Screen" height="400" width="500"
        ...
        <section class="py-10 px-4 sm:px-6 lg:px-8 max-w-365 mx-auto w-full" id="why-need">
            <div class="reveal reveal-fade-up grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                {{-- Left Column: Phone Lock Key Illustration --}}
                <div class="flex justify-center items-center">
                    <div class="relative w-full max-w-sm aspect-square">
                        <img src="/images/it-support/cyber-security/endpoint-security/section-2.png"
                            alt="Mobile Security and Lock Key Illustration" height="400" width="400"
                            class="object-cover" />
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="space-y-3">
                            ...
                            @foreach ($whyNeedItems as $index => $item)
                                <div
                                    class="border border-slate-100 rounded-xl bg-slate-50/70 overflow-hidden transition-all">
                                    <button
                                        onclick="this.nextElementSibling.classList.toggle('hidden'); this.querySelector('.faq-chevron').classList.toggle('rotate-45')"
                                        class="w-full flex justify-between items-center px-5 py-3.5 text-left cursor-pointer hover:bg-slate-100/80 transition-colors">
                                        ...
                                        <span class="text-slate-400 text-xs transition-transform duration-300 faq-chevron">
                                    ...
                                    <div class="hidden">
                                        <div
                                            class="px-5 pb-3.5 pt-1 text-xs text-slate-600 border-t border-slate-100 bg-white text-justify">
                                            {{ $item['description'] }}
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="py-8 px-4 sm:px-6 lg:px-8 max-w-365 mx-auto w-full" id="defender-for-business">
            <div class="reveal reveal-fade-up grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    <div
                        ...
                        <div class="space-y-2 mb-6">
                            @foreach ($defenderFeatures as $feature)
                                <div
                                    class="bg-slate-50 border border-slate-100 rounded-lg px-4 py-2 text-xs font-medium text-slate-700 flex items-center justify-between">
                                    <span>{{ $feature }}</span>
                        ...
                        {{-- Action Button --}}
                        <a href="#why-need"
                            class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs py-2.5 px-6 rounded-md uppercase tracking-wider transition-colors shadow-sm">
                            LEARN MORE
                        </a>
                    </div>
                </div>
                ...
                <div class="flex justify-center items-center order-1 lg:order-2">
                    <div class="relative w-56 sm:w-72 aspect-square">
                        <img src="/images/it-support/cyber-security/endpoint-security/defender.png"
                            alt="Microsoft Defender Blue Shield Graphic" height="400" width="400"
                            class="object-cover" />
                    </div>
                </div>
            </div>
        ...
        <section class="py-8 px-4 sm:px-6 lg:px-8 max-w-365 mx-auto w-full" id="sentinel-one">
            <div class="reveal reveal-fade-up grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                {{-- Left Column: SentinelOne Logo Graphic --}}
                <div class="flex justify-center items-center">
                    <div class="relative overflow-hidden flex justify-center">
                        <img src="/images/it-support/cyber-security/endpoint-security/sentinel.png"
                            alt="SentinelOne Enterprise AI Security Logo" height="400" width="500"
                            class="object-cover" />
                    </div>
                </div>
                ...
                <div>
                    <div
                        ...
                        <div class="flex items-start space-x-3 mb-4">
                            <div
                                class="w-10 h-10 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-purple-600 shrink-0 mt-1">
        ...
        <section class="py-8 pb-20 px-4 sm:px-6 lg:px-8 max-w-365 mx-auto w-full" id="bit-defender">
            <div class="reveal reveal-fade-up grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                {{-- Left Column: Solution Card --}}
                <div class="order-2 lg:order-1">
                    <div
                        ...
                        <div class="flex items-start space-x-3 mb-4">
                            <div
                                class="w-10 h-10 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-red-600 shrink-0 mt-1">
                ...
                <div class="flex justify-center items-center order-1 lg:order-2">
                    <div class="relative overflow-hidden flex justify-center">
                        <img src="/images/it-support/cyber-security/endpoint-security/bitdefender.png"
                            alt="Bitdefender EndPoint Security Logo" height="400" width="400"
                            class="object-cover" />
                    </div>
                </div>
            </div>
