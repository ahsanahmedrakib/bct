...
<section class="relative bg-gradient-to-br from-hero-gradient to-white pt-28 pb-20 lg:pt-36 lg:pb-28 overflow-hidden">
  <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
    ...
    <div class="flex justify-center lg:justify-end">
      <img alt="Endpoint Security" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full" src="/images/it-support/cyber-security/endpoint-security/section-1.webp"/>
    </div>
  </div>
...
<section class="py-24 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
      <div class="reveal reveal-fade-up flex items-start gap-3 bg-slate-50 rounded-xl p-6 border-2 border-blue-100">
      ...
      <div class="reveal reveal-fade-up flex items-start gap-3 bg-slate-50 rounded-xl p-6 border-2 border-blue-100" style="animation-delay: 0.1s">
        <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
        <span class="text-slate-700 font-medium">Protecting Against Malware and Cyberattacks</span>
      </div>

      <div class="reveal reveal-fade-up flex items-start gap-3 bg-slate-50 rounded-xl p-6 border-2 border-blue-100" style="animation-delay: 0.2s">
        <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="reveal reveal-fade-up bg-white rounded-xl p-8 md:p-12 shadow-[0_5px_30px_-10px_rgba(0,0,0,0.05)] border-2 border-blue-100 hover:border-blue-300 hover:-translate-y-1 transition-all duration-300 mb-8">
    ...
    {{-- Sentinel One --}}
    <div class="reveal reveal-fade-up bg-white rounded-xl p-8 md:p-12 shadow-[0_5px_30px_-10px_rgba(0,0,0,0.05)] border-2 border-blue-100 hover:border-blue-300 hover:-translate-y-1 transition-all duration-300 mb-8" style="animation-delay: 0.1s">
      <div class="grid md:grid-cols-2 gap-8 items-start">
        <div>
          <span class="inline-block px-3 py-1 bg-brand-blue/10 text-brand-blue text-xs font-semibold rounded-full mb-4">Solution</span>
    ...
    {{-- Bit Defender --}}
    <div class="reveal reveal-fade-up bg-white rounded-xl p-8 md:p-12 shadow-[0_5px_30px_-10px_rgba(0,0,0,0.05)] border-2 border-blue-100 hover:border-blue-300 hover:-translate-y-1 transition-all duration-300" style="animation-delay: 0.2s">
      <div class="grid md:grid-cols-2 gap-8 items-start">
        <div>
          <span class="inline-block px-3 py-1 bg-brand-blue/10 text-brand-blue text-xs font-semibold rounded-full mb-4">Solution</span>
