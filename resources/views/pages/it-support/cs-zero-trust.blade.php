    ...
    <main class="flex min-h-screen flex-col font-sans text-slate-800 bg-slate-50">
        ...
        <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
            <div
                ...
                <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                    <img src="/images/it-support/cyber-security/cloud-and-network/hero.png" alt="Zero Trust Framework Hero"
        ...
        <section class="py-6 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto w-full">
            <div class="reveal reveal-fade-up flex justify-center items-center overflow-hidden rounded-lg">
                <img src="/images/it-support/cyber-security/zero-trust-framework/zero-trust.png"
                    alt="Description of the image" height="600" width="1300" />
            </div>
        </section>

        {{-- ==================== SECTION 3: Core Principles ==================== --}}
        <section class="pt-6 pb-12 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto w-full">
