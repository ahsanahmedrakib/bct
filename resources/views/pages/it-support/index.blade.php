...
@section('content')
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">We provide
                    enterprise-grade IT support and secure digital workspaces for small to medium businesses. Focus on your
                    growth while we handle the technology.</p>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 md:w-3/4 w-full">
                    <a href="#partners"
                        class="group flex cursor-pointer items-center justify-between px-6 py-4 bg-navy hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg text-white text-sm font-semibold rounded-xl shadow-md transition-all">
                        Our Partners
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="IT Support Hero" loading="lazy" class="rounded-lg w-full max-w-md lg:max-w-lg"
    ...
    <div class="bg-slate-50 py-24 space-y-32">
        ...
        {{-- 1. Our Capabilities --}}
        <section class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8" id="capabilities">
            <div class="reveal reveal-fade-up">
                <div class="grid lg:grid-cols-2 gap-12 items-center mb-16">
                    ...
                    <div class="w-full order-1 lg:order-2">
                        <img src="/images/it-support/capablities.jpg" alt="Capabilities"
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    @foreach ($capabilityCards as $i => $card)
                        <div class="reveal reveal-fade-up" style="transition-delay:{{ $i * 80 }}ms">
                            <div
                                class="flex flex-col h-full bg-white p-8 rounded-2xl shadow-sm border-2 border-blue-100 hover:border-blue-400 hover:shadow-lg hover:-translate-y-1 transition-all relative">
                                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                                ...
                                <div class="my-1">
                                    @foreach ($card['services'] as $service)
                                        <span
                                            class="block w-fit px-3 py-1 bg-blue-100 text-blue-800 text-xs rounded-full mr-2 mb-2">{{ $service }}</span>
                                    @endforeach
                                </div>
                                <a href="{{ route($card['route']) }}"
                                    class="mt-auto text-blue-600 font-medium flex items-center text-sm hover:text-blue-800">
                                    Read More
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 ml-1">
        ...
        {{-- 2. Cyber Security --}}
        <section class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8" id="security">
            <div class="reveal reveal-fade-up">
                <div class="grid lg:grid-cols-2 gap-6 items-center mb-12">
                    ...
                    <div class="h-full">
                        <div
                            ...
                            <p class="text-slate-600 mb-6 leading-relaxed">Protect your business assets with our
                                multi-layered security solutions. We identify vulnerabilities before they are exploited and
                                ensure your data remains completely secure and compliant.</p>
                            <a href="{{ route('it-support.cyber-security') }}"
                ...
                <div class="flex flex-wrap justify-center gap-6">
                    @foreach ($cyberSecurityFeatures as $i => $feature)
                        <div class="reveal reveal-fade-up" style="transition-delay:{{ $i * 80 }}ms">
                            <div
                                class="flex flex-col items-center justify-center p-6 bg-white rounded-2xl shadow-sm border-2 border-blue-100 hover:border-blue-400 hover:bg-blue-50 hover:shadow-md hover:-translate-y-1 w-36 md:w-44 transition-all">
                                ...
                                <span
                                    class="text-xs font-semibold text-center text-slate-700">{{ $feature['label'] }}</span>
                            </div>
                        </div>
                    @endforeach
                </div>
        ...
        <section class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8" id="networking">
            <div class="reveal reveal-fade-up">
                <div class="grid lg:grid-cols-2 gap-12 items-center mb-12">
                    <div class="order-2 lg:order-1 h-full">
                        <div
                            ...
                            <p class="text-slate-600 mb-6 leading-relaxed">Robust infrastructure is the backbone of your
                                operations. We design, implement, and maintain high-speed networks and reliable server
                                environments tailored to your workload.</p>
                            <a href="{{ route('it-support.servers-networking') }}"
                                class="text-blue-600 font-medium flex items-center hover:text-blue-800">
                    ...
                    <div class="w-full order-1 lg:order-2">
                        <img src="/images/it-support/networking.jpg" alt="Servers" class="w-full h-auto object-cover" />
                    </div>
                </div>
        ...
        <section class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8" id="it">
            <div class="reveal reveal-fade-up">
                <div class="grid lg:grid-cols-2 gap-12 items-center mb-12">
                    <div class="w-full">
                        <img src="/images/it-support/it.jpg" alt="Managed Services" class="w-full h-auto object-cover" />
                    </div>
                    <div class="h-full">
                        <div
                            class="bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all relative h-full">
                            ...
                            <p class="text-slate-600 mb-6 leading-relaxed">Outsource your IT management to us. We offer
                                predictable monthly costs for comprehensive support, ensuring your systems are always up to
                                date, secure, and performing optimally.</p>
                            <a href="{{ route('it-support.managed-it') }}"
                                class="text-blue-600 font-medium flex items-center hover:text-blue-800">
                                Explore Managed IT
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
        ...
        {{-- 5. Device Repair --}}
        <section class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8 pb-20" id="repair">
            <div class="reveal reveal-fade-up">
                <div class="grid lg:grid-cols-2 gap-12 items-center mb-12">
                    <div class="order-2 lg:order-1 h-full">
                        <div
                            ...
                            <p class="text-slate-600 mb-6 leading-relaxed">Hardware failures can bring work to a halt. Our
                                skilled technicians provide rapid diagnostic and repair services for laptops, desktops, and
                                peripherals to minimize your downtime.</p>
                            <a href="{{ route('it-support.device-repair') }}"
                                class="text-blue-600 font-medium flex items-center hover:text-blue-800">
                                Book a Repair
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <div class="w-full order-1 lg:order-2">
                        <img src="/images/it-support/repair.jpg" alt="Device Repair"
                            class="w-full h-auto object-cover" />
                    </div>
                </div>
