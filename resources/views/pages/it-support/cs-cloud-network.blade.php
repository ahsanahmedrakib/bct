...
<section class="relative bg-gradient-to-br from-hero-gradient to-white pt-28 pb-20 lg:pt-36 lg:pb-28 overflow-hidden">
  <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
    ...
    <div class="flex justify-center lg:justify-end">
      <img alt="Cloud & Network Security" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full" src="/images/it-support/cyber-security.png"/>
    </div>
  </div>
...
<section class="py-24 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="reveal reveal-fade-up bg-slate-50 rounded-2xl p-8 border border-slate-100">
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      <div class="reveal reveal-fade-up flex items-start gap-3 bg-white rounded-xl p-6 border border-slate-100">
        <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
      ...
      <div class="reveal reveal-fade-up flex items-start gap-3 bg-white rounded-xl p-6 border border-slate-100" style="animation-delay: 0.1s">
        <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
      ...
      <div class="reveal reveal-fade-up flex items-start gap-3 bg-white rounded-xl p-6 border border-slate-100 md:col-span-2">
        <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
...
<section class="py-24 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      <div class="reveal reveal-fade-up bg-gradient-to-br from-brand-blue/5 to-transparent rounded-2xl p-8 border border-brand-blue/10">
      ...
      <div class="reveal reveal-fade-up bg-gradient-to-br from-brand-blue/5 to-transparent rounded-2xl p-8 border border-brand-blue/10" style="animation-delay: 0.1s">
      ...
      <div class="reveal reveal-fade-up bg-gradient-to-br from-brand-blue/5 to-transparent rounded-2xl p-8 border border-brand-blue/10" style="animation-delay: 0.2s">
      ...
      <div class="reveal reveal-fade-up bg-gradient-to-br from-brand-blue/5 to-transparent rounded-2xl p-8 border border-brand-blue/10 md:col-span-2" style="animation-delay: 0.1s">
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      <div class="reveal reveal-fade-up flex items-start gap-3 bg-white rounded-xl p-6 border border-slate-100 hover:shadow-lg transition-shadow">
        <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
        <span class="text-slate-700">Customized security strategies tailored to your unique needs.</span>
      </div>

      <div class="reveal reveal-fade-up flex items-start gap-3 bg-white rounded-xl p-6 border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
