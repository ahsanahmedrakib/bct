...
@section('content')
    <main class="flex min-h-screen flex-col font-sans text-slate-800 bg-slate-50">
        ...
        {{-- BRANDS WE REPAIR --}}
        <section class="py-8 px-4 sm:px-6 lg:px-8 max-w-365 mx-auto w-full text-center">
        ...
        <section class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-365 mx-auto w-full" id="it-services">
            <div class="reveal reveal-fade-up grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                <div class="flex justify-center items-center">
