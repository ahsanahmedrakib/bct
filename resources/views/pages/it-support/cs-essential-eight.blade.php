...
@section('description', 'The ACSC Essential Eight is a cybersecurity framework from Australia\'s Cyber Security Centre,
    outlining eight strategies to protect against cyber threats.')
        ...
        <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
            <div
                ...
                <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                    ...
                    <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">The ACSC Essential
                        Eight is a cybersecurity framework from Australia's Cyber Security Centre, outlining eight
                        strategies to protect against cyber threats. These include patching, application control, user
                        access management, backups, and more, aimed at minimizing the risk of cyber attacks and ensuring
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <div
                            ...
                            <h2 class="text-2xl md:text-3xl font-bold text-blue-600 mb-6 mt-2 uppercase tracking-tight">WHAT
                                IS ACSC ESSENTIAL EIGHT?</h2>
                            <p class="text-slate-500 text-sm leading-relaxed mb-6 text-justify">Developed by the Bangladeshi
                                Cyber Security Centre (ACSC), the Essential Eight is a baseline set of strategies designed
                                to help organizations mitigate cyber security threats. Implementing these strategies makes
                                it significantly harder for adversaries to compromise systems.</p>
                            <p class="text-slate-500 text-sm leading-relaxed mb-8 text-justify">We help businesses implement
                                and maintain the Essential Eight strategies to build a robust defense mechanism. Contact us
                                today to learn more about how we can strengthen your organization's cyber security.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="reveal reveal-fade-up max-w-356 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div
                        ...
                        <img src="/images/it-support/cyber-security/essential-eight/faq.jpg" alt="Fiber Optic Server Cables"
