...
@section('content')
    <main class="flex min-h-screen flex-col font-sans text-slate-800 bg-slate-50">
        ...
        <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
            <div
                class="max-w-356 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10 reveal reveal-fade-up">
                <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                    ...
                    <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">
                        Endpoint security protects devices like computers, smartphones, and servers from cyber threats. It
                        includes antivirus, anti-malware, firewalls, and real-time threat detection to prevent unauthorized
                        access, malware, and data breaches. This protection is vital for securing individual devices and the
                        broader network they connect to.
                    </p>
                ...
                <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                    <img src="{{ asset('images/it-support/cyber-security/cloud-and-network/hero.png') }}" alt="BG Image"
        ...
        <section class="pt-12 sm:pt-16 pb-6 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto w-full text-justify">
            <div class="reveal reveal-fade-up h-full">
                <div
                    class="bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 relative h-full">
        ...
        <section class="py-6 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto w-full text-justify">
            <div class="reveal reveal-fade-up h-full">
                <div
                    class="bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 relative h-full">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
        ...
        <section class="pt-6 pb-16 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto w-full text-justify">
            <div class="reveal reveal-fade-up h-full">
                <div
                    class="bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 relative h-full">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    ...
                    <p class="text-xs sm:text-sm text-slate-500 leading-relaxed border-t border-blue-100 pt-4">
                        ...
                        <a href="tel:+8801972721388" class="text-brand-blue font-semibold hover:underline">+880
                            1972-721388</a>.
                    </p>
                </div>
            </div>
