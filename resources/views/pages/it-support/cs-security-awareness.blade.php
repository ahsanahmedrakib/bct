...
@section('content')
    <main class="flex min-h-screen flex-col font-sans text-slate-800 bg-slate-50">
        ...
        <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
            <div
                class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10 reveal reveal-fade-up">
            ...
            <div class="reveal reveal-fade-up h-full">
                <div
                    ...
                    <p class="text-xs sm:text-sm md:text-base text-slate-600 leading-relaxed">
                        At BCT, our security awareness training empowers
            ...
            <div class="reveal reveal-fade-up h-full">
                <div
                    ...
                    <p class="text-xs sm:text-sm text-slate-500 leading-relaxed">
                        BCT brings extensive experience in delivering
            ...
            <div class="reveal reveal-fade-up h-full">
                <div
                    ...
                    <p class="text-xs sm:text-sm text-slate-500 leading-relaxed border-t border-blue-100 pt-4">
                        ...
                        a demo, contact BCT online or call us at
