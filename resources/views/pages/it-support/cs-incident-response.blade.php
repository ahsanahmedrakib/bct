...
<main class="flex min-h-screen flex-col font-sans text-slate-800 bg-slate-50">
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Protect your business from costly and damaging cybersecurity incidents with Total Solutions IT. Our incident response services are designed to swiftly address and mitigate incidents, minimizing and, where possible, reversing the impact of breaches.</p>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 md:w-3/4 w-full">
                    <a href="https://learn.microsoft.com/en-us/defender-office-365/responding-to-a-compromised-email-account" target="_blank" class="group flex cursor-pointer items-center justify-between px-6 py-4 text-white text-sm font-semibold rounded-xl shadow-md transition-all bg-navy hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg">
                        MICROSOFT ACCOUNT
                    ...
                    <a href="#" class="group flex cursor-pointer items-center justify-between px-6 py-4 text-white text-sm font-semibold rounded-xl shadow-md transition-all bg-navy hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg">
                        REPORT INCIDENT
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 text-sky-300 transition-transform group-hover:translate-x-1"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                    </a>
                    <a href="#" class="group flex cursor-pointer items-center justify-between px-6 py-4 text-white text-sm font-semibold rounded-xl shadow-md transition-all bg-navy hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg">
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img src="/images/it-support/cyber-security/incident-response/hero.jpg" alt="Incident Response Hero" height="400" width="600" class="rounded-lg" />
            </div>
        </div>
        ...
        <div class="reveal reveal-fade-up">
            ...
            <ul class="space-y-4 text-xs sm:text-sm text-slate-500">
                <li class="flex items-start">
                    <span class="text-brand-blue mr-2 font-bold">&bull;</span>
                    <span>
    ...
    <section class="py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full text-justify">
        <div class="reveal reveal-fade-up">
            ...
            <ul class="space-y-3 text-xs sm:text-sm text-slate-500 mb-6">
                <li class="flex items-start">
                    <span class="text-brand-blue mr-2 font-bold">&bull;</span>
                    <span>
                        <strong class="text-brand-blue font-bold uppercase">
