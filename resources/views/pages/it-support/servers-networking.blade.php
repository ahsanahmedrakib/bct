...
@section('content')
    <main class="flex min-h-screen flex-col font-sans text-slate-800 bg-slate-50">
        ...
        <section class="py-16 px-4 sm:px-6 lg:px-8 max-w-365 mx-auto w-full">
        ...
        <section class="py-12 px-4 sm:px-6 lg:px-8 max-w-365 mx-auto w-full">
            <div class="reveal reveal-fade-up">
        ...
        <section class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-slate-900 text-white w-full" id="networking-solutions">
            <div class="reveal reveal-fade-up max-w-365 mx-auto">
