...
@section('content')
        ...
        <div class="reveal reveal-fade-up">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Tailored solutions built from scratch to match your
                        unique business requirements and goals.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Websites that look and perform flawlessly on every
                        device, from desktop to mobile.</p>
                </div>
                ...
                <div
                    ...
                    <div class="flex justify-center pb-6 text-blue-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-layout">
                    ...
                    <p class="text-slate-600 text-sm text-justify">Intuitive and visually stunning interfaces that enhance
                        user engagement and satisfaction.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Built with search engine best practices to help you rank
                        higher and attract more visitors.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Robust security measures and reliable hosting to keep
                        your website safe and online.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Optimized for speed with fast load times and smooth
                        interactions for the best user experience.</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Full-stack web application development</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Progressive Web Apps (PWA)</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Single Page Applications (SPA)</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">API development and integration</span></div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">React, Next.js, and modern frameworks</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Responsive and mobile-first design</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Interactive UI components</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Cross-browser compatibility</span></div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Server-side logic and APIs</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Database design and management</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Authentication and authorization</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Cloud deployment and scaling</span></div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Regular updates and patches</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Performance monitoring</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">Bug fixes and troubleshooting</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg><span class="text-slate-600 text-sm">24/7 technical support</span></div>
                </div>
        ...
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div>
                <div
                    ...
                    <p class="text-slate-600 mb-6 leading-relaxed">We craft custom websites that are not only visually
                        stunning
                    ...
                    <p class="text-slate-600 mb-6 leading-relaxed">From concept to launch, we work closely with you to
                        understand
                        your goals and deliver a website that exceeds expectations. Every project is treated with the same
                        level
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto">
        <div
            class="reveal reveal-fade-up grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 items-center justify-items-center">
            <img src="/images/web/wp.png" alt="WordPress"
                class="h-auto w-auto object-contain opacity-60 hover:opacity-100 transition">
