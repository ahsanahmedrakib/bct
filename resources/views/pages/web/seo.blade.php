...
@section('content')
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">We help your business
                    get
    ...
    {{-- ==================== OUR SEO SERVICES ==================== --}}
    <section class="py-20 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto">
        <div class="reveal reveal-fade-up">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div
                    class="border-2 rounded-2xl p-6 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                    ...
                    <p class="text-slate-600 text-sm text-justify">Gain valuable insights into your SEO performance with our
                        monthly reporting enabling data-driven decision-making and continuous improvement.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Target local customers with tailored SEO strategies,
                        enhancing your presence in specific regions and dominate search in your area.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">We write SEO content tailored to increasing your
                        authority on targeted words proving to Google your website is about that topic.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Getting other websites to link to your website is like
                        someone voting for you. These are called back links and we do the hard work in creating them for
                        you.</p>
                </div>
            ...
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <p class="text-slate-600 mb-6 leading-relaxed">Selecting the right phrases and words to optimise your
                        website is very important. We research and track the most appropriate search terms to make sure
                        people
                        are googling them so you don't waste time trying to be found for something nobody is searching for.
                    </p>
                </div>
            </div>
            <div class="flex justify-center order-1 lg:order-2">
                <img src="/images/web/seo/seo.png" alt="Working seamlessly online"
            ...
            <div>
                <div
                    ...
                    <p class="text-slate-600 mb-4 leading-relaxed">Yoast is Search Engine Optimisation (SEO) for everyone.
                        Whether you're a beginner, a blogger or a big business, Yoast gets your website into perfect shape
                        to
                        compete in the search results.</p>
                    <p class="text-slate-600 mb-6 leading-relaxed">Over 13 million users have the Yoast SEO plugin
                        installed on
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">yoast, seo, search engine optimisation, search
                        engine,
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 mb-12 max-w-3xl mx-auto">Search Engine Optimization (SEO) works by
                optimizing
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    class="relative border-2 border-blue-100 hover:border-blue-300 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div class="flex items-start gap-3 mb-4">
                        <svg class="w-6 h-6 text-blue-600 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Adding structured data is one of the most effective
                        ways
                        of getting your site noticed by search engines. Yoast SEO automatically adds the right structured
                        data
                        and comes with options for you to enrich your site with extra structured data. Increases your
                        chances
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Bid farewell to the complexities of SEO. Yoast SEO
                        handles
                        the technical aspects, such as canonical URLs and meta tags, automating essential optimizations
                        behind
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Take advantage of advanced features like XML
                        sitemaps,
                        title and meta description templating, and Schema.org structured data integration. Empower search
                        engines to fully understand and appreciate your website, helping you reach the top of search
                        results.</p>
                </div>
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
                ...
                {{-- Keyword Research --}}
                <div
                    class="flex gap-4 relative items-start border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all border-blue-100 hover:border-blue-300">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div
                        class="shrink-0 w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600">
                    ...
                    <div>
                        ...
                        <p class="text-slate-600 text-sm leading-relaxed">Identify relevant keywords that users are likely
                            to search for when looking for information related to your website.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-slate-600 text-sm leading-relaxed">Optimize individual pages of your website for
                            selected keywords. This involves including keywords in titles, headings, meta descriptions, and
                            throughout the content.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-slate-600 text-sm leading-relaxed">Create high-quality, relevant, and valuable
                            content. Search engines aim to provide users with the best possible results, so quality content
                            is crucial for ranking.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-slate-600 text-sm leading-relaxed">Ensure a positive user experience by having a
                            well-designed and user-friendly website. This includes fast loading times, mobile
                            responsiveness, and easy navigation.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-slate-600 text-sm leading-relaxed">Acquire high-quality backlinks from reputable
                            websites. Backlinks act as a vote of confidence for your content, contributing to higher search
                            engine rankings.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-slate-600 text-sm leading-relaxed">Optimize technical aspects of your website, such
                            as improving site speed, using clean URL structures, and having a sitemap. This helps search
                            engines crawl and index your site more efficiently.</p>
                    </div>
                </div>
