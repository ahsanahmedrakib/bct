    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed mt-2">From secure
                    payment
        ...
        <div class="reveal reveal-fade-up">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Feature-rich shopping carts that simplify the checkout
                        process and boost your sales.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Secure payment gateways including Stripe, PayPal, and
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Real-time inventory tracking and automated stock
                        management for your products.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Comprehensive sales analytics and reports to track your
                        store performance.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">Integrated shipping options with real-time tracking and
                        automated order fulfillment.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify">SSL encryption and PCI compliance to ensure every
                        transaction is safe and secure.</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                        ...
                        </svg><span class="text-slate-600 text-sm">WordPress-based eCommerce</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Thousands of plugins available</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Full customization control</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Ideal for small to medium businesses</span></div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Hosted eCommerce platform</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Easy setup and management</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Built-in payment processing</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Scalable for growing businesses</span></div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Tailored to your requirements</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Unique branding and features</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Full ownership of code</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Best for enterprise needs</span></div>
                </div>
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div>
                <div
                    ...
                    <p class="text-slate-600 mb-6 leading-relaxed">Launch your online store with a professional eCommerce
                        website designed to maximize conversions. We build custom stores that reflect your brand and provide
                        a
                        seamless shopping experience.</p>
                    <p class="text-slate-600 mb-6 leading-relaxed">From product listings to payment processing, we handle
                        every
            ...
            <div class="flex justify-center order-1 lg:order-2">
                <img src="/images/web/ecommerce/ecommerce.png" alt="Working seamlessly online"
