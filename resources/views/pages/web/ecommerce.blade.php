...
<section class="relative bg-gradient-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
  <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
    <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
      <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">eCommerce Solutions</h1>
      <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Build a powerful online store that drives sales and grows your business. Custom eCommerce solutions tailored to your needs.</p>
    </div>
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16 reveal reveal-fade-up">
      ...
      <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Everything you need to run a successful online store.</p>
    </div>
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed">Easy-to-use product catalog with inventory tracking, variants, and bulk import/export capabilities.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Multiple payment gateway integrations with SSL encryption for safe and secure transactions.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed">Automated shipping calculations and tracking integration with major carriers.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed">Customer registration, wish lists, order history, and personalized shopping experiences.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Real-time sales analytics, customer insights, and conversion tracking to optimize your store.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed">Fully responsive design that provides a seamless shopping experience on all devices.</p>
      </div>
