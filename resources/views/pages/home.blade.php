...
@section('content')
    ...
    <section id="about-sec" class="relative bg-white py-16 mt-4 px-4 sm:px-6 lg:px-8 lg:overflow-hidden">
        ...
        <div class="max-w-365 mx-auto relative z-10">
            {{-- Section Title --}}
    ...
    <div
        class="reveal reveal-fade-up text-start -mt-2 sm:-mt-6 max-w-365 mx-auto flex flex-col md:flex-row justify-between px-2">
        <div>
            <span class="inline-flex items-center gap-3 text-theme-blue text-lg sm:text-xl font-medium tracking-wide">
                <span class="relative inline-block h-5 w-5 shrink-0" aria-hidden="true">
                    <span class="absolute left-0 top-0 h-2.5 w-2.5 bg-theme-border"></span>
    ...
    <section class="bg-linear-to-b from-gray-50 via-white to-gray-50 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden relative">
        ...
        <div class="max-w-365 px-4 sm:px-6 lg:px-8 mx-auto relative z-10">
            <div class="mb-24">
    ...
    <section class="bg-dark-deep text-white py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="max-w-365 mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
    ...
    <section class="bg-dark-hero text-white py-16 md:py-24 font-sans overflow-hidden">
        <div class="max-w-365 px-4 sm:px-6 lg:px-8 mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            {{-- Left Column --}}
