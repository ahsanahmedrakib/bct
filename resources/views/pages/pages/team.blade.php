                                        ...
                                        @foreach ($socials as $key => $url)
                                            @if ($url)
                                                <a href="{{ $url }}" target="_blank" rel="noopener noreferrer"
                                                    ...
                                                    class="flex items-center justify-center w-8 h-8 rounded-full text-white transition-transform duration-300 hover:scale-110 @if ($key === 'facebook') bg-[#1877f2] @elseif ($key === 'instagram') bg-linear-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] @elseif ($key === 'linkedin') bg-[#0a66c2] @else bg-black @endif">
                                                    @if ($key === 'facebook')
