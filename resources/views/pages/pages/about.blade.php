...
@section('description', 'Learn about Bismillah Computer & Technology - empowering businesses through smart IT solutions
    with over 10 years of trusted experience.')
...
@section('content')
        ...
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="reveal reveal-fade-up grid lg:grid-cols-2 gap-16 items-center">
                <div class="space-y-6">
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold text-heading leading-tight">Empowering Businesses Through
                        Smart IT Solutions</h2>
                    <p class="text-body-muted text-lg leading-relaxed">Bismillah Computer & Technology delivers secure,
                        scalable, and affordable IT solutions — from network consultancy and website development to ISP,
                        hardware, and software support. With over 10 years of trusted experience, we help businesses stay
                        connected, reliable, and future-ready.</p>
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-body-muted">Driving growth through smart, reliable, and
                                        future-ready IT solutions.</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3 mb-6">
                                <div class="w-16 h-16 rounded-full bg-brand-blue/10 flex items-center justify-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-body-muted">Streamline communication and data sharing with
                                        secure, high-performance internal networks.</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-body-muted">Turning complicated technology into simple, effective
                                        solutions.</p>
                                </div>
                            </div>
                        </div>
    ...
    <section class="py-20 bg-brand-light-bg">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="reveal reveal-fade-up text-center mb-16">
                <span class="inline-block text-brand-blue font-bold text-sm uppercase tracking-wider mb-3">Work
                    Process</span>
                <h2 class="text-3xl md:text-4xl font-extrabold text-heading">Managed IT Services That Keep You Moving
                    Forward</h2>
            </div>
            <div class="reveal reveal-fade-up grid md:grid-cols-3 gap-8">
                <div
                    class="bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 transition-all relative h-full border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] text-center group">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div
                        class="w-16 h-16 rounded-full bg-brand-blue/10 flex items-center justify-center mx-auto mb-6 group-hover:bg-brand-blue group-hover:text-white transition-all duration-300">
                        <span
                            class="text-xl font-extrabold text-brand-blue group-hover:text-white transition-colors">01</span>
                    </div>
                    <h3 class="text-xl font-bold text-heading mb-3">Consultation & Assessment</h3>
                    <p class="text-body-muted leading-relaxed">We begin with a deep understanding of your business needs,
                        current IT environment, and growth objectives.</p>
                </div>
                <div
                    class="bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 transition-all relative h-full border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] text-center group">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div
                        class="w-16 h-16 rounded-full bg-brand-blue/10 flex items-center justify-center mx-auto mb-6 group-hover:bg-brand-blue group-hover:text-white transition-all duration-300">
                        <span
                            class="text-xl font-extrabold text-brand-blue group-hover:text-white transition-colors">02</span>
                    </div>
                    <h3 class="text-xl font-bold text-heading mb-3">Implementation & Integration</h3>
                    <p class="text-body-muted leading-relaxed">Our team ensures seamless integration of new solutions into
                        your existing infrastructure, minimizing disruption.</p>
                </div>
                <div
                    class="bg-white p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 transition-all relative h-full border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] text-center group">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div
                        class="w-16 h-16 rounded-full bg-brand-blue/10 flex items-center justify-center mx-auto mb-6 group-hover:bg-brand-blue group-hover:text-white transition-all duration-300">
                        <span
                            class="text-xl font-extrabold text-brand-blue group-hover:text-white transition-colors">03</span>
                    </div>
                    <h3 class="text-xl font-bold text-heading mb-3">Ongoing Support & Optimization</h3>
                    <p class="text-body-muted leading-relaxed">We provide continuous support and regularly assess
                        performance to enhance system efficiency.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="reveal reveal-fade-up grid lg:grid-cols-2 gap-16 items-start">
                <div>
                    ...
                    <p class="text-body-muted text-lg mb-8">With years of experience in the IT industry, our certified
                        professionals bring deep knowledge and proven solutions to every project.</p>
                    <a href="{{ route('contact') }}"
                        class="inline-flex items-center gap-2 bg-brand-blue hover:bg-brand-hover text-white font-semibold rounded-full px-8 py-3.5 transition-all duration-300">
                        Asked Questions
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                ...
                <div class="space-y-4">
                    @php
                        $faqs = [
                            'Can You Help Migrate Our Data To The Cloud?' =>
                                'Absolutely. We provide secure and seamless cloud migration services with minimal downtime and full data integrity. Our team handles everything from planning and assessment to execution and post-migration support.',
                            'How Do You Ensure Our Data And Systems Are Secure?' =>
                                'Absolutely. We provide secure and seamless cloud migration services with minimal downtime and full data integrity. Our team handles everything from planning and assessment to execution and post-migration support.',
                            'What If We Already Have An In-House IT Team?' =>
                                'Absolutely. We provide secure and seamless cloud migration services with minimal downtime and full data integrity. Our team handles everything from planning and assessment to execution and post-migration support.',
                            'How Do I Know Which IT Services My Business Needs?' =>
                                'Absolutely. We provide secure and seamless cloud migration services with minimal downtime and full data integrity. Our team handles everything from planning and assessment to execution and post-migration support.',
                        ];
                    @endphp
    ...
    <section class="py-20 bg-white">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="reveal reveal-fade-up text-center mb-16">
                <span
                    class="inline-block text-brand-blue font-bold text-sm uppercase tracking-wider mb-3">Testimonials</span>
            ...
            <div class="reveal reveal-fade-up grid md:grid-cols-2 gap-8">
                <div
                    class="bg-brand-light-bg p-10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 transition-all relative h-full border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    ...
                    <p class="text-body-muted leading-relaxed mb-6 italic">"Bismillah Computer & Technology has been an
                        invaluable partner for our IT needs. Their team delivered exceptional results on time and within
                        budget."</p>
                ...
                <div
                    ...
                    <p class="text-body-muted leading-relaxed mb-6 italic">"Their professionalism and expertise in cloud
                        solutions and cyber security have significantly improved our business operations. Highly
                        recommended!"</p>
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-full bg-brand-blue/20 flex items-center justify-center">
