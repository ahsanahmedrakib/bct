    ...
    <section class="py-20 bg-white">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="reveal reveal-fade-up text-center mb-12">
                <span class="inline-block text-brand-blue font-bold text-sm uppercase tracking-wider mb-3">Case
                    Studies</span>
                    ...
                    @php
                        $caseStudies = [
                            [
                                ...
                                'image' => '/images/pages/case-study/case_4_1.jpg',
                            ],
                            [
                                'title' => 'E-Commerce Store Build',
                                'category' => 'Woo Commerce',
                                'image' => '/images/pages/case-study/case_4_2.jpg',
                            ],
                            [
                                'title' => 'Sales CRM Integration',
                                'category' => 'CRM Solutions',
                                'image' => '/images/pages/case-study/case_4_3.jpg',
                            ],
                            [
                                'title' => 'Corporate Website Redesign',
                                'category' => 'Web Design',
                                'image' => '/images/pages/case-study/case_4_4.jpg',
                            ],
                            [
                                'title' => 'Managed IT Support',
                                'category' => 'IT Support',
                                'image' => '/images/pages/case-study/case_4_5.jpg',
                            ],
                            [
                                'title' => 'Mobile App Development',
                                'category' => 'Development',
                                'image' => '/images/pages/case-study/case_4_6.jpg',
                            ],
                            [
                                'title' => 'Brand Landing Page',
                                'category' => 'Web Design',
                                'image' => '/images/pages/case-study/case_4_7.jpg',
                            ],
                        ];
                    @endphp
