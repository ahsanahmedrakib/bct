...
@section('description', 'Stay updated with the latest insights, tips, and news from Bismillah Computer & Technology on
    cloud, software, cyber security, and more.')
    ...
    <section class="py-20 bg-white">
        <div class="max-w-365 mx-auto px-4 sm:px-6 lg:px-8">
            @php
                $blogs = $blogs ?? [
                    [
                        'slug' => 'cloud-solutions-for-scalable-it-infrastructure',
                    ...
                    [
                        'slug' => 'innovative-software-solutions-for-businesses',
                    ...
                    [
                        'slug' => 'practical-tips-for-secure-it-systems-checklist',
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($blogs as $b)
                    <a href="{{ route('pages.blog-show', $b['slug']) }}"
                        ...
                        <div class="flex flex-col flex-1 p-6 sm:p-8 pt-8">
                            ...
                            <h3
                                class="text-xl font-bold text-gray-900 leading-snug tracking-tight transition-colors cursor-pointer mb-6 group-hover:text-brand-blue">
                                {{ $b['title'] }}</h3>
                            <div
                                ...
                                <div class="flex items-center space-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round" class="text-brand-blue/60">
