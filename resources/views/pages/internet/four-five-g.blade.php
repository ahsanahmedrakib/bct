...
@section('content')
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8">
            <h2 class="text-3xl text-center font-bold text-blue-900 mb-12">What Does the 4G/5G Installation Process Involve?
            </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                        ...
                        </svg><span class="text-slate-600 text-sm">High-speed wireless delivered without the long wait or
                            high cost of cable infrastructure.</span></div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Concealed cabling and a tidy internal outlet, connected
                            and configured by certified technicians.</span></div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">A built-in high gain antenna on your roof captures
                            strong, reliable signal from the nearest tower.</span></div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">From site survey to speed test, our team ensures your
                            connection is fast and reliable.</span></div>
                </div>
