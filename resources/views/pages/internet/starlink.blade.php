...
@section('content')
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto">
        <div class="reveal reveal-fade-up grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="flex justify-center">
                <div
                    class="w-full max-w-md aspect-4/3 rounded-2xl border-2 border-dashed border-blue-200 bg-blue-50/40 flex items-center justify-center">
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8">
            <h2 class="text-3xl text-center font-bold text-blue-900 mb-12">What Does the Antenna Installation Process
                Involve?</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">A Total Solutions IT technician will come
                        ...
                        your roof, mounting options, possible cable routes and the location of your Router, including
                        options
                ...
                <div
                    ...
                    <div class="flex items-start gap-4 mb-4">
                        <span
                            class="shrink-0 w-11 h-11 rounded-full bg-blue-600 text-white font-bold flex items-center justify-center">2</span>
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">We securely mount the Starlink satellite
                        ...
                        Starlink satellite dish to the router. We will create an interior outlet (if required) near where
                        the
                ...
                <div
                    ...
                    <div class="flex items-start gap-4 mb-4">
                        <span
                            class="shrink-0 w-11 h-11 rounded-full bg-blue-600 text-white font-bold flex items-center justify-center">3</span>
                        <h3 class="text-xl font-bold text-slate-900 pt-2">Assessment of Efficiency</h3>
                    </div>
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">Once complete, your technician will run
                        an
        ...
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8">
            ...
            <div class="space-y-8">
                ...
                <div
                    ...
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <h3 class="text-xl font-bold text-slate-900 mb-4">What factors need to be considered for the cost of
                        install?</h3>
                    <p class="text-slate-600 text-sm leading-relaxed mb-4">There are a few factors to consider when
                        determining the price of professional Starlink Installation:</p>
                    <ul class="space-y-3">
                        <li class="flex items-start"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg><span class="text-slate-600 text-sm">Where the Starlink satellite is going to be located —
                                how difficult it is to access and how far it is from where you require internet
                                access.</span></li>
                        <li class="flex items-start"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg><span class="text-slate-600 text-sm">What obstructions exist that may interfere with
                                signal reception and what height is required to avoid them — such as tall trees, structures
                                or buildings.</span></li>
                        <li class="flex items-start"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg><span class="text-slate-600 text-sm">The construction of your house — flat or pitched
                                roof, crawl space or wall cavities, single or double story, tile or metal roof, and
                                more.</span></li>
                        <li class="flex items-start"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg><span class="text-slate-600 text-sm">Where the Starlink Router will be located within the
                                house and whether the Starlink-supplied cable will be long enough.</span></li>
                        <li class="flex items-start"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg><span class="text-slate-600 text-sm">Whether you need to boost your WiFi signal inside
                                the house, or to other buildings, once Starlink is installed.</span></li>
                        <li class="flex items-start"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg><span class="text-slate-600 text-sm">Where you are located — such as near the coastline
                                where corrosion is a major factor, or in a high wind area.</span></li>
                    </ul>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed mb-4">Yes, in most circumstances the Starlink
                        satellite is
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed mb-4">If the dish is unable to be mounted on your roof
                        for
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed mb-4">The following types of mounts are some examples
                        of those used for Starlink Installations:</p>
                    <div class="flex flex-wrap gap-2">
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Tin Roof
                            Mount</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Gutter
                            Mount</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Tile/Flashing
                            Mount</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Universal Wall
                            Mounting</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Bespoke /
                            Guy-Masted Pole (3m+)</span>
                    </div>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">There are outdoor WiFi Access Points along with Point
                        to
                        Point (PtP) and Point to Multiple Point (PtMP) systems available. You can chat with your
                        installation
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed mb-4">We suggest you do some research to ensure that
                        the
