...
<section class="relative bg-gradient-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
  <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
    <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
      ...
      <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Australia's National Broadband Network delivers high-speed internet to businesses across the country. Choose the right plan for your needs.</p>
    </div>
    <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
      <img alt="NBN Services" loading="lazy" class="rounded-lg" src="/images/internet/nbn.png"/>
    </div>
  </div>
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16 reveal reveal-fade-up">
      ...
      <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Choose the right speed tier for your business requirements.</p>
    </div>
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed mb-6">Perfect for small businesses with basic internet needs, email, and light browsing.</p>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-lg border-2 border-brand-blue relative hover:shadow-xl transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed mb-6">Ideal for growing businesses with multiple users and video conferencing needs.</p>
        <ul class="space-y-2 text-sm text-slate-600">
          <li class="flex items-center">
            <svg class="w-4 h-4 text-brand-blue mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
            5-10 users
          </li>
          <li class="flex items-center">
            <svg class="w-4 h-4 text-brand-blue mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed mb-6">High-speed connection for businesses with heavy data usage and multiple concurrent users.</p>
        <ul class="space-y-2 text-sm text-slate-600">
          <li class="flex items-center">
            <svg class="w-4 h-4 text-brand-blue mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
            10-20 users
