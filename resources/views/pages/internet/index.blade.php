...
@section('content')
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Business Internet and
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img src="/images/internet/hero.png" alt="BG Image" height="400" width="600"
                ...
                @php
                    $internetCards = [
                        [
                            'title' => 'NBN',
                            'desc' =>
                                'Total Solutions IT delivers the National Broadband Network (NBN) to industry quality commercial and premises.',
                            'img' => '/images/internet/nbn.jpg',
                        ],
                        [
                            'title' => '4G/5G backup',
                            'desc' =>
                                'Ensure you stay connected in the event of an infrastructure issue to give you peace of mind with 4G/5G backup.',
                            'img' => '/images/internet/backup.png',
                        ],
                        [
                            'title' => 'Cel-Fi (4G/5G Boosters)',
                            'desc' =>
                                'A smart antenna on the roof communicates with the mobile tower to amplify the signal to a building.',
                            'img' => '/images/internet/celfi.png',
                        ],
                        [
                            'title' => 'Starlink',
                            'desc' =>
                                'Starlink is a satellite internet from Low Earth Orbit satellite globally by SpaceX, delivering global broadband coverage.',
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div
                ...
                <p class="text-slate-600 mb-6 leading-relaxed">In today's digital landscape, a fast and reliable internet
                    connection is crucial for the success of any business. We provide comprehensive Business Internet and
                    Voice solutions designed to keep your operations running smoothly, ensuring you stay connected with
                    clients, colleagues, and partners. Our services offer the speed, reliability, and flexibility your
                    business needs to excel in a competitive environment.</p>
            </div>
            <div class="order-1 lg:order-2 w-full rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
                <img src="/images/internet/voip.jfif" alt="Connectivity and communication"
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div>
                <img src="/images/internet/section.png" alt="Working seamlessly online" height="400" width="400"
                    class="object-cover" />
            </div>
            <div
                class="bg-white p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all relative">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                ...
                <p class="text-slate-600 mb-6 leading-relaxed">With a focus on customer satisfaction, our local support
                    team is readily available to assist you, offering a personalized touch to your internet experience.</p>
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div
                class="order-2 lg:order-1 bg-white p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-blue-100 hover:border-blue-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all relative">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <h2 class="text-3xl font-bold text-blue-900 mb-6 mt-2">Let us keep you <br class="hidden lg:block" />
                    connected.</h2>
                <div class="space-y-8">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-600 leading-relaxed">We ensure that our services contribute positively to
                                the well-being and connectivity of the community we serve.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="order-1 lg:order-2 w-full rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
                <img src="/images/internet/connected.png" alt="Connectivity and communication"
                    class="w-full h-auto object-cover rounded-2xl" />
            </div>
        </div>
    </section>
