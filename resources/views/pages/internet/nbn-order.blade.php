...
<section class="relative bg-gradient-to-br from-hero-gradient to-white pt-28 pb-20 lg:pt-36 lg:pb-28 overflow-hidden">
  <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
    <div class="space-y-6">
      ...
      <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Order Your NBN</h1>
      <p class="text-lg md:text-xl text-slate-700 leading-relaxed">Order your NBN connection quickly and easily with Bismillah Computer & Technology.</p>
    </div>
    <div class="flex justify-center lg:justify-end">
      <img alt="Order NBN" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full" src="/images/internet/hero.png"/>
    </div>
  </div>
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16 reveal reveal-fade-up">
      ...
      <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">We make getting connected simple. Our team handles everything from checking eligibility to installation and activation.</p>
    </div>
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow text-center">
        ...
        <p class="text-slate-600 leading-relaxed">Enter your address to check which NBN technology is available at your premises and find the best plans.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow text-center" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Select from a range of NBN plans with different speeds and data options to suit your needs and budget.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow text-center" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed">We arrange the installation and get you online. Most connections are activated within 5-10 business days.</p>
      </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="reveal reveal-fade-up flex items-start gap-4 p-6 rounded-2xl bg-slate-50">
        <div class="w-12 h-12 bg-brand-green/10 rounded-xl flex items-center justify-center flex-shrink-0">
          <svg class="w-6 h-6 text-brand-green" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
        </div>
        <div>
          <h4 class="font-bold text-slate-900 mb-1">Free Eligibility Check</h4>
          <p class="text-slate-600 text-sm">We check your address at no cost to confirm what NBN technology is available.</p>
        </div>
      </div>

      <div class="reveal reveal-fade-up flex items-start gap-4 p-6 rounded-2xl bg-slate-50" style="animation-delay: 0.1s">
        <div class="w-12 h-12 bg-brand-green/10 rounded-xl flex items-center justify-center flex-shrink-0">
          <svg class="w-6 h-6 text-brand-green" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
        </div>
        <div>
          <h4 class="font-bold text-slate-900 mb-1">No Activation Fees</h4>
          <p class="text-slate-600 text-sm">We waive the standard activation fee for new NBN connections ordered through us.</p>
        </div>
      </div>

      <div class="reveal reveal-fade-up flex items-start gap-4 p-6 rounded-2xl bg-slate-50" style="animation-delay: 0.2s">
        <div class="w-12 h-12 bg-brand-green/10 rounded-xl flex items-center justify-center flex-shrink-0">
          <svg class="w-6 h-6 text-brand-green" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
        </div>
        <div>
          <h4 class="font-bold text-slate-900 mb-1">Free Modem</h4>
          <p class="text-slate-600 text-sm">Receive a free modem with your plan, just return it if you cancel your service.</p>
        </div>
      </div>
      ...
      <div class="reveal reveal-fade-up flex items-start gap-4 p-6 rounded-2xl bg-slate-50">
        ...
        <div>
          ...
          <p class="text-slate-600 text-sm">Our team helps you choose the right plan and manages the entire connection process.</p>
        </div>
      </div>
      ...
      <div class="reveal reveal-fade-up flex items-start gap-4 p-6 rounded-2xl bg-slate-50" style="animation-delay: 0.1s">
        ...
        <div>
          ...
          <p class="text-slate-600 text-sm">Most new connections are activated within 5-10 business days of ordering.</p>
        </div>
      </div>
      ...
      <div class="reveal reveal-fade-up flex items-start gap-4 p-6 rounded-2xl bg-slate-50" style="animation-delay: 0.2s">
        ...
        <div>
          ...
          <p class="text-slate-600 text-sm">Australian-based support available 7 days a week for any issues after connection.</p>
        </div>
      </div>
