...
@section('content')
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8 max-w-356 mx-auto">
        <div class="reveal reveal-fade-up">
            ...
            <p class="text-slate-600 max-w-3xl mx-auto mb-12 text-justify">Supporting configurations that are
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                {{-- Keep connected --}}
                <div
                    class="border-2 rounded-2xl p-8 relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
        ...
        <div class="reveal reveal-fade-up max-w-356 mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Powertec specialises in the development of creative
                        and
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="flex justify-center pb-4 text-blue-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-satellite-dish">
                    ...
                    <p class="text-center text-blue-600 text-xs font-semibold uppercase tracking-wider mb-4">Powered by
                        Powertec</p>
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">More power — the unit has an output power of +20 dBm, an
                            increase from +16 dBm with the previous GO models. That's an incredible 250% increase in output
                            power.</span></div>
                    <a href="https://totalsolutionsit.com/wp-content/uploads/2024/03/CEL-FI-GO-4-Flyer.pdf"
                ...
                <div
                    ...
                    <div class="flex justify-center pb-4 text-blue-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-signal">
                            <path d="M2 20h.01" />
                            <path d="M7 20v-4" />
                            <path d="M12 20v-8" />
                            <path d="M17 20V8" />
                    ...
                    <p class="text-center text-blue-600 text-xs font-semibold uppercase tracking-wider mb-4">Powered by
                        Powertec</p>
                    <p class="text-slate-600 text-sm text-justify leading-relaxed mb-4">Experience unmatched 5G
                        connectivity
                        with the Nextivity GO G51 Stationary Repeater! Boost both 4G and 5G signals indoors with up to 100
                        dB
                        signal gain.</p>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Incredible coverage and carrier switching — covers up to
                            3000 m2.</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Better, faster, stronger — powered by the 4th generation
                            IntelliBoost chip.</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Ideal mobile signal boosting — large homes, commercial
                            buildings, government, medical, nursing, underground parking, warehousing and more!</span></div>
                    <div class="mt-2 flex flex-wrap gap-2">
                        <a href="https://totalsolutionsit.com/wp-content/uploads/2024/03/GOG51_datasheet.pdf"
                            target="_blank" rel="noopener"
                        ...
                        <a href="https://totalsolutionsit.com/wp-content/uploads/2024/03/GOG51_qsg.pdf" target="_blank"
                            rel="noopener"
                            class="inline-flex items-center px-5 py-2.5 text-sm font-semibold rounded-xl shadow-sm transition-all bg-blue-50 text-blue-700 hover:bg-navy hover:text-white">
                            Quick Start
                            <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <div
                    ...
                    <div class="flex justify-center pb-4 text-blue-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-car">
                            <path
                    ...
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            ...
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Extend your coverage — improve 3G, 4G, and 5G DSS in
                            your car, boat, fleet or any roaming vehicle.</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg><span class="text-slate-600 text-sm">Carrier switching — select which operator signal to
                            boost and change anytime via the WAVE App.</span></div>
                    <div class="flex items-start mb-3"><svg class="w-5 h-5 mr-2 mt-0.5 text-blue-500 shrink-0"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    ...
                    <a href="https://totalsolutionsit.com/wp-content/uploads/2024/03/CELFI-ROAM-R41Brochure-1.pdf"
                        target="_blank" rel="noopener"
                        class="mt-2 inline-flex items-center px-5 py-2.5 text-sm font-semibold rounded-xl shadow-sm transition-all bg-blue-50 text-blue-700 hover:bg-navy hover:text-white">
                        Download Brochure
                        <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
