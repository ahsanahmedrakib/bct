    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
        ...
        <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
            <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
                ...
                <span class="text-blue-600 block mt-2">Clinics &amp; Animal Hospitals</span>
            </h1>
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">IT services for
                veterinary practices have transformed animal healthcare, providing innovative solutions that enhance
                patient care, streamline clinic administration, and ensure robust security and compliance.</p>
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed mt-2">From practice
                management software such as RxWorks and ezyVet, to secure data storage and backup, we deliver the
                reliable technology your clinic depends on.</p>

            {{-- Support Link --}}
            <div class="pt-6 border-t border-slate-200/60 flex flex-col items-start gap-3">
                <p class="text-sky-700 font-semibold text-sm">Need help with IT for your veterinary practice?</p>
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Delivering specialized IT support for veterinary
            practices by ensuring secure patient records, reliable clinical systems and compliant operations.</p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Our I.T support is laser-focused on security,
                    implementing advanced measures to protect sensitive patient records with continuous monitoring,
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <div class="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-5">
                    <svg class="w-7 h-7 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
                </div>
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Uninterrupted 24/7 IT support ensures seamless
                    operations for veterinary practices, providing round-the-clock assistance whenever it's needed.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">We bring proven track record in delivering reliable and
                    secure IT solutions to veterinary practices.</p>
            </div>
...
<section class="py-16 lg:py-24 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Our services cover the full range of outsourced IT
            services for veterinary practices. Here are just a few examples of how you'll benefit from working with us.</p>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">Some of our veterinary clients work
                    extended hours caring for animals. They simply can't wait if there's a tech issue. We provide
                    flexible options for out-of-hours support. And you'll always have direct and instant access to our
                    Australian-based frontline support desk – where you get to set the urgency that our team responds to
                    an issue.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">From appointment scheduling to patient
                    records and billing, we get to know your clinic workflows and business needs. That ensures we act
                    appropriately at each and every step of your IT journey, from planning to tech problems to day-to-day
                    support.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">Our security solutions protect you against
                    hacking, malware, data breaches – and downtime. We have deep understanding of the security and
                    privacy requirements for handling patient records.</p>
            </div>

            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <h3 class="text-lg font-bold text-slate-900 mb-3">No surprises with fixed cost IT</h3>
                <p class="text-slate-600 text-sm text-justify leading-relaxed">We know you need to manage your budget, so
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">From purchasing, provisioning, using,
                    maintenance and disposal, we make sure your IT assets are efficient and effective so your clinical
                    team can focus on animal care.</p>
            </div>
...
<section class="py-20 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">We specialise in supporting the practice
                management and clinical software trusted by veterinary clinics across Australia, ensuring your systems
                run reliably, securely and stay compliant.</p>
            <div class="flex flex-wrap gap-2 mb-6">
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">RxWorks experience</span>
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">ezyVet experience</span>
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Vet-link experience</span>
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">SmartVet experience</span>
            </div>
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">From patient records and appointment scheduling to
                billing and secure data storage, our specialists keep your veterinary software connected, current and
                protected so your team can deliver outstanding animal care without interruption.</p>
            <a href="{{ route('contact') }}"
