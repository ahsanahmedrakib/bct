    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Our services cover the full range of outsourced IT
                services for veterinary practices. Here are just a few examples of how you'll benefit from working with us.
            </p>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">From appointment scheduling to patient
                        ...
                        appropriately at each and every step of your IT journey, from planning to tech problems to
                        day-to-day
                        support.</p>
                </div>
            ...
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We specialise in supporting the practice
                        management and clinical software trusted by veterinary clinics across Australia, ensuring your
                        systems
                        run reliably, securely and stay compliant.</p>
                    <div class="flex flex-wrap gap-2 mb-6">
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">RxWorks
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">ezyVet
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Vet-link
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">SmartVet
                            experience</span>
                    </div>
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">From patient records and appointment
                        scheduling
                        to
                        billing and secure data storage, our specialists keep your veterinary software connected, current
                        and
