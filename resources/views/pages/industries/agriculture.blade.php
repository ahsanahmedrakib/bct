        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Our I.T support is laser-focused on security,
                    implementing advanced measures to protect your data with continuous monitoring, updates, and rigorous
                    access controls.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Uninterrupted 24/7 IT support ensures seamless
                    operations for the agriculture industry, providing round-the-clock assistance whenever it's needed.</p>
            </div>
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">Some of our agriculture clients work around
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">From feed mills to freezer technology, we
                    ...
                    and every step of your IT journey, from planning, to tech problems, to day-to-day support. It's about
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">We offer ongoing technical assistance and training
                to ensure smooth integration and utilization of IT tools. By leveraging our expertise in IT support, we
            ...
            <div class="flex flex-wrap gap-2 mb-6">
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Previous agriculture and farming operations experience</span>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">Cybersecurity is crucial in protecting sensitive
                information related to crop research and proprietary technologies. We provide robust security protocols,
