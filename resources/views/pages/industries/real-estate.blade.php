    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/industries/real-state-hero.png"
                ...
                <div
                    ...
                    <div class="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-5">
                        <svg class="w-7 h-7 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M9.75 3v6m-3-3h6m2.25 15 4.5-1.5-1.5-4.5-5.25 5.25a2.25 2.25 0 0 1-3-3L19.5 8.25a2.25 2.25 0 0 1 3.18-3.18l-3.18 3.18 3 3 3-3a2.25 2.25 0 0 1 0 0l-3.18 3.18 3 3 3-3a2.25 2.25 0 0 1-3 3z" />
                        </svg>
                    </div>
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Our services cover the full range of outsourced IT
                services for real estate agencies. Here are just a few examples of how you'll benefit from working with us.
            </p>
        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We specialise in supporting the property
                        management
                    ...
                    <div class="flex flex-wrap gap-2 mb-6">
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">PropertyMe
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Console Cloud
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Property Tree
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">REST / Agentbox
                            experience</span>
                    </div>
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">From trust accounting and property
                        management
                        to
                        listing and inspection platforms, our specialists keep your real estate software connected, current
                        and
