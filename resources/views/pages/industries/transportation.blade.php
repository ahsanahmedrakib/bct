    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
        ...
        <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
            <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
                ...
                <span class="text-blue-600 block mt-2">Freight, Logistics &amp; Fleet</span>
            </h1>
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">IT services for
                transportation and logistics have transformed the industry, offering advanced solutions to boost
                efficiency, reliability, and visibility across the supply chain. Services include fleet tracking,
                route optimisation, warehouse management systems and real-time shipment monitoring.</p>
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed mt-2">By leveraging
                cloud-based platforms and mobile applications, operators can access critical information anytime,
                anywhere, streamlining operations and reducing costs.</p>

            {{-- Support Link --}}
            <div class="pt-6 border-t border-slate-200/60 flex flex-col items-start gap-3">
                <p class="text-sky-700 font-semibold text-sm">Need help with IT for your transportation business?</p>
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Delivering specialized IT support for transportation
            and logistics by streamlining operations, enhancing fleet visibility, and ensuring reliable service.</p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Our I.T support is laser-focused on security,
                    implementing advanced measures to protect your operational data with continuous monitoring, updates,
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Uninterrupted 24/7 IT support ensures seamless
                    operations for the transport industry, providing round-the-clock assistance whenever it's needed.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">We bring proven track record in delivering reliable IT
                    solutions that keep transport and logistics operations moving.</p>
            </div>
...
<section class="py-16 lg:py-24 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Our services cover the full range of outsourced IT
            services for transport and logistics businesses. Here are just a few examples of how you'll benefit from
            working with us.</p>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">Some of our transport clients operate
                    around the clock to keep goods moving. They simply can't wait if there's a tech issue. We provide
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">From dispatch systems to warehouse
                    management and fleet telematics, we get to know your operations and your business needs. That ensures
                    we act appropriately at each and every step of your IT journey, from planning, to tech problems, to
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">Our security solutions protect you against
                    ...
                    involved in the transport and logistics industry.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">From purchasing, provisioning, using,
                    maintenance and disposal, we make sure your IT assets are efficient and effective, so your fleet and
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">We offer ongoing technical assistance and training
                to ensure smooth integration and utilization of IT tools across your transport network. By leveraging our
                expertise in IT support, we empower operators to maximize efficiency, maintain visibility, and deliver
                reliable service.</p>
            <div class="flex flex-wrap gap-2 mb-6">
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Fleet management experience</span>
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Warehouse &amp; logistics systems</span>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">We understand the critical role reliability plays
                in the efficiency of your transport services. Our team is committed to ensuring the security and seamless
                functionality of your IT infrastructure, contributing to the efficiency and safety of your operations
                around the clock.</p>
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">Cybersecurity is crucial in protecting sensitive
                information related to shipments and logistics. We provide robust security protocols, regular audits, and
                continuous monitoring to safeguard against cyber threats.</p>
            <a href="{{ route('contact') }}"
