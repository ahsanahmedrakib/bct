...
@section('content')
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/industries/transport-hero.png"
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Delivering specialized IT support for
                transportation
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Uninterrupted 24/7 IT support ensures seamless
                        operations for the transport industry, providing round-the-clock assistance whenever it's needed.
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">From dispatch systems to warehouse
                        management and fleet telematics, we get to know your operations and your business needs. That
                        ensures
            ...
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We offer ongoing technical assistance and
                        training
                        to ensure smooth integration and utilization of IT tools across your transport network. By
                        leveraging
                        our
                        expertise in IT support, we empower operators to maximize efficiency, maintain visibility, and
                        deliver
                        reliable service.</p>
                    <div class="flex flex-wrap gap-2 mb-6">
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Fleet
                            management
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Warehouse &amp;
                            logistics systems</span>
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We understand the critical role reliability
                        plays
                        in the efficiency of your transport services. Our team is committed to ensuring the security and
                        seamless
                        functionality of your IT infrastructure, contributing to the efficiency and safety of your
                        operations
                        around the clock.</p>
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">Cybersecurity is crucial in protecting
                        sensitive
                        information related to shipments and logistics. We provide robust security protocols, regular
                        audits,
                        and
