        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">We understand the demanding technology needs of
                        design,
            ...
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <div class="flex flex-wrap gap-2 mb-6">
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">CAD &amp; BIM
                            workstation support</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Document
                            control
                            experience</span>
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We understand the critical role reliability
                        plays
                        in the smooth running of your engineering projects. Our team is committed to ensuring the security
                        and
