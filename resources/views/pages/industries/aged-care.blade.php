...
<section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
        ...
        <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
            ...
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">IT support for aged care
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">We understand the unique technology and regulatory needs
...
<section class="py-16 lg:py-24 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Our services cover the full range of outsourced IT
            services for aged care providers. Here are just a few examples of how you'll benefit from working with us.</p>
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">We offer ongoing technical assistance and training
                to ensure smooth integration and utilization of IT tools within your care environment. By leveraging our
                expertise in IT support, we empower providers to deliver efficient, safe and compliant care.</p>
            <div class="flex flex-wrap gap-2 mb-6">
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Aged care software experience</span>
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Compliance &amp; reporting support</span>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">Cybersecurity is crucial in protecting sensitive
                resident and health information. We provide robust security protocols, regular audits, and continuous
