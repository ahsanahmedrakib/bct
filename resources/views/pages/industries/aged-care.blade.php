...
@section('content')
        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
                    IT for Aged Care
                    <span class="text-blue-600 block mt-2">Community &amp; Residential Care</span>
                </h1>
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">IT support for aged
                    care
                    providers ensures reliable technology that helps you deliver person-centred care while meeting stringent
                    regulatory and data security requirements.</p>
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed mt-2">We help community
                    and residential aged care organisations manage their clinical systems, resident records and
                    communications securely, so your team can focus on the wellbeing of your residents.</p>

                {{-- Support Link --}}
                <div class="pt-6 border-t border-slate-200/60 flex flex-col items-start gap-3">
                    <p class="text-sky-700 font-semibold text-sm">Need help with IT for your aged care facility?</p>
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/industries/hero.png" class="rounded-lg w-full max-w-md lg:max-w-lg" />
            </div>
        </div>
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Delivering specialized IT support for aged care
                organisations by ensuring reliable systems, secure resident data and compliant operations.</p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Our I.T support is laser-focused on security,
                        implementing advanced measures to protect sensitive resident data with continuous monitoring,
                ...
                <div
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Aged care expertise.</h3>
                    <p class="text-slate-600 text-sm leading-relaxed">We understand the unique technology and regulatory
                        needs
                        of aged care providers, from clinical records to compliance reporting.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">We bring proven track record in delivering reliable,
                        compliant IT solutions to aged care organisations.</p>
                </div>
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Our services cover the full range of outsourced IT
                services for aged care providers. Here are just a few examples of how you'll benefit from working with us.
            </p>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">Aged care is a round-the-clock operation
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">From clinical management systems to
                        resident communication and check-in technologies, we get to know your operations and business needs.
                        That ensures we act appropriately at each and every step of your IT journey.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">Our security solutions protect you
                        ...
                        privacy requirements for aged care providers.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">From purchasing, provisioning, using,
                        maintenance and disposal, we make sure your IT assets are efficient and effective so your care team
                        can stay focused on residents.</p>
                </div>
            ...
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We offer ongoing technical assistance and
                        training
                        to ensure smooth integration and utilization of IT tools within your care environment. By leveraging
                        our
                        expertise in IT support, we empower providers to deliver efficient, safe and compliant care.</p>
                    <div class="flex flex-wrap gap-2 mb-6">
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Aged care
                            software
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Compliance
                            &amp;
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We understand the critical role reliability
                        plays
                        in the smooth running of your aged care services. Our team is committed to ensuring the security and
                        seamless functionality of your IT infrastructure, contributing to the efficiency and safety of your
                        operations around the clock.</p>
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">Cybersecurity is crucial in protecting
                        sensitive
                        resident and health information. We provide robust security protocols, regular audits, and
                        continuous
