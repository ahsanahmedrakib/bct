    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/industries/medical-hero.png"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Our I.T support is laser-focused on security,
                        implementing advanced measures to protect sensitive patient data with continuous monitoring,
                        updates,
        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div class="order-1 lg:order-2">
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We specialise in supporting the clinical
                        and
                        practice management software trusted by medical practices across Australia, ensuring your systems
                        run
                        reliably, securely and stay compliant.</p>
                    <div class="flex flex-wrap gap-2 mb-6">
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Best Practice
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">MedicalDirector
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Genie Solutions
                            experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Ninja Practice
                            experience</span>
                    </div>
