    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32 overflow-hidden">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 md:w-3/4 w-full">
                    @foreach ($actionButtons ?? ['Healthcare', 'Construction', 'Logistics', 'Accounting'] as $button)
                        <a href="#industries"
                            class="group flex cursor-pointer items-center justify-between px-6 py-4 text-white text-sm font-semibold rounded-xl shadow-md transition-all bg-navy hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg">{{ $button }}
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img src="{{ $heroImage ?? '/images/industries/hero.png' }}" alt="Industry-Specific IT Solutions"
                ...
                @php
                    $industries = [
                        [
                            ...
                            'image' => '/images/industries/industry-1.png',
                            'description' =>
                        ...
                        [
                            ...
                            'image' => '/images/industries/industry-2.png',
                            'description' =>
                        ...
                        [
                            ...
                            'image' => '/images/industries/industry-3.png',
                            'description' =>
                        ...
                        [
                            ...
                            'image' => '/images/industries/industry-4.png',
                            'description' =>
                        ...
                        [
                            ...
                            'image' => '/images/industries/industry-5.png',
                            'description' =>
                        ...
                        [
                            ...
                            'image' => '/images/industries/industry-8.png',
                            'description' =>
                        ...
                        [
                            ...
                            'image' => '/images/industries/industry-9.png',
                            'description' =>
                        ...
                        [
                            ...
                            'image' => '/images/industries/industry-10.png',
                            'description' =>
