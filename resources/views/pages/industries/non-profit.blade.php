    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
        ...
        <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
            <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
                IT for Non-Profit
                <span class="text-blue-600 block mt-2">Charities, NFP &amp; Community Organisations</span>
            </h1>
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">IT services for
                non-profit organisations help charities and community groups work more efficiently, securely and
                responsibly, so more resources can go towards delivering their mission.</p>
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed mt-2">From fundraising and
                donor management to membership and volunteer coordination, we deliver reliable technology that supports
                your important work.</p>

            {{-- Support Link --}}
            <div class="pt-6 border-t border-slate-200/60 flex flex-col items-start gap-3">
                <p class="text-sky-700 font-semibold text-sm">Need help with IT for your non-profit organisation?</p>
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Delivering specialized IT support for non-profit
            organisations by ensuring reliable systems, secure supporter data and cost-effective operations.</p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Our I.T support is laser-focused on security,
                    implementing advanced measures to protect your supporter and donor data with continuous monitoring,
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <div class="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-5">
                    <svg class="w-7 h-7 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19 14v3a4 4 0 0 1-4 4H9a4 4 0 0 1-4-4v-6a4 4 0 0 1 4-4h6a4 4 0 0 1 4 4v3M10 6v6a3 3 0 1 1-3-3m3 0h10"/></svg>
                </div>
                <h3 class="text-xl font-bold text-slate-900 mb-3">Non-profit expertise.</h3>
                <p class="text-slate-600 text-sm leading-relaxed">We understand the unique technology and budget needs of
                    charities and community organisations, helping you do more with less.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">We bring proven track record in delivering reliable,
                    cost-effective IT solutions to non-profit organisations.</p>
            </div>
...
<section class="py-16 lg:py-24 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Our services cover the full range of outsourced IT
            services for non-profit organisations. Here are just a few examples of how you'll benefit from working with
            us.</p>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">Non-profit teams often work across many
                    locations and hours, and can't wait if there's a tech issue. We provide flexible options for
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">From donor management and fundraising to
                    membership and volunteer coordination, we get to know your workflows and business needs. That ensures
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">Our security solutions protect you against
                    ...
                    involved in handling supporter and donor data.</p>
            </div>

            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <h3 class="text-lg font-bold text-slate-900 mb-3">No surprises with fixed cost IT</h3>
                <p class="text-slate-600 text-sm text-justify leading-relaxed">We know you need to manage your budget
                    carefully, so we make your IT investment fixed and predictable. Combined with no lock-in contracts,
                    you also gain complete freedom.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">From purchasing, provisioning, using,
                    maintenance and disposal, we make sure your IT assets are efficient and effective so more of your
                    resources go towards your mission.</p>
            </div>
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">We offer ongoing technical assistance and training
                to ensure smooth integration and utilization of IT tools across your organisation. By leveraging our
                expertise in IT support, we empower non-profits to operate efficiently and focus on their mission.</p>
            <div class="flex flex-wrap gap-2 mb-6">
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Donor &amp; CRM software experience</span>
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Fundraising platform support</span>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">We understand the critical role reliability plays
                in supporting the important work of non-profit organisations. Our team is committed to ensuring the
                security and seamless functionality of your IT infrastructure, contributing to the efficiency and safety
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">Cybersecurity is crucial in protecting sensitive
                supporter and donor information. We provide robust security protocols, regular audits, and continuous
                monitoring to safeguard against cyber threats.</p>
            <a href="{{ route('contact') }}"
