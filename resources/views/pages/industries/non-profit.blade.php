    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed mt-2">From fundraising
                    and
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/industries/non-profit-hero.png"
                ...
                <div
                    ...
                    <div class="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-5">
                        <svg class="w-7 h-7 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M19 14v3a4 4 0 0 1-4 4H9a4 4 0 0 1-4-4v-6a4 4 0 0 1 4-4h6a4 4 0 0 1 4 4v3M10 6v6a3 3 0 1 1-3-3m3 0h10" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Non-profit expertise.</h3>
                    <p class="text-slate-600 text-sm leading-relaxed">We understand the unique technology and budget needs
                        of
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">From donor management and fundraising to
                        membership and volunteer coordination, we get to know your workflows and business needs. That
                        ensures
            ...
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We offer ongoing technical assistance and
                        ...
                        expertise in IT support, we empower non-profits to operate efficiently and focus on their mission.
                    </p>
                    <div class="flex flex-wrap gap-2 mb-6">
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Donor &amp; CRM
                            software experience</span>
                        <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Fundraising
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">Cybersecurity is crucial in protecting
                        sensitive
                        supporter and donor information. We provide robust security protocols, regular audits, and
                        continuous
