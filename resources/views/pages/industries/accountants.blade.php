            ...
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">We specialise in supporting the accounting,
                        practice management and tax software trusted by firms across Australia, ensuring your core
                        applications
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">From tax and practice management to
                        document
                        management, billing and payroll, our specialists keep your accounting software connected, current
                        and
