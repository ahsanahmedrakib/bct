                ...
                <div
                    ...
                    <div class="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-5">
                        <svg class="w-7 h-7 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0 0a8.949 8.949 0 0 0 4.95-1.501A4.5 4.5 0 0 0 12 14.25M3.3 8.25h4.2a4.5 4.5 0 0 1 4.5 4.5" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Expertise in professional services.</h3>
                    <p class="text-slate-600 text-sm leading-relaxed">We have deep experience supporting law firms,
                        accounting
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm text-justify leading-relaxed">From your practice management software to
                        ...
                        day-to-day support. It's about having a partner who understands your industry, your business and
                        your
                        challenges.</p>
                </div>
