    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
        ...
        <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
            <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
                ...
                <span class="text-blue-600 block mt-2">Law Firms, Accountants &amp; Advisors</span>
            </h1>
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">IT support for
                professional service firms ensures your technology works reliably, securely and efficiently, so your
                team can focus on delivering exceptional service to clients.</p>
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed mt-2">We understand the
                demands of legal, accounting and advisory practices, tailoring our managed IT services to keep your
                operations running smoothly and your sensitive data protected.</p>

            {{-- Support Link --}}
            <div class="pt-6 border-t border-slate-200/60 flex flex-col items-start gap-3">
                <p class="text-sky-700 font-semibold text-sm">Need help with IT for your professional services firm?</p>
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Delivering specialized IT support for legal,
            accounting and advisory firms through optimized technology, robust security and reliable operations.</p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Our I.T support is laser-focused on security,
                    implementing advanced measures to protect your confidential client data with continuous monitoring,
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <div class="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-5">
                    <svg class="w-7 h-7 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0 0a8.949 8.949 0 0 0 4.95-1.501A4.5 4.5 0 0 0 12 14.25M3.3 8.25h4.2a4.5 4.5 0 0 1 4.5 4.5"/></svg>
                </div>
                <h3 class="text-xl font-bold text-slate-900 mb-3">Expertise in professional services.</h3>
                <p class="text-slate-600 text-sm leading-relaxed">We have deep experience supporting law firms, accounting
                    practices and advisory businesses, understanding the specialised software and compliance demands of
                    your industry.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">We bring proven track record in delivering reliable and
                    efficient IT solutions to professional services firms.</p>
            </div>
...
<section class="py-16 lg:py-24 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Our services cover the full range of outsourced IT
            services for professional services firms. Here are just a few examples of how you'll benefit from working
            with us.</p>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">Some of our professional services clients
                    work around the clock serving their clientele. We provide flexible options for out-of-hours support.
                    And you'll always have direct and instant access to our Australian-based frontline support desk –
                    where you get to set the urgency that our team responds to an issue. We employ staff in multiple
                    locations including Yass, Wagga Wagga, Brisbane, Melbourne and Sydney.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">From your practice management software to
                    your file servers, we get to know your workflows and business needs. That ensures we act
                    appropriately at each and every step of your IT journey, from planning, to tech problems, to
                    day-to-day support. It's about having a partner who understands your industry, your business and your
                    challenges.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm text-justify leading-relaxed">Our security solutions protect you against
                    ...
                    involved in handling sensitive client information.</p>
            </div>
...
<section class="py-20 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">We specialise in supporting the software trusted by
                legal, accounting and advisory firms across Australia, ensuring your core applications run reliably and
                securely.</p>
            <div class="flex flex-wrap gap-2 mb-6">
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Smokeball experience</span>
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">LawVu experience</span>
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Xero &amp; MYOB experience</span>
                <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">BGL &amp; HandiSoft experience</span>
            </div>
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">From practice management and document management
