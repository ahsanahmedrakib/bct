        ...
        <div
            ...
            <div class="space-y-6">
                <span
                    ...
                    Systems</span>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Small
                    Business Phone Systems</h1>
                <p class="text-lg md:text-xl text-slate-700 leading-relaxed">Simple, affordable, and powerful phone systems
                    designed for businesses with 1-20 users. Get up and running in minutes, not days.</p>
            </div>
            <div class="flex justify-center lg:justify-end">
                <img alt="Small Business Phone Systems" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full"
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Professional communication without the complexity.
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Create a professional first impression with custom greetings
                        and menu options that route callers to the right department automatically.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Receive voicemails as audio attachments directly in your email
                        inbox. Never miss an important message, even when you're away from your desk.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Make and receive business calls from your mobile phone using
                        your business number. Stay connected wherever you go.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Track call volumes, wait times, and response rates with simple
                        dashboards. Understand your communication patterns and improve customer service.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Start with as few as 2 extensions and add more as your team
                        grows. No costly hardware upgrades required.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Enterprise-grade features at small business prices.
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="reveal reveal-fade-up">
                    ...
                    <p class="text-slate-600 leading-relaxed mb-8">We understand that small businesses need reliable
                        communication solutions that don't break the bank. Our phone systems are designed to give you a
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600">Get your phone system running in under 24 hours with our guided
                                    setup process.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600">Cloud-managed system means no expensive on-site equipment to
                                    maintain.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600">Desktop and mobile apps keep your team connected whether they're
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600">Based in Bangladesh with dedicated local support whenever you
                                    need it.</p>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="reveal reveal-fade-up flex justify-center">
                    <img alt="Small Business Phone System Setup" loading="lazy"
                        class="rounded-2xl shadow-lg w-full max-w-lg" src="/images/voice/phone-systems.png" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Ideal for a wide range of small businesses looking
                    to professionalise their communications.</p>
            </div>
