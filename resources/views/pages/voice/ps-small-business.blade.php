...
<section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-20 lg:pt-32">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-lg md:text-xl text-slate-700 font-medium leading-relaxed mt-6 max-w-3xl">Cloud-based phone systems
            help small businesses reduce costs while improving flexibility.</p>
        <div class="mt-10 flex flex-wrap gap-4">
            <a href="{{ route('voice.ps-medium-business') }}" class="inline-flex px-6 py-2.5 bg-brand-blue text-white text-xs font-bold tracking-wider uppercase rounded-lg shadow-sm cursor-pointer transition-colors hover:bg-brand-active">Find Out More</a>
            <a href="{{ route('contact') }}" class="inline-flex px-6 py-2.5 bg-white border border-brand-active text-sky-700 text-xs font-bold tracking-wider uppercase rounded-lg shadow-sm hover:bg-navy-active hover:text-white transition-colors">Contact Us</a>
        </div>
    </div>
</section>
