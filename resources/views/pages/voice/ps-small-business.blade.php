...
@section('description', 'Cloud-based phone systems for small businesses reduce costs while improving flexibility. Auto attendants, call routing, voicemail to email, mobile apps and more.')
...
<section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
        <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
            ...
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Cloud-based phone systems
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 md:w-3/4 w-full">
                <a href="{{ route('voice.ps-medium-business') }}" class="group flex cursor-pointer items-center justify-between px-6 py-4 bg-navy text-white text-sm font-semibold rounded-xl shadow-md hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg transition-all">
                    FIND OUT MORE
                ...
                <a href="{{ route('contact') }}" class="group flex cursor-pointer items-center justify-between px-6 py-4 bg-navy text-white text-sm font-semibold rounded-xl shadow-md hover:bg-navy-active hover:-translate-y-0.5 hover:shadow-lg transition-all">
                    CONTACT US
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 text-sky-300 group-hover:translate-x-1 transition-transform"><path d="m9 18 6-6-6-6"></path></svg>
                </a>
            </div>
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify"><strong>Cloud-based phone systems</strong> are
                ...
                without the cost and complexity of traditional phone infrastructure. Instead of installing and maintaining
                expensive onsite PBX hardware, cloud phone systems operate over the internet using <strong>VoIP
                technology</strong>, making them more flexible and cost-effective. Businesses that have remote staff,
            ...
            <ul class="space-y-3 text-slate-600">
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Reducing upfront hardware costs</strong> – no expensive phone servers required</span></li>
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Lowering call charges</strong> with modern VoIP technology</span></li>
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Providing predictable monthly pricing</strong> for easier budgeting</span></li>
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Allowing easy scalability</strong> as staff are added or removed</span></li>
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Reducing maintenance costs</strong> through cloud-hosted infrastructure</span></li>
            </ul>
        ...
        <div class="grid lg:grid-cols-2 gap-8 items-center">
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border-blue-100">
                ...
                <p class="text-slate-600 leading-relaxed mb-6 text-justify"><strong>Cloud-based phone systems</strong>
                    provide <strong>small businesses</strong> with a modern, flexible way to manage communications without
                    the cost and complexity of traditional on-site phone systems. Instead of expensive PBX hardware, calls
            ...
            <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border-blue-100">
                ...
                <ul class="space-y-3 text-sm text-slate-600">
                    <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Lower upfront costs</strong> – No expensive phone system hardware or maintenance contracts</span></li>
                    <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Work from anywhere</strong> – Staff can make and receive calls from laptops, desk phones, or mobile apps</span></li>
                    <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Professional call handling</strong> – Features like <strong>auto attendants, call routing, and voicemail to email</strong></span></li>
                    <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Easy scalability</strong> – Quickly add or remove users as your business grows</span></li>
                    <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Business continuity</strong> – Calls can be redirected during outages or remote work situations</span></li>
                    <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span><strong>Advanced features</strong> – Integration with <strong>CRM systems, Microsoft Teams, and AI call analytics</strong></span></li>
                </ul>
                <p class="text-slate-600 text-sm leading-relaxed mt-6">For growing organisations, <strong>cloud
                    telephony</strong> delivers enterprise-level functionality while remaining simple and affordable to
                    manage.</p>
            </div>
        </div>
        <div class="mt-10 flex flex-wrap gap-4 justify-center">
            <a href="{{ route('voice.feature-microsoft-teams') }}" class="inline-flex px-6 py-2.5 bg-white border border-brand-active text-sky-700 text-xs font-bold tracking-wider uppercase rounded-lg shadow-sm hover:bg-navy-active hover:text-white transition-colors">Find Out More</a>
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-4">A <strong>cloud-based phone system</strong> provides
            <strong>small businesses</strong> with powerful communication features that were traditionally only available
            to large organisations. Because the system runs over the internet, businesses can access advanced tools
            without the need for expensive on-site phone infrastructure.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Send calls to the right person, department, or location.</p>
            </div>
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300 md:col-span-2 lg:col-span-3">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
        ...
        <p class="text-center text-slate-600 max-w-3xl mx-auto mt-10 text-justify">These features help <strong>small
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify"><strong>Bismillah Computer &amp;
                Technology</strong> provides reliable <strong>ongoing support for business phone systems</strong>, ensuring
                your communication platform continues to operate smoothly and efficiently. A dependable phone system is
                essential for daily operations, and our team is available to assist with system management, configuration
                changes, and troubleshooting when needed. We support businesses using modern <strong>VoIP and cloud-based
            ...
            <ul class="space-y-3 text-sm text-slate-600">
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span>Technical support and troubleshooting</span></li>
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span>User and extension management</span></li>
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span>Call routing and configuration updates</span></li>
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span>System monitoring and maintenance</span></li>
                <li class="flex items-start"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg><span>Advice on improving communication systems</span></li>
            </ul>
            <p class="text-slate-600 leading-relaxed mt-6 text-justify">With <strong>Bismillah Computer &amp; Technology
