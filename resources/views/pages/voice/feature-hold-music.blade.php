    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Make the most of every
                    phone
                    call by transforming waiting times into valuable customer interactions with custom, professionally
                    produced
                    hold messages.</p>
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/voice/features/music/hero.png"
        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Expertly crafted messages that keep callers informed
                        and
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Engaging, legally compliant music so your messages
                        sound
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            <div
                ...
                <a href="{{ route('contact') }}"
                    class="inline-flex px-6 py-2.5 bg-brand-blue text-white text-xs font-bold tracking-wider uppercase rounded-lg shadow-sm cursor-pointer transition-colors hover:bg-brand-active">Request
                    a Custom Demo</a>
            </div>
        </div>
    </section>
