...
<section class="relative bg-gradient-to-br from-hero-gradient to-white pt-28 pb-20 lg:pt-36 lg:pb-28 overflow-hidden">
  <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
    <div class="space-y-6">
      ...
      <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Hold Music & Messaging</h1>
      <p class="text-lg md:text-xl text-slate-700 leading-relaxed">Turn hold time into opportunity with professional music and custom messages that keep callers engaged and informed.</p>
    </div>
    <div class="flex justify-center lg:justify-end">
      <img alt="Hold Music and Messaging" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full" src="/images/voice/hero.png"/>
    </div>
  </div>
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16 reveal reveal-fade-up">
      ...
      <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Don't let callers hang up in frustration. Use hold time to promote your business, share important information, and keep callers engaged.</p>
    </div>
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed">Choose from a curated library of royalty-free music tracks. Genre, tempo, and mood options to match your brand personality.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Record and upload custom messages about promotions, business hours, or important announcements. Rotate messages automatically.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed">Set different hold messages for business hours, holidays, and after-hours. Automatic switching based on your schedule.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed">Automatically inform callers of their queue position and estimated wait time. Reduces abandonment rates and improves satisfaction.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Use hold time to promote new products, services, or special offers. Turn waiting time into a marketing opportunity.</p>
      </div>

      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        <div class="w-14 h-14 bg-brand-blue/10 rounded-xl flex items-center justify-center mb-6">
          <svg class="w-7 h-7 text-brand-blue" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h7.5m-7.5 3h7.5m-7.5 3h7.5m-9-6h.008v.008H10.5V6zm0 3h.008v.008H10.5V9zm0 3h.008v.008H10.5v-3zm0 3h.008v.008H10.5V15z" />
          </svg>
        </div>
        <h3 class="text-xl font-bold text-slate-900 mb-3">Multi-Language Support</h3>
        <p class="text-slate-600 leading-relaxed">Offer hold messages in multiple languages to serve your diverse customer base. Auto-detect caller language preference.</p>
      </div>
