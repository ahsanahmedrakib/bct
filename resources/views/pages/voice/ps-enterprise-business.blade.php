    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/voice/phone-systems/enterprise-business/hero.png"
        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            <div
                ...
                <p class="text-slate-600 leading-relaxed mb-10 text-justify max-w-4xl">Enterprise phone systems are advanced
                    telecommunication solutions designed to manage high call volumes, support numerous extensions, and
                    provide a
                    variety of features customized for large organizations. These systems can be implemented on-premises, in
                    the
                    cloud, or as a hybrid solution, blending the advantages of both approaches.</p>
                <div class="flex justify-center">
                    <img alt="BG Image" src="/images/voice/phone-systems/enterprise-business/section.jpg"
        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">With on-premises systems, businesses can implement
                        their
        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">We recognize that every business is unique. Our
                        solutions
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Our dedicated support team is always on hand to assist
                        with installation, maintenance, and any technical issues, ensuring your system operates seamlessly.
                    </p>
                </div>
                <div
                    class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">We stay at the forefront of technological advancements
                        to
