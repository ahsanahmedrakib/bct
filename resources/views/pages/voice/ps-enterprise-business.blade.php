        ...
        <div
            ...
            <div class="space-y-6">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
                    Enterprise Phone Systems</h1>
                <p class="text-lg md:text-xl text-slate-700 leading-relaxed">Enterprise-grade unified communications for
                    large organisations with 100+ users, multi-site deployments, and mission-critical requirements.</p>
            </div>
            <div class="flex justify-center lg:justify-end">
                <img alt="Enterprise Phone Systems" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full"
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Reliable, secure, and highly available phone
                    systems built for organisations that can't afford downtime.</p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Connect offices across cities or countries under one unified
                        system. Centralised management with local failover for maximum reliability.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Redundant infrastructure, automatic failover, and 99.99%
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">End-to-end encryption, SSO integration, and compliance with
                        industry standards protect your communications.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Comprehensive reporting and business intelligence tools to
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Open APIs connect your phone system to ERP, CRM, and custom
                        business applications for seamless workflows.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Priority 24/7 support with a dedicated account manager and
                        guaranteed response times for mission-critical issues.</p>
                </div>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Choose the deployment model that fits your
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Fully managed cloud solution with no on-premise hardware.
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Full control with on-site PBX hardware. Ideal for
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Best of both worlds — keep critical infrastructure on-premise
                        while leveraging cloud features for flexibility and disaster recovery.</p>
                </div>
            </div>
        </div>
    </section>
