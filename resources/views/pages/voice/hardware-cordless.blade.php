...
@section('content')
        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Stay
                    connected anywhere in the office, warehouse or home. Our range of cordless phone solutions gives staff
                    the
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/voice/hardware/cordless/hero.png"
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            <div
                ...
                <p class="text-slate-600 leading-relaxed mb-4 text-justify">Analogue Extensions on your PABX system allows
                    for
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div
                ...
                <p class="text-slate-600 leading-relaxed mb-4 text-justify">DECT stands for <strong>Digital Enhanced
                        Cordless
                        Telecommunications</strong>. It is a wireless standard that is very often used for landline phones.
                    Wireless communication has been given a big boost thanks to the introduction of the wireless standard.
                </p>
                <p class="text-slate-700 font-medium leading-relaxed mb-4">Put simply:</p>
                <p class="text-slate-600 leading-relaxed mb-6 text-justify">DECT is to landline telephony what WiFi is to
                    the
                    Internet.</p>
                ...
                <p class="text-slate-600 leading-relaxed">Please check the page for your specific PABX system to view the
                    range
                    of DECT options available to you.</p>
            </div>
            <div class="w-full order-1 lg:order-2">
                <img src="/images/voice/hardware/cordless/section.png" alt="Section" class="w-full h-auto object-cover" />
            </div>
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">If you are after a short range solution that just
                needs to cover the office or home, then the Uniden XDECT range of cordless phone products will be suitable
                for
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div
                    ...
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div class="w-full">
                        <img src="/images/voice/hardware/cordless/3wpr.png" alt="Section"
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Introducing the Most Advanced Home Smart Phone System
                        in
                        the market. Sporting Bluetooth® connectivity with USB Charging Port. This new series from Uniden now
                        enables you to dial and receive mobile calls on the cordless handset for convenience and versatility
                        as
                ...
                <div
                    ...
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div class="w-full">
                        <img src="/images/voice/hardware/cordless/3wpr-1.png" alt="Section"
                            class="w-full h-auto object-cover" />
                    </div>
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-700 font-medium max-w-3xl mx-auto mb-12"><strong>Cordless communications for
                    every
                    business.</strong></p>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div
                    ...
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div class="w-full">
                        <img src="/images/voice/hardware/cordless/durafon.png" alt="Section"
                            class="w-full h-auto object-cover" />
                    </div>
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed mb-4">EnGenius Durafon is the cordless communications
                        tool
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Durafon provides mobility, flexibility and freedom.
                        Add
                        the many user-friendly convenience features and you have the ultimate in versatile, powerful
                        cordless
                ...
                <div
                    ...
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div class="w-full">
                        <img src="/images/voice/hardware/cordless/freestyl.png" alt="Section"
                            class="w-full h-auto object-cover" />
                    </div>
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed mb-4">EnGenius FreeStyl1 is the revolutionary cordless
                        ...
                        required.</p>
                    <p class="text-slate-600 text-sm leading-relaxed">EnGenius Durafon uses two-way radio technology to
                        cover
                        the extra distance needed for farms, factories, motels, resorts, caravan parks, nurseries,
                        hospitals;
                        even homes and offices. The more open the space, the greater the distance covered. A range of over
                        5km
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">A scalable 900 MHz Cordless Phone System with
                        ultra-long
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Crystal clear over long distances. Dual base system
                        with
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            <div
                ...
                <p class="text-slate-600 leading-relaxed mb-8 max-w-2xl mx-auto">Let us help you choose and set up the
                    right
