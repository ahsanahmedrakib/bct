...
@section('description',
    'Scalable phone systems for small, medium and enterprise businesses. VoIP, cloud and on-premise
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <ul class="space-y-3 mb-8 text-sm text-slate-600">
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 shrink-0" fill="none"
