...
@section('description', 'Scalable phone systems for small, medium and enterprise businesses. VoIP, cloud and on-premise
    PBX solutions with automatic call distributor, advanced voice mail, and more.')
...
@section('content')
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <div
                    class="w-full max-w-md lg:max-w-lg aspect-4/3 rounded-2xl border-2 border-dashed border-blue-200 bg-blue-50/40 flex items-center justify-center">
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Choose the right phone system for your business
                size
                and requirements.</p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">

                <div
                    class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300 flex flex-col">
                    ...
                    <ul class="space-y-3 mb-8 text-sm text-slate-600">
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Up to 20 extensions</li>
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Auto attendant</li>
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Voicemail to email</li>
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Mobile app integration</li>
                    </ul>
                    <a href="{{ route('voice.ps-small-business') }}"
                        class="mt-auto block w-full text-center bg-brand-blue text-white font-semibold py-3 rounded-xl hover:bg-brand-active transition-colors">Learn
                        More</a>
                </div>

                <div
                    class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-300 flex flex-col">
                    <div
                        class="absolute -top-3 left-1/2 -translate-x-1/2 bg-brand-blue text-white text-xs font-bold px-4 py-1 rounded-full">
                        Popular</div>
                    ...
                    <ul class="space-y-3 mb-8 text-sm text-slate-600">
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Up to 100 extensions</li>
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Call queues &amp; routing</li>
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>CRM integration</li>
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Call recording</li>
                    </ul>
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed mb-6">Enterprise-grade unified communications for
                        large
                        organisations with mission-critical and multi-site requirements.</p>
                    <ul class="space-y-3 mb-8 text-sm text-slate-600">
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0"
                                fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Unlimited extensions</li>
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0"
                                fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Multi-site support</li>
                        <li class="flex items-center"><svg class="w-5 h-5 text-blue-600 mr-3 flex-shrink-0"
                                fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    ...
                    <a href="{{ route('voice.ps-enterprise-business') }}"
                        class="mt-auto block w-full text-center bg-brand-blue text-white font-semibold py-3 rounded-xl hover:bg-brand-active transition-colors">Learn
                        More</a>
                </div>
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Modern phone systems come packed with the
                features
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Bring voice, video, messaging and collaboration
                        together
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Intelligently route incoming calls to the right
                        person or
                        team, every time.</p>
                </div>
                <div
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Host reliable audio and video conferences with your
                        team
                        and customers.</p>
                </div>
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Make and receive calls from your computer or mobile
                        app,
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <p class="text-slate-600 leading-relaxed mb-6 text-justify">We combine telecommunications and IT expertise
                    to
                    deploy the right phone system for your business, whether cloud-hosted, on-premise, or hybrid. From
                    assessment and planning to seamless migration and ongoing support, we are with you every step of the
                    way.</p>
                <p class="text-slate-600 leading-relaxed mb-6 text-justify">Our dedicated team provides 24/7 support,
                    number
        ...
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8">
            ...
            <div class="space-y-4">
                @php
                    $faqs = [
                        [
                            'q' => 'What types of phone systems do you offer?',
                            'a' =>
                                'We offer cloud-hosted (VoIP), on-premise, and hybrid phone systems to suit businesses of every size — from small business PBX to enterprise unified communications platforms.',
                        ],
                        [
                            'q' => 'Can I keep my existing phone numbers?',
                            'a' =>
                                'Yes. In most cases your numbers can be ported across to the new system with no disruption, so your business keeps working as usual.',
                        ],
                        [
                            'q' => 'How long does it take to set up a phone system?',
                            'a' =>
                                'Most small to medium business systems can be up and running within days. We handle configuration, device setup, and staff training to minimise downtime.',
                        ],
                    ];
                @endphp
                @foreach ($faqs as $faq)
