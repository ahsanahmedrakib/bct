    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Phone Systems
                </h1>
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Scalable IP phone
                    systems designed to meet the communication needs of businesses from small startups to large enterprises.
                </p>
            </div>
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="Phone Systems" loading="lazy" class="rounded-lg w-full max-w-md lg:max-w-lg" src="/images/voice/phone-systems.png" />
            </div>
        </div>
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Choose the right phone system for your business
                    size and requirements.</p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 mb-6 leading-relaxed">Simple, affordable phone systems for businesses with 1-20
                        users. Easy setup and management.</p>
                    ...
                    <a href="{{ route('contact') }}"
                        class="block w-full text-center bg-brand-green text-white font-semibold py-3 rounded-xl hover:bg-brand-green/90 transition-colors">
                        Get Started
                    </a>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-lg border-2 border-brand-blue relative hover:shadow-xl transition-shadow"
                    ...
                    <p class="text-slate-600 mb-6 leading-relaxed">Feature-rich phone systems for growing businesses with
                        20-100 users and multiple locations.</p>
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center text-slate-600">
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 mb-6 leading-relaxed">Enterprise-grade unified communications for large
                        organizations with 100+ users.</p>
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center text-slate-600">
                            <svg class="w-5 h-5 text-brand-blue mr-3 flex-shrink-0" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
