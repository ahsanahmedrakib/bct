...
@section('content')
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/voice/phone-systems/medium-business/hero.png"
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8 grid lg:grid-cols-3 gap-16 items-center">
            <div class="w-full">
            ...
            <div class="lg:col-span-2">
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">If your business is growing, you need a
                        phone
                        system that does more than just handle basic calls. A company of your size requires a solution that
                        supports all the ways you communicate with customers, clients, and colleagues—now and in the future.
                        At
                        Bismillah Computer &amp; Technology, we have the answer.</p>
                    <p class="text-slate-600 leading-relaxed text-justify">Our phone system experts possess the industry
                        expertise
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8">
            <h2 class="text-3xl text-center font-bold text-blue-900 mb-12">Hundreds of businesses rely on us for their phone
                system needs.</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Receive prompt and reliable support from our
                        dedicated
            ...
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <div class="space-y-6 mb-8">
                        <div
                            class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border-blue-100">
                            <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                            <h3 class="text-lg font-bold text-slate-900 mb-3">Dependable and Secure Connectivity</h3>
                            <p class="text-slate-600 text-sm leading-relaxed">Guarantee that every interaction with your
                                clients
                        ...
                        <div
                            ...
                            <p class="text-slate-600 text-sm leading-relaxed">Get prompt and reliable support from our
                                dedicated
                                team.</p>
                        </div>
                    </div>
        ...
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Keep your business calls and information protected.
                    </p>
                </div>
                <div
                    class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
