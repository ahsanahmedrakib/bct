...
@section('description', 'Vodia PBX is a cloud phone system for the modern workplace, catering to contemporary companies where seamless communication is vital.')
...
<section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-20 lg:pt-32">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <p class="text-lg md:text-xl text-slate-700 font-medium leading-relaxed mt-6 max-w-3xl leading-relaxed">Cloud
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Easily adapts to various communication needs, integrating
...
<section class="py-16 lg:py-24 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <h3 class="text-2xl text-center font-bold text-slate-900 mb-6">All in One Softphone to make and manage calls</h3>
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">The Vodia desktop apps go far beyond what you know
            from traditional SIP soft phones. You can see the status of your coworkers, call or text them, see messages in
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">You can use the Vodia PBX through a standard web browser
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">The Vodia PBX Android client is available from Google Play
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Our iOS app is the latest addition to our fleet of
                    softphones. Make and receive calls, listen and manage voicemails, message your colleagues all with our
                    own iOS app.</p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Users connect to the Vodia PBX through extensions, and
                    ...
                    someone calls the extension, so a person can pick up the call on the device that suits him or her best.
                    Each extension can have its own time zone, language, ringtone, address book and much, much more.
                    Extensions may have administrative permissions; for example, for managing the central address book or
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Each extension comes with a mailbox so callers can leave
                    messages. These messages can be shared in a group, moved to other mailboxes; users can also leave
                    comments for mailbox messages. The PBX can also receive FAX messages and then send them to the user's
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">The auto attendant helps incoming callers find the right
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Simple hunt groups call a list of extensions up and
                    escalate calls based on simple time rules. Groups can have their own ring melody and display the group
                    name on phones, making which group is being called easy to discern. When necessary, users can be called
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">For more sophisticated call distribution, the Vodia PBX
                    comes with agent groups which are equipped to handle higher call volumes and sequentially distribute
                    calls. While waiting, the PBX can play announcements and mix these announcements with music on the fly.
                    Users can receive a call back when it's their turn, instead of holding. Agents can log in and out of
                    the queues, and managers can see service level measurements like speed of answer. For outbound calls,
                    lists of numbers-to-be-dialed can be uploaded into the ACD; the PBX can then dial those numbers
                    automatically and distribute them to an agent, or the agents can use a code to dial the next number on
                    the list. Virtual offices benefit from separate DID: each can have its own name and voice announcement.
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Sometimes more than two people need to talk, and the Vodia
                    ...
                    calls the conference participants into the conference. Rapid response conferences can be commenced when
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">The PBX comes with extensive paging features that can be
                    used with standard desktop phones and with overhead speaker equipment; it supports live paging and
                    recorded announcements. Predefined pages can be triggered by events – for example, when a user calls an
                    emergency number or when a group receives a call. Using the Google text to speech API, arbitrary texts
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">There are several predefined CRM integrations available,
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">The PBX keeps address books on user and domain level, so
                    that each user can have their own contacts and companies can share contacts. Contacts can be imported
                    through the web interface or from Google G-Suite and Office 365. The contacts are stored on the server,
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">The Vodia PBX supports a great many VoIP phones through
                    provisioning templates. Where available, the PBX uses secure communication for provisioning and calls.
                    Button templates can be used to assign functions to buttons without touching the devices. Whenever
                    possible, the PBX generates background images and ring tones, making branding easier for partners and
                    corporate users.</p>
            </div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300 md:col-span-2">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">There are numerous reports available for users, managers
                    and system administrators. The PBX proactively sends emails and SMS messages when important events are
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            ...
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">The Vodia PBX can act as an SBC for Microsoft
                ...
                extensions using VoIP phones unavailable for Teams; the PBX can also terminate Teams calls into SIP trunks
                for outbound calls. Inbound calls can be sent to Teams extensions.</p>
            <a href="{{ route('voice.feature-microsoft-teams') }}" class="text-blue-600 font-medium flex items-center hover:text-blue-800">
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <div class="aspect-4/3 rounded-xl border-2 border-dashed border-blue-200 bg-blue-50/40 flex items-center justify-center mb-5">
                    <span class="text-blue-300 font-medium text-sm">Add image here</span>
                </div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm">A high-end IP phone with a large touchscreen and powerful features.</p>
            </div>
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <div class="aspect-4/3 rounded-xl border-2 border-dashed border-blue-200 bg-blue-50/40 flex items-center justify-center mb-5">
                ...
                <p class="text-slate-600 text-sm">A carrier-grade professional IP phone ideal for everyday business use.</p>
            </div>
        </div>
        <h3 class="text-xl text-center font-bold text-slate-900 mb-6">Soft Phones</h3>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300 text-center">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300 text-center">
                ...
                <p class="text-slate-600 text-sm">Android client available on Google Play for all major Android systems.</p>
            </div>
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300 text-center">
                <div class="absolute top-0 left-1/2 -translate-x-1/2 w-16 h-1 bg-blue-600 rounded-b-md"></div>
