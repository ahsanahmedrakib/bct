        ...
        <div
            ...
            <div class="space-y-6">
                <span
                    ...
                    Partner</span>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Vodia
                    PBX Platform</h1>
                <p class="text-lg md:text-xl text-slate-700 leading-relaxed">A powerful and flexible PBX platform supporting
                    multi-tenant deployments, advanced call routing, and seamless integration with modern communication
                    tools.</p>
            </div>
            <div class="flex justify-center lg:justify-end">
                <img alt="Vodia PBX Platform" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full"
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Discover the power of Vodia's software-based PBX
                    platform for modern businesses and service providers.</p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Host multiple organisations on a single PBX instance with
                        complete tenant isolation. Perfect for MSPs and service providers.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Comprehensive REST API enables integration with business
                        applications, CRM systems, and custom workflows.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Intuitive web interface for system administration. Manage
                        users, trunks, and features from any browser.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Flexible call routing with time-of-day rules, skills-based
                        distribution, and failover options for optimal call handling.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Runs on standard Linux servers — no proprietary hardware
                        required. Easy to deploy, update, and scale.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Deploy on-premise or in the cloud. Supports Docker containers
                        and virtualisation for flexible deployment options.</p>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="reveal reveal-fade-up">
                    ...
                    <p class="text-slate-600 leading-relaxed mb-8">Vodia's multi-tenant architecture makes it the ideal
                        platform for managed service providers, hosted PBX operators, and telecommunications companies
                        looking to offer cloud-based phone services.</p>
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600">Brand the platform as your own with custom themes and domains.
                                </p>
                            </div>
                        </li>
                        <li class="flex items-start">
                ...
                <div class="reveal reveal-fade-up flex justify-center">
                    <img alt="Vodia Multi-Tenant PBX" loading="lazy" class="rounded-2xl shadow-lg w-full max-w-lg"
                        src="/images/voice/brands.png" />
                </div>
            </div>
        </div>
