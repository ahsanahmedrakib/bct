...
@section('description', 'Vodia is a flexible, future-proof cloud phone system offering unified communications for enterprises, contact centres and service providers.')
    ...
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
        <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
            ...
            <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
                Vodia
                <span class="text-blue-600 block mt-2">Cloud Phone System</span>
            </h1>
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Vodia Networks Inc.
                offers unified communications solutions for enterprises, contact centres and service providers, delivered
                as a flexible, future-proof cloud phone system.</p>
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        <h2 class="text-3xl text-center font-bold text-blue-900 mb-4">A Cloud Phone System That Grows With You</h2>
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Vodia gives your business the flexibility to
            communicate from anywhere while keeping things simple to manage and secure.</p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Use your phone from home, a cafe, or the office, staying
                    connected wherever you are with softphone and mobile apps.</p>
            </div>
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Make calls easily from your phone or computer with
                    powerful, intuitive softphone applications.</p>
            </div>
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <h3 class="text-lg font-bold text-slate-900 mb-3">Keep Your Numbers</h3>
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Keep your business calls and information protected with
                    robust security protocols built into the platform.</p>
            </div>
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <h3 class="text-lg font-bold text-slate-900 mb-3">Cost Saving</h3>
                <p class="text-slate-600 text-sm leading-relaxed">Cut costs on office equipment and phone bills with an
                    affordable, scalable cloud solution.</p>
            </div>
...
<section class="py-16 lg:py-24 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            <h2 class="text-3xl text-left font-bold text-blue-900 mb-6">Who Is Vodia For?</h2>
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">Vodia is suited to a wide range of organisations,
                from growing small businesses to larger enterprises and contact centres.</p>
            <ul class="space-y-4">
                <li class="flex items-start">
                    ...
                    <div>
                        <h4 class="font-semibold text-slate-900">Enterprises</h4>
                        <p class="text-slate-600 text-sm">Scalable multi-site unified communications.</p>
                    </div>
                </li>
                <li class="flex items-start">
                    <svg class="w-6 h-6 text-blue-600 mt-0.5 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    <div>
                        <h4 class="font-semibold text-slate-900">Contact Centres</h4>
                        <p class="text-slate-600 text-sm">Robust call handling and queue features.</p>
                    </div>
                </li>
                <li class="flex items-start">
                    <svg class="w-6 h-6 text-blue-600 mt-0.5 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    <div>
                        <h4 class="font-semibold text-slate-900">Service Providers</h4>
                        <p class="text-slate-600 text-sm">Flexible, white-label deployment options.</p>
                    </div>
                </li>
            </ul>
        </div>
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        <div class="relative border-2 rounded-2xl p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border-blue-100 text-center">
            ...
            <h2 class="text-3xl text-center font-bold text-blue-900 mb-4">Ready to Move to the Cloud?</h2>
            <p class="text-slate-600 leading-relaxed mb-8 max-w-2xl mx-auto">Talk to our team about deploying Vodia for your
                business. We handle the setup, migration, and ongoing support.</p>
