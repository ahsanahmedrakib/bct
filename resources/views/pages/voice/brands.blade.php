        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">We partner with leading
                    voice technology brands to deliver reliable, feature-rich communication solutions for your business.</p>
            </div>
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="Voice Brands" loading="lazy" class="rounded-lg w-full max-w-md lg:max-w-lg" src="/images/voice/brands.png" />
            </div>
        </div>
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Trusted voice technology solutions from
                    industry-leading manufacturers.</p>
            </div>
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6">Vodia provides a powerful and flexible PBX platform that
                        supports multi-tenant deployments, advanced call routing, and seamless integration with modern
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6">Grandstream offers a complete range of IP phones, PBX
                        systems, and networking equipment with exceptional quality and value for businesses of all sizes.
                    </p>
                    <ul class="space-y-2 text-sm text-slate-600">
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-brand-green mr-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6">Avaya delivers enterprise-grade unified communications
                        and contact center solutions trusted by organizations worldwide for mission-critical communications.
                    </p>
                    <ul class="space-y-2 text-sm text-slate-600">
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-brand-green mr-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6">LG iPECS provides reliable and innovative business phone
                        systems with advanced features, excellent voice quality, and seamless integration capabilities.</p>
                    <ul class="space-y-2 text-sm text-slate-600">
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-brand-green mr-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
