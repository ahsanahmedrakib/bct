            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">We provide clear pricing with no hidden charges,
                        allowing you to budget with confidence and invest in your business growth without unexpected costs.
                    </p>
                </div>
        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            <div class="order-2 lg:order-1">
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 text-justify">Get prompt and reliable support from our
                        dedicated
        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Use your phone from home, a cafe, or the office,
                        staying
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-12" role="tablist">
                <button onclick="switchTab(this, 'tab-onboarding')"
                    class="px-6 py-3 border-2 rounded-xl font-semibold text-sm bg-brand-blue text-white border-brand-blue shadow-sm cursor-pointer">Onboarding</button>
                <button onclick="switchTab(this, 'tab-training')"
                    class="px-6 py-3 border-2 rounded-xl font-semibold text-sm border-blue-100 bg-white text-slate-700 hover:border-blue-300 cursor-pointer">Training
                    Your Team</button>
                <button onclick="switchTab(this, 'tab-programming')"
                    class="px-6 py-3 border-2 rounded-xl font-semibold text-sm border-blue-100 bg-white text-slate-700 hover:border-blue-300 cursor-pointer">Phone
                    Programming</button>
                <button onclick="switchTab(this, 'tab-transfer')"
                    class="px-6 py-3 border-2 rounded-xl font-semibold text-sm border-blue-100 bg-white text-slate-700 hover:border-blue-300 cursor-pointer">Knowledge
                    Transfer</button>
                <button onclick="switchTab(this, 'tab-support')"
                    class="px-6 py-3 border-2 rounded-xl font-semibold text-sm border-blue-100 bg-white text-slate-700 hover:border-blue-300 cursor-pointer">Support
                    Services</button>
            </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p class="text-slate-600 leading-relaxed mb-6 text-justify">Implementation can be completed in as
                            ...
                            porting, this process can be expedited. Many of our customers opt for a longer timeline, which
                            is
            ...
            <div id="tab-training"
                class="relative border-2 rounded-2xl p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border-blue-100 hidden">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p class="text-slate-600 leading-relaxed mb-6 text-justify">Implementation can be done in as little
                            ...
                            process can happen quickly. Many of our customers prefer a longer timeline, and that is
                            perfectly
                            acceptable.</p>
                        <a href="{{ route('contact') }}"
                            class="inline-flex px-6 py-2.5 bg-brand-blue text-white text-xs font-bold tracking-wider uppercase rounded-lg shadow-sm cursor-pointer transition-colors hover:bg-brand-active">Contact
            ...
            <div id="tab-transfer"
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p class="text-slate-600 leading-relaxed mb-6 text-justify">Simply provide us with information on
                            the
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p class="text-slate-600 leading-relaxed mb-6 text-justify">Our post-activation support and account
                            management are as exceptional as our onboarding. We uphold high service standards, including
                            live
                            24/7/365 support, a 20-second answer time, and a 94% first contact resolution rate. With
                            dedicated
                            support, account management, and regular service reviews and evaluations, we guarantee your
                            needs
