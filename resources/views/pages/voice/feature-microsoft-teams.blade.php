...
<section class="relative bg-gradient-to-br from-hero-gradient to-white pt-28 pb-20 lg:pt-36 lg:pb-28 overflow-hidden">
  <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
    <div class="space-y-6">
      ...
      <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Microsoft Teams Integration</h1>
      <p class="text-lg md:text-xl text-slate-700 leading-relaxed">Seamlessly connect your phone system with Microsoft Teams for a unified communication experience your team already knows and loves.</p>
    </div>
    <div class="flex justify-center lg:justify-end">
      <img alt="Microsoft Teams Integration" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full" src="/images/voice/hero.png"/>
    </div>
  </div>
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16 reveal reveal-fade-up">
      ...
      <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Get the most out of your Microsoft 365 investment by integrating your phone system directly into Teams.</p>
    </div>
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed">Connect your existing phone system to Teams via SIP trunking. Make and receive external calls without leaving the Teams interface.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Deploy certified Teams IP phones for shared spaces, reception areas, and hot-desking environments.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed">Simplified phone system management through Microsoft's Operator Connect programme for easier carrier management.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed">Microsoft Teams Phone with calling plans for a fully cloud-based solution. No on-premise hardware required.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Session Border Controller setup and configuration for secure, reliable connectivity between your phone system and Teams.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed">Keep your existing phone numbers when migrating to Teams. We handle the porting process with zero downtime.</p>
      </div>
...
<section class="py-24 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16 reveal reveal-fade-up">
      ...
      <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">As a certified Microsoft Solutions Partner, we have the expertise to deploy and manage Teams voice solutions for your organisation.</p>
    </div>
    <div class="grid md:grid-cols-2 gap-8">
      <div class="reveal reveal-fade-up flex items-start">
        ...
        <div>
          ...
          <p class="text-slate-600">Evaluate your readiness for Teams voice and identify the best migration path.</p>
        </div>
      </div>
      <div class="reveal reveal-fade-up flex items-start">
        <div class="w-10 h-10 bg-brand-green/10 rounded-lg flex items-center justify-center mr-4 mt-1 flex-shrink-0">
        ...
        <div>
          ...
          <p class="text-slate-600">Navigate Microsoft licensing to get the right Teams Phone plan for your needs.</p>
        </div>
      </div>
      <div class="reveal reveal-fade-up flex items-start">
        <div class="w-10 h-10 bg-brand-green/10 rounded-lg flex items-center justify-center mr-4 mt-1 flex-shrink-0">
        ...
        <div>
          ...
          <p class="text-slate-600">End-to-end setup including SBC, direct routing, auto-attendants, and call queues.</p>
        </div>
      </div>
      <div class="reveal reveal-fade-up flex items-start">
        <div class="w-10 h-10 bg-brand-green/10 rounded-lg flex items-center justify-center mr-4 mt-1 flex-shrink-0">
