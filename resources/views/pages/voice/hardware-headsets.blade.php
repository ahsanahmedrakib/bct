...
<section class="relative bg-gradient-to-br from-hero-gradient to-white pt-28 pb-20 lg:pt-36 lg:pb-28 overflow-hidden">
  <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
    <div class="space-y-6">
      ...
      <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">Headsets</h1>
      <p class="text-lg md:text-xl text-slate-700 leading-relaxed">Professional headsets for call centres, offices, and remote workers. Crystal-clear audio with noise cancellation for productive conversations.</p>
    </div>
    <div class="flex justify-center lg:justify-end">
      <img alt="Professional Headsets" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full" src="/images/voice/hero.png"/>
    </div>
  </div>
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16 reveal reveal-fade-up">
      ...
      <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">From mono to stereo, wired to wireless, find the perfect headset for your work style and environment.</p>
    </div>
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed">Single-ear design keeps one ear free for awareness of your surroundings. Ideal for busy offices and reception areas.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Dual-ear design for immersive audio and maximum noise isolation. Perfect for call centres and focused work.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed">DECT or Bluetooth wireless freedom. Walk and talk without being tethered to your desk. Up to 100m range.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
        ...
        <p class="text-slate-600 leading-relaxed">Active noise cancellation blocks out background noise for clearer conversations. Essential for open-plan offices.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.1s">
        ...
        <p class="text-slate-600 leading-relaxed">Connect to computers, phones, and tablets via USB or Bluetooth. One headset for all your devices.</p>
      </div>
      ...
      <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow" style="animation-delay: 0.2s">
        ...
        <p class="text-slate-600 leading-relaxed">Headsets with integrated cameras for video conferencing. All-in-one solution for Teams and Zoom calls.</p>
      </div>
...
<section class="py-24 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16 reveal reveal-fade-up">
      ...
      <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Investing in quality headsets pays dividends in productivity and employee satisfaction.</p>
    </div>
    <div class="grid md:grid-cols-2 gap-8">
      <div class="reveal reveal-fade-up flex items-start">
        <div class="w-10 h-10 bg-brand-green/10 rounded-lg flex items-center justify-center mr-4 mt-1 flex-shrink-0">
          <svg class="w-5 h-5 text-brand-green" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
        </div>
        <div>
          <h4 class="font-semibold text-slate-900 mb-1">Reduced Fatigue</h4>
          <p class="text-slate-600">Ergonomic designs and lightweight materials mean all-day comfort for your team.</p>
        </div>
      </div>
      <div class="reveal reveal-fade-up flex items-start">
        <div class="w-10 h-10 bg-brand-green/10 rounded-lg flex items-center justify-center mr-4 mt-1 flex-shrink-0">
        ...
        <div>
          ...
          <p class="text-slate-600">Noise cancellation and HD audio mean clearer conversations with fewer misunderstandings.</p>
        </div>
      </div>
      <div class="reveal reveal-fade-up flex items-start">
        <div class="w-10 h-10 bg-brand-green/10 rounded-lg flex items-center justify-center mr-4 mt-1 flex-shrink-0">
        ...
        <div>
          ...
          <p class="text-slate-600">Hands-free operation lets you type, take notes, and multitask during calls.</p>
        </div>
      </div>
      <div class="reveal reveal-fade-up flex items-start">
        <div class="w-10 h-10 bg-brand-green/10 rounded-lg flex items-center justify-center mr-4 mt-1 flex-shrink-0">
        ...
        <div>
          ...
          <p class="text-slate-600">Quality headsets project a professional image during client and customer calls.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="py-24 bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16 reveal reveal-fade-up">
      ...
      <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">We stock and support the leading headset manufacturers for business communications.</p>
    </div>
