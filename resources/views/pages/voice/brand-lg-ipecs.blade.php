...
@section('description', 'LG iPECS phones and phone systems are LG\'s solution for Unified Communications (UC), focusing on the basics of reliability and scalability.')
...
<section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-24 items-center relative z-10">
        <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
            ...
            <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">iPECS phones and phone
                systems are LG's solution for Unified Communications (UC), focusing on the basics of reliability and
                scalability.</p>
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
            <h2 class="text-3xl text-left font-bold text-blue-900 mb-6">Reliable and Scalable Communications</h2>
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">LG iPECS is built around the fundamentals of
                reliability and scalability. It delivers solid, dependable phone systems that can grow with your
                organisation.</p>
            <p class="text-slate-600 leading-relaxed mb-6 text-justify">With a complete range of phones and phone systems,
                iPECS offers business-grade communications from a trusted global brand, backed by quality hardware.</p>
...
<section class="py-16 lg:py-24 bg-slate-50">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        <h2 class="text-3xl text-center font-bold text-blue-900 mb-4">Why Choose iPECS</h2>
        <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">Communications that focus on what matters — solid
            performance you can build your business on.</p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">Dependable hardware and software engineered to keep your
                    business connected.</p>
            </div>
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <h3 class="text-lg font-bold text-slate-900 mb-3">Scalability</h3>
                <p class="text-slate-600 text-sm leading-relaxed">Systems that grow with you, from small offices to larger
                    deployments with multiple users.</p>
            </div>
            <div class="relative border-2 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white transition-all h-full border-blue-100 hover:border-blue-300">
                <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                <h3 class="text-lg font-bold text-slate-900 mb-3">Trusted Brand</h3>
                <p class="text-slate-600 text-sm leading-relaxed">Backed by LG, a globally recognised name in quality
...
<section class="py-16 lg:py-24 bg-white">
    <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
        <div class="relative border-2 rounded-2xl p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border-blue-100 text-center">
            ...
            <h2 class="text-3xl text-center font-bold text-blue-900 mb-4">Built on Reliability</h2>
            <p class="text-slate-600 leading-relaxed mb-8 max-w-2xl mx-auto">Talk to our team about deploying an LG iPECS
                solution for your business, with full installation and ongoing support.</p>
