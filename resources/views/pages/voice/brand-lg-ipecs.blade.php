        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">The
                    Ericsson-LG iPECS and eMG100 phone systems are so popular because they're feature rich but still
                    maintain the
                    ease of use that the LG brand is synonymous with. Your staff can learn the system in just minutes and
                    you don't
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/voice/brands/ipecs/ipecs.png"
        ...
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            <div
                ...
                <p class="text-slate-600 leading-relaxed mb-4 text-justify">Now that LG have been aggressively promoting the
                    ...
                    Computer &amp; Technology is here to help businesses with their iPECS systems and help grow your
                    business.
                </p>
                <p class="text-slate-600 leading-relaxed text-justify">Bismillah Computer &amp; Technology is here to
                    support
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <p class="text-center text-slate-600 max-w-3xl mx-auto mb-12">In a word…fantastic. The latest iPECS phone system
                range is state of the art and a quantum leap forward from the previous LG offerings. The real standout in
                the
                range is the brand new LG iPECS eMG100 for SME business. Its incredible price point has made it an instant
                best-seller since it burst on the scene. Other leading brands simply can't or won't compete and will be
                playing
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">With all the Ericsson-LG iPECS phone systems you get
                        the
                ...
                <div
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">The new LG phone system solutions allow users to
                        attach
            ...
            <p class="text-slate-600 leading-relaxed max-w-4xl mx-auto text-center mb-12">In all there are 2 Ericsson-LG
                phone
                system solutions designed to meet the needs of every small to medium size business. Both the eMG100 system
                and
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-start">
                <div
                    class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border-blue-100 h-full">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div class="w-full">
                        <img src="/images/voice/brands/ipecs/ipecs-1.png" alt="Section"
                            class="w-full h-auto object-cover" />
                    </div>

                    <h3 class="text-xl font-bold text-blue-900 mb-2">Ericsson-LG iPECS-eMG 100</h3>
                    <p class="text-slate-500 font-medium text-sm mb-6">Hybrid phone system for small-sized business (up to
                        74
                        staff)</p>
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Up to 74 users (Handset Capacity – IP 74,
                                Digital 74, DECT 74, IP DECT 74, plus softphone options)</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Designed for small business that need growth
                                and potential multisite networking</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Rack &amp; wall mountable</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Supports up to 74 PSTN, 74 ISDN 2, 74 PRI
                                channels, 74 SIP trunks, 74 H.323 connections</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Choose from a range of Ericsson-LG IP,
                                Digital, Wireless, DECT, IP DECT and Softphones</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Up to 16 port voicemail and auto
                                attendant</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Unified communications platform</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">32 party conferencing</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Call recording</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Mobile phone connectivity and SIP
                                applications</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Range of advanced CTI applications can be
                                added such as Call centre, Conference bridging, PC softphones, Receptionist console and
                                more</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">IP networking for remote users or multi-site
                                deployments</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Open API</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Advanced technology</span></li>
                    </ul>
                </div>
                <div
                    class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border-blue-100 h-full">
                    <div class="absolute top-0 left-8 w-16 h-1 bg-blue-600 rounded-b-md"></div>
                    <div class="w-full">
                        <img src="/images/voice/brands/ipecs/ipecs-2.png" alt="Section"
                            class="w-full h-auto object-cover" />
                    </div>
                    <h3 class="text-xl font-bold text-blue-900 mb-2">Ericsson-LG UCP 100</h3>
                    <p class="text-slate-500 font-medium text-sm mb-6">Phone system for small-medium sized business (up to
                        199
                        staff)</p>
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Up to 199 users (Handset Capacity – IP 199,
                                Digital 199, DECT 199, IP DECT 199, plus softphone options)</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Designed for small business that need growth
                                and potential multisite networking</span></li>
                        ...
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Supports up to 199 ISDN 2, 199 PRI channels,
                                199 SIP trunks, 199 H.323 connections</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Choose from a range of Ericsson-LG IP,
                                Digital, Wireless, DECT, IP DECT and Softphones</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Up to 8 port voicemail and auto
                                attendant</span></li>
                        <li class="flex items-start gap-3"><span
                                class="w-1.5 h-1.5 rounded-full bg-blue-600 mt-2 shrink-0"></span><span
                                class="text-slate-600 text-sm leading-relaxed">Unified communications platform</span></li>
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            <div
                ...
                <a href="{{ route('contact') }}"
                    class="inline-flex px-6 py-2.5 bg-brand-blue text-white text-xs font-bold tracking-wider uppercase rounded-lg shadow-sm cursor-pointer transition-colors hover:bg-brand-active">Book
                    Now</a>
            </div>
        </div>
    </section>
