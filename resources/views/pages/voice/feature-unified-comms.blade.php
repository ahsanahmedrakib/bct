...
@section('content')
        ...
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">Break down barriers to
                    inter-office, intra-office, and external communications, and allow your business to connect with each
                    other
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/voice/features/unified/hero.png"
        ...
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8">
            <div
                ...
                <p class="text-slate-600 leading-relaxed mb-4 text-justify">Unified Communications offers many benefits to
                    ...
                    intra-office, and external communications, and allow businesses to connect with each other across
                    multiple
                    platforms.</p>
                ...
                <p class="text-slate-600 leading-relaxed mb-4 text-justify">Operating efficiently. Staying close to
                    customers.
                    Carefully managing scarce resources. Focusing on what really matters. These are essential tasks for
                    small
                    and medium businesses.</p>
                <p class="text-slate-600 leading-relaxed mb-4 text-justify">What they may lack in scale, growing companies
                    make
                ...
                <p class="text-slate-600 leading-relaxed mb-4 text-justify"><strong>Mobile collaboration</strong> – the
                    ability
                    to communicate and stay productive from anywhere – is reshaping every aspect of business operations
                    today,
                    from sales to customer service to hiring and budgeting. To remain competitive, small and midsize
                    companies
                    need to match their communications to the new realities of the marketplace.</p>
                <p class="text-slate-600 leading-relaxed mb-4 text-justify">Unified Communications can integrate IP
                    telephony,
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8">
            ...
            <p class="text-slate-600 leading-relaxed mb-8 max-w-4xl">iPECS UCP is Ericsson-LG Enterprise's unified
                ...
                stakeholders. iPECS Unified Communications helps people across your business be more productive and
                efficient
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach (['Mobile Client (Android/iOS)', 'Video Conferencing', 'Presence and Instant Messaging', 'Outlook Integration', 'Built-In Voicemail and Auto Attendant', 'Built-in Automatic Call Distribution', 'Mobile Extension', 'Powerful Call Handling Features', 'Embedded SIP', 'Embedded Hotel Features', 'Centralised Control Transport Network (T-NET)'] as $feature)
                    <div
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8">
            ...
            <p class="text-slate-600 leading-relaxed mb-6 max-w-4xl text-justify">iPECS Unified Communications (UC)
                ...
                easy to use platform. Designed to be intuitive and provide your team easy to use tools and features.
                Increase
                reliability and flexibility with distribution architecture.</p>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                @foreach ([['Total reliability', 'Complete resilience through geographic redundancy and inherent modular architecture.'], ['Integrated applications tailored to your needs', 'Offers a range of enhanced applications from Ericsson-LG and other specialist application providers. Integrates into standard office applications such as Microsoft Outlook or Lync and others.'], ['Leverage the latest standards based technologies', 'Makes the most of the latest network technologies such as SIP. Optimise call costs using WiFi. Use in-built voice conferencing to save on external conference services.'], ['Scale with your growth', 'Delivers the flexibility you need as your organisation grows and easily adapts to meet changing needs.'], ['Anytime and anywhere connectivity', 'Access the power of your iPECS UCP your way regardless of your device or location using smartphone, tablet or PC applications.']] as [$title, $desc])
                    <div
            ...
            <div
                ...
                <p class="text-slate-600 leading-relaxed text-justify">iPECS vUCP as a software base call server is running
                    on
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8">
            <div
                ...
                <p class="text-slate-600 leading-relaxed mb-4 text-justify"><strong>Flexible Configurations:</strong> Choose
                    a
                ...
                <p class="text-slate-600 leading-relaxed mb-6 text-justify"><strong>Complete Collaboration
                        Solution:</strong>
    ...
    <div class="reveal reveal-fade-up max-w-365 mx-auto px-6 lg:px-8 pb-6">
        <div class="w-full">
