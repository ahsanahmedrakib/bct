        ...
        <div
            ...
            <div class="space-y-6">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
                    Conferencing Solutions</h1>
                <p class="text-lg md:text-xl text-slate-700 leading-relaxed">Professional audio and video conferencing
                    solutions that bring your team together from anywhere in the world.</p>
            </div>
            <div class="flex justify-center lg:justify-end">
                <img alt="Conferencing Solutions" loading="lazy" class="rounded-2xl shadow-lg max-w-md w-full"
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Our conferencing solutions make it easy to
                    collaborate with colleagues, clients, and partners regardless of location.</p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Crystal-clear audio conferencing with dial-in numbers,
                        moderator controls, and support for hundreds of participants.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">HD video conferencing with screen sharing, virtual
                        backgrounds, and recording capabilities for face-to-face collaboration.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Browser-based conferencing with no downloads required. Share
                        your screen, present documents, and collaborate in real time.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Dedicated conference room systems with professional audio
                        equipment, ceiling microphones, and room scheduling displays.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">Record conferences for later review, training, or compliance.
                        Automatic transcription and searchable archives.</p>
                </div>
                ...
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow"
                    ...
                    <p class="text-slate-600 leading-relaxed">End-to-end encryption, password protection, and waiting rooms
                        keep your confidential meetings safe from unauthorised access.</p>
                </div>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal reveal-fade-up">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">Professional-grade hardware for the best
                    conferencing experience in any room size.</p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
                <div
                    ...
                    <div class="w-16 h-16 bg-brand-blue/10 rounded-xl flex items-center justify-center mx-auto mb-6">
                        <svg class="w-8 h-8 text-brand-blue" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <p class="text-slate-600 leading-relaxed">360-degree microphones and HD audio for small to medium
                        meeting rooms.</p>
                </div>
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow text-center"
                    ...
                    <p class="text-slate-600 leading-relaxed">All-in-one video bars with cameras, speakers, and microphones
                        for huddle rooms and boardrooms.</p>
                </div>
                <div class="reveal reveal-fade-up bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow text-center"
                    style="animation-delay: 0.2s">
                    <div class="w-16 h-16 bg-brand-blue/10 rounded-xl flex items-center justify-center mx-auto mb-6">
                    ...
                    <p class="text-slate-600 leading-relaxed">Discreet ceiling-mounted microphones for large conference
                        rooms and boardrooms with premium audio pickup.</p>
                </div>
            </div>
        </div>
    </section>
