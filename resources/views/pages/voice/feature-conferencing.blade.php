...
@section('content')
    ...
    <section class="relative bg-linear-to-t from-hero-gradient to-white pt-24 pb-32 lg:pt-32">
        <div
            ...
            <div class="space-y-8 order-2 lg:order-1 lg:col-span-2">
                ...
                <p class="text-lg text-justify md:text-xl text-slate-700 font-medium leading-relaxed">We specialize in both
                    Avaya
                    and iPECS phone systems. A key part of these solutions is ensuring an appropriate conferencing system
                    can be
            ...
            <div class="flex justify-center lg:justify-end order-1 lg:order-2 lg:col-span-1">
                <img alt="BG Image" src="/images/voice/features/solutions/hero.png"
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            <div
                ...
                <p class="text-slate-600 leading-relaxed">We can supply and install teleconferencing IP Phones from Konftel
                    and
                ...
                <div class="order-2 lg:order-1">
                    <div
                        ...
                        <p class="text-slate-600 leading-relaxed mb-4 text-justify">The Konftel 300IP is perfect for both
                            cloud-based and traditional IP platforms, giving you everything you need for effective,
                            top-quality
                            distance meetings. Konftel's OmniSound® audio technology delivers crystal-clear, natural HD
                            audio.
                        </p>
                        <ul class="space-y-2 mt-6">
                            <li class="flex items-center gap-3 text-slate-700"><span
                                    class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>SIP</li>
                            <li class="flex items-center gap-3 text-slate-700"><span
                                    class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>Built-in bridging function</li>
                            <li class="flex items-center gap-3 text-slate-700"><span
                                    class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>Zero Touch Installation</li>
                            <li class="flex items-center gap-3 text-slate-700"><span
                                    class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>Meeting size: more than 20
                                people
                            </li>
                            <li class="flex items-center gap-3 text-slate-700"><span
                                    class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>OmniSound® with HD audio</li>
                            <li class="flex items-center gap-3 text-slate-700"><span
                                    class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>Recording on memory card</li>
                        </ul>
                    </div>
                </div>
                <div class="w-full order-1 lg:order-2">
                    <img src="/images/voice/features/solutions/section-1.png" alt="Section"
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="reveal reveal-fade-up max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="w-full">
                    <img src="/images/voice/features/solutions/section-2.png" alt="Section"
                        class="w-full h-auto object-cover" />
                </div>
                <div class="relative border-2 rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border-blue-100">
                    ...
                    <ul class="space-y-2 mt-6">
                        <li class="flex items-center gap-3 text-slate-700"><span
                                class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>Speakerphone with Bluetooth</li>
                        <li class="flex items-center gap-3 text-slate-700"><span
                                class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>Certified for Business &amp; Teams
                        </li>
                        <li class="flex items-center gap-3 text-slate-700"><span
                                class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>Convenient controls</li>
                        <li class="flex items-center gap-3 text-slate-700"><span
                                class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>Available expansion mics</li>
                        <li class="flex items-center gap-3 text-slate-700"><span
                                class="w-2 h-2 rounded-full bg-blue-600 shrink-0"></span>Cabling made easy</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="order-2 lg:order-1">
                    <div
                        ...
                        <p class="text-slate-500 font-medium mb-4">Transform small meeting rooms and huddle spaces into
                            inspiring
                            conference facilities.</p>
                        <p class="text-slate-600 leading-relaxed mb-4 text-justify">The modern world of enterprise requires
                            smooth
                            collaboration and flexibility, especially when it comes to team meetings in huddle rooms, and
                            this
                            is
                            exactly what Barco ClickShare CX-20 provides. Encouraging creative innovation through seamless
                            wireless conferencing, ClickShare CX-20 can make meetings more inspiring and more productive.
                        </p>
                        <a href="{{ route('contact') }}"
                            class="inline-flex px-6 py-2.5 bg-brand-blue text-white text-xs font-bold tracking-wider uppercase rounded-lg shadow-sm cursor-pointer transition-colors hover:bg-brand-active mt-4">Enquire
                            About Conferencing</a>
                    </div>
                </div>
                <div class="w-full order-1 lg:order-2">
                    <img src="/images/voice/features/solutions/section-3.png" alt="Section"
                        class="w-full h-auto object-cover" />
                </div>
            </div>
        </div>
