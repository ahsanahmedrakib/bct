...
@if (count($links) > 0 && !request()->is('admin*'))
                ...
                <div style="animation-delay: {{ 0.15 + $i * 0.1 }}s" class="chat-btn-pop group relative">
                    <a href="{{ $link['href'] }}" target="_blank" rel="noopener noreferrer" title="{{ $link['title'] }}"
                        ...
                        @elseif ($link['icon'] === 'messenger')
                            <svg viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                                <path
                                    d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.654V24l4.088-2.242c1.092.304 2.246.464 3.443.464 6.627 0 12-4.975 12-11.111C24 4.974 18.627 0 12 0zm1.191 14.963l-3.055-3.26-5.963 3.26 6.559-6.96 3.131 3.259 5.887-3.259-6.559 6.961z" />
                            </svg>
    ...
    <div id="scroll-top-btn"
        ...
        <button onclick="window.scrollTo({top:0,behavior:'smooth'})" title="Scroll to top" aria-label="Scroll to top"
